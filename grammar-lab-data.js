  ...
  const INTENSITY = {
    ...
    games: [
      ...
      { type: 'quiz', key: 'adv', label: 'Which adverb?', sub: 'pick the collocation', time: 18,
        ...
        items: [
          { q: 'I was ______ exhausted after the maths mock exam — I fell asleep at 7 p.m.', o: ['utterly', 'slightly'], a: 0, e: '<b>exhausted</b> is extreme → utterly. “slightly exhausted” is a contradiction.' },
          { q: 'I’m ______ uneasy about tomorrow’s presentation, but it’s not a big problem.', o: ['completely', 'slightly'], a: 1, e: '“not a big problem” = a small feeling, and <b>uneasy</b> is gradable → slightly.' },
          ...
          { q: 'Before the final whistle, the whole team was ______ tense.', o: ['slightly', 'rather'], a: 1, e: '<b>rather</b> tense — stronger than “slightly”, and tense is gradable.' },
          { q: 'He hadn’t slept for two nights, so he was ______ drained.', o: ['completely', 'fairly'], a: 0, e: 'Two nights without sleep = the maximum → <b>completely drained</b>.' },
          { q: 'I’m ______ confident about English, but maths is another story.', o: ['utterly', 'fairly'], a: 1, e: 'The “but” signals a limit → <b>fairly</b> confident.' },
          { q: 'My little brother gets ______ irritable when he is hungry — don’t go near him!', o: ['slightly', 'really'], a: 1, e: '“don’t go near him” = strong → <b>really</b> irritable (irritable is gradable, so not “completely”).' },
          ...
          { q: 'Where does the adverb go?', o: ['I was completely drained.', 'I was drained completely.'], a: 0, e: 'Adverb <b>before</b> the adjective.' },
        ] },
  ...
  const GERUND = {
    ...
    games: [
      ...
      { type: 'quiz', key: 'doctor', label: 'Grammar Doctor', sub: 'cure the sentence', time: 20,
        ...
        items: [
          { q: 'I really enjoy to spend time offline at weekends.', s: 'What is the cure?', o: ['enjoy to spending', 'enjoy spend', 'enjoy spending'], a: 2, e: '<b>enjoy</b> is a gerund verb → enjoy <b>spending</b>.' },
          { q: 'The coach suggested to train twice a week.', s: 'What is the cure?', o: ['suggested to training', 'suggested training', 'suggested that train'], a: 1, e: '<b>suggest</b> + -ing → suggested <b>training</b>.' },
          ...
          { q: 'He promised calling me as soon as the exam finished.', s: 'What is the cure?', o: ['promised call', 'promised for calling', 'promised to call'], a: 2, e: '<b>promise</b> + to-infinitive → promised <b>to call</b>.' },
          { q: 'Do you feel like to watch a film tonight?', s: 'What is the cure?', o: ['feel like watch', 'feel like watching', 'feel like to watching'], a: 1, e: '<b>feel like</b> + -ing → feel like <b>watching</b>.' },
          { q: 'My parents want that I sleep more.', s: 'What is the cure?', o: ['want that I sleep', 'want me sleeping', 'want me to sleep'], a: 2, e: 'Verb + <b>object</b> + to-infinitive: want <b>me to sleep</b>.' },
    ...
    games: [
      { type: 'quiz', key: 'context', label: 'Which form?', sub: 'decide from context', time: 22,
        ...
        items: [
          ...
          { q: 'I’ll never forget ______ the championship with that team.', o: ['to win', 'winning'], a: 1, e: 'An unforgettable <b>memory</b> → forget + -ing.' },
          { q: 'She tried ______ the window, but it was completely stuck.', o: ['to open', 'opening'], a: 0, e: 'A <b>difficult attempt</b> that failed → try + to.' },
        ] },
  ...
  const ADVICE = {
    ...
    games: [
      ...
      { type: 'quiz', key: 'kind', label: 'Make it kind', sub: 'bossy → helpful', time: 22,
        ...
        items: [
          { q: '“Stop using your phone at night!”', s: 'Choose the kind version:', o: ['You must stop using your phone at night.', 'It might help to leave your phone outside your bedroom at night.', 'You better stop using your phone at night.'], a: 1, e: '<b>It might help to…</b> softens without losing the advice. (“You better” is also misspelled — it is “you’d better”.)' },
          { q: '“Study more!”', s: 'Choose the kind version:', o: ['You’d better study more.', 'You must study more!', 'Maybe you could add two short study sessions this week.'], a: 2, e: 'Small problem → rung 1. <b>Maybe you could…</b>' },
          ...
          { q: '“Talk to her right now!”', s: 'Choose the kind version:', o: ['You must talk to her right now.', 'Have you tried talking to her calmly about how you feel?', 'You’d better talk to her now.'], a: 1, e: '<b>Have you tried + -ing?</b> turns the order into a question.' },
          { q: '“Go to sleep earlier!”', s: 'Choose the kind version:', o: ['You must go to sleep earlier.', 'You better go to bed earlier.', 'If I were you, I’d go to bed thirty minutes earlier for a week and see how it feels.'], a: 2, e: '<b>If I were you, I’d…</b> — advice from experience, not an order.' },
          { q: '“Calm down before your presentation!”', s: 'Choose the kind version:', o: ['You must calm down.', 'It might help to breathe slowly and run through your slides once more.', 'You’d better calm down.'], a: 1, e: 'You cannot order someone to calm down — the strength must match the goal.' },
          ...
          { q: 'You are writing to a teacher about your essay.', s: 'Which is appropriate?', o: ['You’d better read my essay today.', 'Would you mind looking at my essay when you have a moment?', 'You must read my essay.'], a: 1, e: '’d better and must said <b>upwards</b> sound like warnings. Use a polite request.' },
        ] },
    ...
    games: [
      ...
      { type: 'quiz', key: 'detective', label: 'Detective', sub: 'read the photo', time: 25,
        ...
        items: [
          ...
          { q: 'A boy in a muddy football kit is grinning and holding a small gold trophy.', s: 'Best guess about BEFORE?', o: ['His team can’t have played.', 'His team might be losing.', 'His team must have won.'], a: 2, e: 'Trophy + grin + mud → <b>must have won</b> (past guess: modal + have + participle).' },
          { q: 'The fridge is open, an empty pizza box is on the counter, three school bags are by the door.', s: 'Which guess fits the bags?', o: ['The kids can’t be home.', 'The kids must have gone to school.', 'The kids must be home from school.'], a: 2, e: 'Three bags by the door = they are in the house.' },
          { q: 'A teenager at a bus stop in the rain checks her phone every few seconds.', s: 'Which negative guess fits?', o: ['She mustn’t be enjoying the rain.', 'She can’t be enjoying the rain.', 'She can’t enjoy the rain.'], a: 1, e: 'Negative guess = <b>can’t be</b> + -ing. “mustn’t” would mean she is not allowed to.' },
          ...
          { q: 'He knew the exact score of Sunday’s match.', s: 'Past guess:', o: ['He must watch the match.', 'He must have watched the match.', 'He can’t have watched the match.'], a: 1, e: 'Past guess = <b>must have</b> + past participle.' },
          ...
          { q: 'I texted him twice and he replied both times.', s: 'Which guess is right?', o: ['He mustn’t have forgotten.', 'He might not forget.', 'He can’t have forgotten.'], a: 2, e: 'Two replies = almost certainly NOT forgotten → <b>can’t have forgotten</b>.' },
        ] },
    ],
  };
  ...
  const WISH = {
    ...
    games: [
      ...
      { type: 'quiz', key: 'quant', label: 'Quantifier check', sub: 'a few / few / plenty…', time: 20,
        ...
        items: [
          { q: 'Most teenagers spend ______ time on screens after 10 p.m.', o: ['too many', 'too much', 'a few'], a: 1, e: '<b>time</b> is uncountable + “more than is good” → too much.' },
          { q: '… and ______ of them get the nine hours of sleep doctors recommend.', o: ['plenty', 'a little', 'hardly any'], a: 2, e: '“of them” + almost zero → <b>hardly any</b>.' },
          ...
          { q: 'Many admitted they have ______ energy in the mornings.', o: ['few', 'little', 'a few'], a: 1, e: '<b>energy</b> is uncountable + negative feeling → little.' },
          ...
          { q: 'Most students said they now drink ______ water during the school day.', o: ['too much', 'few', 'enough'], a: 2, e: 'As much as needed → <b>enough</b>.' },
          ...
          { q: '______ students sleep nine hours a night.', o: ['A few', 'Little', 'Few'], a: 2, e: 'Almost none, negative → <b>Few</b>.' },
          { q: '______ stress can actually help you focus.', o: ['Little', 'A little', 'A few'], a: 1, e: 'Uncountable + positive → <b>A little</b>.' },
