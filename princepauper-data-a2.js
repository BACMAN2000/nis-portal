...
const CHAPTERS = [
  ...
  { n:3, title:"Lost in London",
    ...
    think:{ quote:"Miles Hendon did not believe the boy’s story — and he defended him anyway.",
      ...
      options:["He helps somebody because he will get money for it.","He helps somebody because he is afraid of the crowd.","He helps somebody who cannot defend himself, even if he doesn’t understand him."],
      answer:2,
  ...
  { n:4, title:"The Royal Banquet",
    ...
    think:{ quote:"Tom is frightened at the banquet — and he still asks the king for mercy for a man he has never met.",
      ...
      options:["Because he knows what it is to be poor and afraid.","Because he wants the nobles to like him.","Because the king told him to do it."],
      answer:0,
  ...
  { n:5, title:"Long Live King Edward!",
    ...
    think:{ quote:"“Rise, Sir Miles Hendon. You may sit in my presence.”",
      ...
      options:["Respect and a promise for the future.","Money for the food and the room.","A joke to make him laugh."],
      answer:0,
  ...
  { n:7, title:"Surprise at Hendon Hall",
    ...
    think:{ quote:"In prison the little king saw, for the first time, what his own laws did to poor people.",
      ...
      options:["That prisons should be more comfortable.","That his brother-in-law Hugh is a bad man.","That a person who decides the rules should know what they do to people."],
      answer:2,
  ...
  { n:8, title:"The Great Seal",
    ...
    think:{ quote:"Tom could keep the crown by saying nothing. He said one sentence instead.",
      ...
      options:["Because he is afraid of the soldiers.","Because he doesn’t like being king.","Because he knows what it is to have nothing, and he could not do that to Edward."],
      answer:2,
