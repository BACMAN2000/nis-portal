        ...
        weeks: [
          ...
          { id:'w0', title:'', games:[
            ...
            { href:'wordsearch-mind-over-matter.html', icon:'🔍', title:'Word Search by Level — Mind Over Matter',
              ...
              tags:['A2','B1','B2','C1'] },
            { href:'word-wheel-u4-by-level.html', icon:'🎡', title:'Word Wheel by Level — Mind Over Matter',
              desc:'The unit’s 36 key words on the same wheel, but grouped A2 to C1 instead of by week: everyday feelings and advice at A2, academic register and the editor’s vocabulary at C1. Progress is kept separate from the weekly wheel.',
              tags:['A2','B1','B2','C1'] },
          ]},
