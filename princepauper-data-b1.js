...
const CHAPTERS = [
  ...
  { n:3, title:"Lost in London", unit:3,
    ...
    think:{ quote:"Miles Hendon did not believe a word of the boy’s story — and he drew his sword for him anyway.",
      ...
      options:["He protects somebody who cannot protect himself, even though he doesn’t understand him.","He helps somebody because he expects a reward.","He acts out of fear of the crowd."],
      answer:0,
  ...
  { n:4, title:"The Royal Banquet", unit:4,
    ...
    think:{ quote:"Tom is terrified at the banquet — and he still asks the dying king for mercy for a stranger.",
      ...
      options:["Because he wants the nobles to approve of him.","Because the king ordered him to.","Because he knows from the inside what it is to be poor and afraid."],
      answer:2,
  ...
  { n:6, title:"The Whipping Boy", unit:6,
    ...
    think:{ quote:"Every time the prince made a mistake, the teacher beat Humphrey and not the prince.",
      ...
      options:["It is unfair: the person who makes the mistake is not the person who pays for it.","It is fair, because Humphrey was paid.","It is unfair only because Humphrey was a child."],
      answer:0,
  ...
  { n:7, title:"Surprise at Hendon Hall", unit:7,
    ...
    think:{ quote:"In prison the little king saw, for the first time, what his own laws did to poor people.",
      ...
      options:["That prisons should be more comfortable.","That Hugh Hendon is an unusually bad man.","That whoever makes the rules should know what they do to the people who live under them."],
      answer:2,
  ...
  { n:8, title:"The Great Seal", unit:8,
    ...
    think:{ quote:"Tom could have kept the crown by saying nothing. He said one sentence instead.",
      ...
      options:["Because he is afraid of being discovered later.","Because he dislikes being king.","Because he knows exactly what it is to have nothing, and he cannot do that to Edward."],
      answer:2,
