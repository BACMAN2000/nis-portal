...
9:{
  ...
  titulo:L('Does Our School Run on Data? · and who it is fair to','Does Our School Run on Data? · y a quién le es justo'),
  ...
  semanas:[
    s(1,'U5',L('The brief, and the machine','El brief, y la máquina'),
      'Vocabulario de la auditoría (screen time, energy consumption, e-waste, policy) y de los elementos narrativos: plot, character, setting, theme, conflict; colocaciones build tension, foreshadow, deliver a twist. Prosodia al leer a Wells en voz alta.',
      'El brief del equipo directivo; The Time Machine, cap. 1.',
      'La pregunta de la auditoría y el plan del equipo: qué, dónde, cuándo, quién, con qué.',
      'Preguntas al equipo directivo; ensayar el plan en una frase.',
      L('Audit question + plan','Pregunta de auditoría + plan'),
      ['U5:Vocabulary Development','U5:Phonics','U5:Reading Plan']),
    s(2,'U5',L('What is already known','Lo que ya se sabe'),
      'Evaluar fuentes: quién lo dice, cómo lo sabe, cuándo, a quién beneficia.',
      'Dos fuentes que discrepan sobre el coste energético de la IA; The Time Machine, cap. 2: el narrador-testigo, estructura y voz, con evidencia del texto.',
      'Tres fuentes clasificadas con lo que cada una permite afirmar; el mapa del relato propio —el año 802.701 del dato— con su análisis de técnica.',
      'Contar la premisa del relato en un minuto y recibir una pregunta.',
      L('Sources + story map','Fuentes + mapa del relato'),
      ['U5:Reading Skills','U5:Textual Comprehension']),
    s(3,'U5',L('Measuring this building','Medir este edificio'),
      'La pasiva para el protocolo; pasado simple, continuo y perfecto; past perfect continuous; adverbios de secuencia (eventually, meanwhile, suddenly) para contar el día de la auditoría.',
      'The Time Machine, cap. 3-4.',
      'El protocolo, la tabla de datos y el gráfico de la cifra principal; escena de prueba de 60-80 palabras con los cuatro tiempos.',
      'Escucha: punto de vista en un extracto de los cap. 3-4; inferir qué quiere el Time Traveller.',
      L('Dataset + four tenses','Datos + los cuatro tiempos'),
      ['U5:Language Conventions (Writing)','U5:Listening Skills']),
    s(4,'U5',L('From data to a recommendation — and to a story','Del dato a la recomendación — y al relato'),
      'Registro de propuesta (I would recommend, it is advisable to); concesión (although, despite, even though); cohesión narrativa con expresiones de tiempo (while, as soon as, by the time); consistencia verbal.',
      '—',
      'Propuesta al equipo directivo, 300-350 palabras: borrador a mano. Short story «The year 802,701», 320-380 palabras: borrador completo.',
      'Role-play: el equipo directivo objeta cada recomendación.',
      L('Proposal draft + story draft','Propuesta y relato en borrador'),
      ['U5:Text Types (Writing)','U5:Idea Development & Process']),
    s(5,'U5',L('Two texts, closed','Dos textos, cerrados'),
      'Autoevaluación del oficio narrativo: ¿qué decisiones literarias tomé?; hedging (may, might, tends to) en la propuesta.',
      '—',
      'Versión final de la propuesta (impresa para el panel) y del relato. PRIMERA EVIDENCIA CALIFICADA: relato + narración oral.',
      'Ensayo de la defensa (seis minutos, desde notas); narración oral del relato y narración colaborativa en grupo.',
      L('Story + oral narrative · proposal final','Relato + narración oral · propuesta final'),
      ['U5:Speaking Skills','U5:Writing Reflection']),
    s(6,'U5',L('The observatory opens','El observatorio abre'),
      'Repaso de la primera mitad.',
      'The Time Machine, cap. 5-6: los Eloi y los Morlocks, el cierre de la primera parte.',
      'Reflexión: qué hizo el colegio con la propuesta.',
  ...
  gana:['Si 9.º presenta B2 First en diciembre —lo dice el Scope, aunque los cursos del portal se lo dan a 10.º: ver la discrepancia abierta— la unidad larga deja noviembre para escritura de examen y speaking, que es lo que el FCE mide. Y si no lo presenta, esas mismas semanas consolidan sin perderse nada.',
        ...
        'La U5 conserva lo que los alumnos ya recibieron el 14 de setiembre —nombre, brief, propuesta y defensa— y suma el relato del Scope sin duplicar trabajo: el relato sigue el mismo número que audita la propuesta y que recoge el instrumento del proyecto.']
},
