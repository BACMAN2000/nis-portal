...
/* ---------------------------------------------------------------- U5 */
{
  ...
  reader:{title:'The Time Machine', series:'Vicens Vives · Reading & Training Step Three B1.2', term:3, inPortal:false,
          note:'The book of the term and the method of the unit: Wells took one fact of 1895 and followed it into the year 802,701. Chapters 1–6 in this unit, on paper; the rest in Unit 6.'},
  exam:{target:'b2first',
        themes:['technology','environment','society','ethics','education'],
        grammar:['proposal register: I would recommend, it is advisable to','passive for processes','concession: although, despite, even though','hedging: may, might, tends to','advanced connectors: nevertheless, moreover, in contrast','narrative tenses: past simple, past continuous, past perfect, past perfect continuous','sequence adverbs: eventually, meanwhile, suddenly'],
        extra:['artificial intelligence','algorithm','data centre','energy consumption','carbon footprint','e-waste','screen time','policy','trade-off','evidence','plot','setting','narrator','foreshadow','twist']},
  areas:[{area:'philosophy', level:2},{area:'ict', level:2},{area:'math', level:2},{area:'comunicacion', level:1}],
  criteria:[
    ...
    {n:4, text:'Story — follow your number into the year 802,701 with the four narrative tenses.',
     levels:{
  ...
  sequence:[
    {n:1,title:'The brief, and the machine',desc:'The leadership team explains what policy they have to write and what they are missing. Teams form and each one takes one question of the audit. And the book of the term opens: Wells, the man who measured his own century and followed it into the future.',
     ...
     across:{
       philosophy:'What “being well” means before anyone measures it: the unit ¿Qué significa ser feliz? starts this same week.',
       ict:'Identifying the project and the single piece of data the instrument will collect: your audit question is the instrument’s question.',
       math:'Domain and range of a real function: what values your number can take, and which it cannot.',
       comunicacion:'The observatory question, written in Spanish to present it to the school.'},
     sessions:[
      ...
      {s:2,title:'What can actually be measured',
       ...
       view:[
         ...
         'Each team drafts its own and passes it to the team on the right. The other team tries to break it: how would you measure THAT, exactly?',
         'The same number is the one the ICT instrument will collect in week 5: choose one a form or a sensor could log.'],
       levels:{
      ...
      {s:3,title:'The Time Machine, chapter one',
       objective:'Read Wells taking one fact of his own time and following it 800,000 years forward — the method your story will borrow.',
       view:[
         'Read the opening aloud, in turns. Wells writing in 1895 about the year 802,701. Where does the voice pause, where does it speed up?',
         'The elements on the board: plot, character, setting, theme, conflict. Find each one in the chapter.',
         'The collocations of the trade: build tension, foreshadow, deliver a twist. Which does Wells use in the first ten pages?',
         'What does he get right about how technology changes a society? What does he invent? Ten minutes of silent reading to close.'],
       levels:{
         'A2':{task:'Answer five comprehension questions and match the five narrative elements to an example from the chapter.',
               help:'Questions with two options each; the elements with a definition.'},
         'B1':{task:'Answer the questions and write what Wells assumes about progress, using three of the unit’s words.',
               help:'Frame: "Wells thinks that…"'},
         'B2':{task:'Explain what Wells gets right and what he invents, with evidence from the text, and name the technique he uses to build tension.',
               help:'Quote at least once.'},
         'C1':{task:'Explain what Wells assumes about progress, whether we still assume it, and how the narrator-witness makes the story believable.',
               help:'Connect it to the debate about AI.'}}},
      {s:4,title:'Building the plan',
       ...
       view:[
         ...
         'The awkward question: what permission do we need, and who asks for it? Coordination has to agree the data and the consent this week, not in week five.',
    ...
    {n:2,title:'What is already known',desc:'The plan under attack, then the research on the energy and water cost of AI. Telling a solid source from a loud one — and, from Wells, how a narrator makes you believe a future.',
     give:'Three sources, classified, with what each one lets you claim; and the map of your story.',
     across:{
       philosophy:'Capability theory (Sen and Nussbaum): being well is what people can do and be — the criterion that says why measure this number and not another.',
       ict:'Web application development with Mimo: first prototype of the form that will collect your number.',
       math:'Studying a real function: the shape of a number that changes over time.',
       comunicacion:'The list of capabilities, translated and discussed.'},
     sessions:[
      {s:1,title:'The plan under attack',
      ...
      {s:2,title:'What the research says about AI and energy',
      ...
      {s:3,title:'Reliable or loud?',
       objective:'Judge a source you found yourself, and see what nobody has measured here.',
       view:[
         'Each team brings a source found outside class. On the board, all of them.',
         'Four tests: who says it, how they know, when, and who benefits. The uncomfortable one: a source that says what we wanted to hear.',
         'On the board, everything the class can now claim with sources — and the list of things nobody has measured at NIS. That second list is your audit.',
         'Hand in: three sources, classified, with what each one lets your team claim.'],
       levels:{
         'A2':{task:'Classify three sources into reliable / not sure, using the four tests.',
               help:'The four tests as a checklist.'},
         'B1':{task:'File your three sources with one usable fact from each, and write what you will have to measure yourself.',
               help:'Useful: "The research shows… but nobody has measured…"'},
         'B2':{task:'File your sources, explain why you discarded one, and say what your measurement adds to what is already published.',
               help:'If it adds nothing, change the question.'},
         'C1':{task:'File your sources ranked by reliability FOR YOUR QUESTION, and identify which of your claims is weakest and why.',
               help:'A source can be excellent and useless for what you are asking.'}}},
      {s:4,title:'Technique and voice: the map of your story',
       objective:'See how Wells makes a future believable, and decide how you will make yours.',
       view:[
         'Chapter two. Why a narrator-witness in the first person and not the Time Traveller himself? Find the sentence where you first believe him.',
         'Structure and voice on the board: exposition, complication, climax; first or third person; linear, in medias res, flashback.',
         'Your story: the year 802,701 of your number. Take the thing you are measuring and follow it forward. Who lives there, and what has it done to them?',
         'Story map in four boxes: protagonist, setting, conflict, twist. Tell the premise to a partner in one minute; take one clarifying question.'],
       levels:{
         'A2':{task:'Complete the story map with the four boxes, choosing your setting from three given.',
               help:'Story map template with an example for a different number.'},
         'B1':{task:'Complete your story map and write which voice you will use and why.',
               help:'Frame: "I chose ___ because it makes the reader feel ___."'},
         'B2':{task:'Complete the story map and write a technique analysis: the voice and structure you chose, with the effect you want on the reader.',
               help:'80–100 words. Quote the sentence of Wells you are imitating.'},
         'C1':{task:'Complete the map and the technique analysis, and say what Wells would have to change in his own chapter to tell YOUR story.',
               help:'The number is the machine. Everything else follows from it.'}}}
     ]},
    {n:3,title:'Measuring this building',desc:'The audit itself, with ICT and Maths: screen minutes, devices, energy, what gets thrown away. Real numbers from NIS — and, on Friday, the grammar for telling what happened.',
     give:'Your dataset, the method you followed, and a test scene in the four tenses.',
     across:{
       philosophy:'The longest study on happiness (Harvard): what can only be known by looking for a long time — and what eleven weeks of data cannot tell you.',
       ict:'Arduino and Tinkercad: the sensor as an instrument. What the hand-count of this week could be logged automatically.',
       math:'Quadratic function: what something that accelerates looks like. Your totals and averages, per student and per room.',
       comunicacion:'The Harvard study, summarised in Spanish.'},
     sessions:[
      ...
      {s:2,title:'Out into the school',
       ...
       view:[
         'Out with ICT: devices, screen minutes, consumption, what gets thrown away.',
      ...
      {s:3,title:'Is this number trustworthy?',
       objective:'Clean the data without hiding what it says, and make the headline figure visible.',
       view:[
         'The pooled data on screen. Which readings look wrong? The rule of the unit: an outlier is investigated, not deleted.',
         'With Maths: totals and averages, per student and per classroom. Which single figure would make the leadership team stop reading and look up?',
         'With ICT: three ways of showing that figure. Which one is understood in five seconds? Build the chart.',
         'The trap: a chart that exaggerates is a chart that gets you caught. Hand in: the dataset, the method and the chart.'],
       levels:{
         'A2':{task:'Work out the total and the average of your data, circle the highest figure and build its chart with the model given.',
               help:'The operations set out; chart with axes ready.'},
         'B1':{task:'Work out totals and averages, build your chart and write the sentence that goes under it.',
               help:'On average, in total, per student. The caption says what the chart cannot.'},
         'B2':{task:'Present your data and explain how you obtained it so it could be repeated; choose the chart type and justify it.',
               help:'The method in three sentences. Why that type and not another.'},
         'C1':{task:'Present the data, the method and the limitations of your measurement, and say what your chart makes visible and what it hides.',
               help:'Every representation chooses. Say what yours chose.'}}},
      {s:4,title:'Narrative tenses: what happened on audit day',
       objective:'Use the four past tenses to tell, in order, what really happened when you measured.',
       view:[
         'Timeline on the board with four sentences from Tuesday: what was happening, what happened, what had happened before, what had been going on for how long.',
         'Past simple, past continuous, past perfect, past perfect continuous — each one has a place on that line. Sequence adverbs to move along it: eventually, meanwhile, suddenly.',
         'Listen to an extract of chapters 3–4: who is telling this, and what does the Time Traveller want when he reaches 802,701? Infer it from what he does, not from what he says.',
         'Test scene, 60–80 words: audit day, the four tenses, one sequence adverb. Swap with a partner: find the four tenses in theirs.'],
       levels:{
         'A2':{task:'Complete the audit-day scene choosing the right tense in eight gaps, then write two sentences of your own.',
               help:'The four tenses with one example each and the timeline.'},
         'B1':{task:'Write the test scene in 60–80 words using at least three of the four tenses and one sequence adverb.',
               help:'Start with "By the time we arrived…"'},
         'B2':{task:'Write the test scene with the four tenses and two sequence adverbs, and answer the listening: what the Time Traveller wants and how you know.',
               help:'Past perfect continuous for how long something had been going on before you got there.'},
         'C1':{task:'Write the scene so the reader can rebuild the timeline without a single date, and explain the narrator’s point of view in the extract.',
               help:'If you have to write "at 10:15", the tenses are not doing their job.'}}}
     ]},
    {n:4,title:'From data to a recommendation — and to a story',desc:'Turning numbers into something somebody can decide on: the proposal, drafted by hand. And the same number followed into the year 802,701: the story, drafted.',
     give:'The draft of the proposal, handwritten, and the draft of the story.',
     across:{
       philosophy:'Religion and stoicism: two traditions that answered “what is being well” before anyone counted anything — the objection your proposal has to take seriously.',
       ict:'Iterative algorithms and recursion: the algorithm that processes your number, step by step.',
       math:'Absolute value and square root functions; and, for the story, how a quantity compounds when it grows every year.',
       comunicacion:'The two traditions contrasted, in writing.'},
     sessions:[
      ...
      {s:4,title:'The story, drafted: the year 802,701',
       objective:'Follow your number into the far future and write what it did to the people who live there.',
       view:[
         'With Maths: if your number grew every year like it grew this year, what is it in 802,701? That figure is the machine of your story. Wells did exactly this with the class divide of 1895.',
         'Story arc on the board: opening, inciting incident, complication, climax, resolution. Plug in your map from week 2 and your test scene from week 3.',
         'Cohesion of time: while, as soon as, by the time, no sooner had… than. Do not change tense without a reason.',
         'Writing workshop: 320–380 words, by hand. Halfway, read your opening sentence aloud to a partner: would they keep reading?'],
       levels:{
         'A2':{task:'Write your story with the five-part arc given, 320–380 words, using the past simple and at least one past perfect.',
               help:'The five openings printed and a bank of time expressions.'},
         'B1':{task:'Write your story in 320–380 words using the four tenses and at least three time expressions.',
               help:'Model opening on a different number.'},
         'B2':{task:'Write your story with the four tenses, the technique you chose in week 2, and the number visible in what has happened to the setting.',
               help:'The reader should meet the consequence before the cause.'},
         'C1':{task:'Write the story so the number is never named: the reader works it out from the world. Consistent tense control throughout.',
               help:'Foreshadow in the first paragraph what the twist confirms in the last.'}}}
     ]},
    {n:5,title:'Two texts, closed',desc:'Both drafts against the rubric, the final versions, and the story out loud. The proposal is printed for the panel; the story is the first graded evidence of the term.',
     give:'The proposal handed in, the story handed in, and your oral narrative.',
     across:{
       philosophy:'Modern eudaimonia (Seligman) and the neuroscience of happiness: the science that would put your number in context.',
       ict:'The instrument, running: the form or the sensor collects the same number you counted by hand in week 3. Do the two agree?',
       math:'Sequences and geometric progression: the compounding you used for the story, now with its formula.',
       comunicacion:'The script for presenting the observatory.'},
     sessions:[
      {s:1,title:'Feedback against the rubric',
       objective:'Improve both texts with the criteria in front of you.',
       view:[
         'The rubric on the table. Each pair reads the other’s proposal against criterion 1, and the other’s story against criterion 4.',
         'Not "I liked it": which level is it at, and what is missing to move up one.',
         'Twenty minutes of silent rewriting, one text each. You choose which one needs it more.',
         'Hand in: the revised drafts, with the changes marked.'],
       levels:{
         'A2':{task:'Mark on the rubric which level each text is at and correct one thing in each.',
               help:'The rubric simplified into a checklist.'},
         'B1':{task:'Assess your partner’s texts against two criteria and rewrite your weakest paragraph.',
               help:'Say what level and what is missing.'},
         'B2':{task:'Assess against the four criteria and rewrite justifying each change.',
      ...
      {s:2,title:'The final versions',
       objective:'Close both texts and check every figure.',
       view:[
         'The final version is not the draft typed up. Read each one aloud once before touching it.',
         'Proposal: check every figure against your table. One wrong number sinks the whole thing. Last read for register: does it sound like a proposal or like an essay?',
         'Story: self-assessment checklist — voice, the four tenses, cohesion, the number visible in the world. What literary choices did I make, and why?',
         'Hand in: the proposal printed for the panel and uploaded to the portal; the story uploaded to the portal.'],
       levels:{
         'A2':{task:'Copy both corrected texts neatly, check your three figures and tick the checklist.',
               help:'Your texts with the corrections marked.'},
         'B1':{task:'Produce both final versions; check figures, units and sources in one, tenses in the other.',
               help:'Checklist of four things to verify per text.'},
         'B2':{task:'Produce the final versions, check that every claim in the proposal is supported, and write the 2–3 literary choices you made in the story.',
               help:'Underline each claim and find its evidence.'},
         'C1':{task:'Produce the final versions, check that no claim goes beyond your data, and write what you would change in the story if you had one more week.',
               help:'The most common error at this level is claiming too much.'}}},
      {s:3,title:'Rehearsing the defence',
      ...
      {s:4,title:'The story, out loud',
       objective:'Tell your story to the group so that they hear the year 802,701 — not read it to them.',
       view:[
         'The teacher tells a fragment first: pauses before the twist, emphasis on the number, eyes on the room. What changed from the written version?',
         'Rehearse in pairs: two minutes each, one technique chosen — the dramatic pause, the change of pace, the voice of a character.',
         'In groups of four: each tells the story of their number. Then the collaborative one: four numbers, one future, told in turns.',
         'Written reflection to close: what did I learn about myself as a writer this term? This is the first graded evidence of the term: story plus oral narrative.'],
       levels:{
         'A2':{task:'Tell your story from four cue cards, using one storytelling technique, and complete the reflection with the three openings given.',
               help:'Cue cards and the openings printed.'},
         'B1':{task:'Tell your story from notes with two techniques, and write your reflection: which choice worked and which did not.',
               help:'Be specific: which sentence, and why.'},
         'B2':{task:'Tell your story without notes, take your turn in the collaborative story keeping the tenses consistent, and write the reflection.',
               help:'Where did the group’s future stop making sense, and who fixed it?'},
         'C1':{task:'Tell it, hold the room through the twist, steer the collaborative story when it drifts, and write what you would do differently as a writer next time.',
               help:'The next story is always better than the first.'}}}
     ]},
    {n:6,title:'The observatory opens',desc:'Half the machine read, the defence in front of the people who will write the policy, what they did with it — and the Show. The bridge to Unit 6: who this future is fair to.',
     give:'The defence before the panel and your reflection.',
     across:{
       philosophy:'Closing the unit: what answer we can already give to the question of happiness — and what any number leaves out.',
       ict:'Presentation of the software project and of the data collected: the instrument on the same table as the proposal.',
       math:'The curve of the number, interpreted and exhibited.',
       comunicacion:'The presentation of the observatory to the rest of the grade.'},
     sessions:[
      {s:1,title:'Half the machine',
       objective:'Close the first half of The Time Machine and see what it has to do with your number.',
       view:[
         'Chapters 5–6: the Eloi above ground, the Morlocks below. Wells took one fact of 1895 — who works and who does not — and this is where it went.',
         'Predict before reading: what does the Time Traveller expect to find beyond the Eloi? Then read and check.',
         'Discussion: which of our numbers, followed far enough, splits people in two? That is the question Unit 6 will ask.',
         'Reading diary: one prediction for the rest of the novel, with the evidence you are basing it on.'],
       levels:{
         'A2':{task:'Answer five questions on chapters 5–6 and write one prediction with the sentence frame given.',
               help:'Questions with two options; frame: "I think that… because…"'},
         'B1':{task:'Summarise what the Time Traveller learns in chapters 5–6 and write your prediction with one piece of evidence.',
               help:'Quote the line that made you think it.'},
         'B2':{task:'Explain what fact of 1895 the Eloi and the Morlocks come from, and which of the class’s numbers could do the same, with your reasoning.',
               help:'Connect Wells’s method to your own story.'},
         'C1':{task:'Explain the two-class future as a narrative technique AND as a problem of justice, and say which of the two Unit 6 should take up.',
               help:'One answer is about craft; the other is about who it is fair to.'}}},
      {s:2,title:'Facing the leadership team',
       objective:'Defend the proposal in front of the people who will write the policy.',
       view:[
         'Six minutes per team, then questions. The panel is real. The ICT instrument is on the table, running: the number it collects is the one you are talking about.',
      ...
      {s:3,title:'What happened with it',
      ...
      {s:4,title:'The Show, and the bridge',
       objective:'Put the grade’s piece on stage, and hand the unit over to the next one.',
       view:[
         'The Creative Arts Show: the grade’s piece is a dramatised reading — one story from the class, or the collaborative future from week 5, told in turns with the techniques you rehearsed.',
         'Run-through with feedback on form only: timing, volume, transitions. Then the real thing.',
         'Back in class: the proposal is with the leadership team, the story is graded, the instrument is collecting. What is still open?',
         'Unit 6 starts from here: you built the instrument — now argue, seriously, that it should not exist. Who is this future fair to?'],
       levels:{
         'A2':{task:'Perform your part in the grade’s piece and write two sentences: what you did and one thing that went well.',
               help:'Your cue cards and two sentence openings.'},
         'B1':{task:'Perform your part and write what the piece needed from you, and what you would keep for Unit 6.',
               help:'Frame: "My part was… Next time I would…"'},
         'B2':{task:'Perform, and write the question your number leaves open for Unit 6 — the one the leadership team did not ask.',
  ...
  deliverables:[
    ...
    {kind:'story', type:'text', icon:'&#9203;', title:'The year 802,701',
     ...
     checklist:[
       ...
       {k:'ppcont', t:'I use the past perfect continuous for how long something had been going on', re:'\\bhad (not )?been [a-z]+ing\\b'},
       {k:'sequence', t:'I move through time with sequence adverbs', re:'\\b(eventually|meanwhile|suddenly|by the time|as soon as|no sooner)\\b'},
       {k:'number', t:'The number I measured is in the story, grown', re:'[0-9][0-9,.]* ?(%|kwh|minutes|hours|devices|litres|liters|kg|years|screens|tablets)'},
       {k:'future', t:'The story reaches the year 802,701', re:'802[,.]?701'}
     ]},
