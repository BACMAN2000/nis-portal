...
9:{
  ...
  titulo:'Does Our School Run on Data? · and who it is fair to',
  hilo:'The first half measures the school and follows what it measured into the year 802,701 in a '+
  ...
  semanas:[
    s(1,'The brief, and the machine',
      'Vocabulary of the audit (screen time, energy consumption, e-waste, policy) and of the narrative elements: plot, character, setting, theme, conflict; collocations build tension, foreshadow, deliver a twist. Prosody when reading Wells aloud.',
      'The leadership team’s brief; The Time Machine, ch. 1.',
      'The audit question and the team’s plan: what, where, when, who, with what.',
      'Questions to the leadership team; rehearsing the plan in one sentence.',
      'Audit question + plan'),
    s(2,'What is already known',
      'Evaluating sources: who says it, how they know, when, who benefits.',
      'Two sources that disagree on the energy cost of AI; The Time Machine, ch. 2: the narrator-witness, structure and voice, with textual evidence.',
      'Three sources classified with what each one lets you claim; the map of your own story — the year 802,701 of your number — with its technique analysis.',
      'Telling the premise of the story in one minute and taking one question.',
      'Sources + story map'),
    s(3,'Measuring this building',
      'The passive for the protocol; Past Simple, Continuous and Perfect; Past Perfect Continuous; sequence adverbs (eventually, meanwhile, suddenly) to tell what happened on audit day.',
      'The Time Machine, ch. 3-4.',
      'The protocol, the data table and the chart of the headline figure; a 60-80 word test scene in the four tenses.',
      'Listening: point of view in an extract from ch. 3-4; inferring what the Time Traveller wants.',
      'Dataset + four tenses'),
    s(4,'From data to a recommendation — and to a story',
      'Proposal register (I would recommend, it is advisable to); concession (although, despite, even though); narrative cohesion with time expressions (while, as soon as, by the time); consistent tense use.',
      '—',
      'Proposal to the leadership team, 300-350 words: handwritten draft. Short story «The year 802,701», 320-380 words: full draft.',
      'Role-play: the leadership team objects to every recommendation.',
      'Proposal draft + story draft'),
    s(5,'Two texts, closed',
      'Self-assessment of narrative craft: what literary choices did I make?; hedging (may, might, tends to) in the proposal.',
      '—',
      'Final version of the proposal (printed for the panel) and of the story. FIRST GRADED PIECE: story + oral narrative.',
      'Rehearsing the defence (six minutes, from notes); oral narrative of the story and collaborative group storytelling.',
      'Story + oral narrative · proposal final'),
    s(6,'The observatory opens',
      'Review of the first half.',
      'The Time Machine, ch. 5-6: the Eloi and the Morlocks, closing the first part.',
  ...
  gana:['If Grade 9 sits B2 First in December — the Scope says so, though the portal courses give it to Grade 10: see the open question — the long unit leaves November for exam writing and speaking, which is what FCE measures. And if it does not sit it, those same weeks consolidate and nothing is lost.',
        ...
        'U5 keeps what the students already received on 14 September — name, brief, proposal and defence — and adds the Scope’s story without doubling the work: the story follows the same number the proposal audits and the project’s instrument collects.']
},
