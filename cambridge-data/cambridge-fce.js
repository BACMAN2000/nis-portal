...
// ===== TEST 1: TECHNOLOGY & DIGITAL LIFE =====
{
  ...
  exercises:[
    {type:"mc",tl:"Use of English",title:"Part 1 - Multiple-choice Cloze",ins:"Choose the correct word (A-D) for each gap.",
     ...
     items:[
       {q:"Gap 1",opts:["deeply","fully","vastly","completely"]},
       {q:"Gap 2",opts:["done","made","caused","let"]},
       {q:"Gap 3",opts:["lifted","risen","raised","put"]},
       {q:"Gap 4",opts:["carried","brought","taken","held"]},
       {q:"Gap 5",opts:["wide","broad","vast","large"]},
       {q:"Gap 6",opts:["outweigh","overcome","overtake","outnumber"]},
       {q:"Gap 7",opts:["method","approach","system","way"]},
       {q:"Gap 8",opts:["remain","last","stay","keep"]}
     ]},
    {type:"fl",tl:"Use of English",title:"Part 2 - Open Cloze",ins:"Write the word which best fits each gap.",
     items:[
       {pre:"Many people are not aware",post:"how much personal data they share online every day."},
       {pre:"It was not",post:"the early 2000s that smartphones became widely available."},
       {pre:"The internet has made it easier for people to work from home,",post:"has changed the structure of many companies."},
       {pre:"You can download the app free",post:"charge from the official website."},
       {pre:"There is no point",post:"buying the latest phone if your current one works perfectly well."},
       {pre:"Artificial intelligence is expected to play a much bigger",post:"in education in the coming years."},
       {pre:"She would have finished the online course",post:"she had not been so busy with work."},
       {pre:"The company is looking",post:"ways of making their products more environmentally friendly."}
     ]},
    {type:"wf",tl:"Use of English",title:"Part 3 - Word Formation",ins:"Use the word given to form a word that fits the gap.",
     items:[
       {pre:"The",root:"DEVELOP",post:"of new software takes a great deal of time and effort."},
       {pre:"Many users find the new interface",root:"COMPLETE",post:"intuitive and easy to navigate."},
       {pre:"There has been a dramatic",root:"IMPROVE",post:"in battery life with the latest model."},
       {pre:"It would be",root:"WISE",post:"to share your password with anyone you do not trust."},
       {pre:"The company made a public",root:"APOLOGISE",post:"after the data breach affected millions of customers."},
       {pre:"Online shopping offers greater",root:"CONVENIENT",post:"than visiting physical stores."},
       {pre:"The",root:"RELY",post:"of the new system has been questioned by several experts."},
       {pre:"It is becoming",root:"INCREASE",post:"difficult to tell real images from those generated by AI."}
     ]},
    {type:"kt",tl:"Use of English",title:"Part 4 - Key Word Transformations",ins:"Use 2-5 words including the word given.",
     items:[
       {src:"She started using social media when she was thirteen.",kw:"BEEN",hint:"Present perfect continuous + since"},
       {src:"They did not let us take photos inside the museum.",kw:"ALLOWED",hint:"Passive voice with allow"},
       {src:"I regret not learning to code when I was younger.",kw:"WISH",hint:"Wish + past perfect for past regret"},
       {src:"It is possible that the file was deleted by mistake.",kw:"MAY",hint:"Modal of deduction + passive"},
       {src:"Despite the rain, they went ahead with the outdoor event.",kw:"EVEN",hint:"Even though + clause"},
       {src:"He is too young to create an account on that platform.",kw:"ENOUGH",hint:"Not + adjective + enough + to"}
     ]},
    {type:"mc",tl:"Reading",title:"Part 5 - Multiple Choice",ins:"Read the text and choose the best answer (A-D).",
     ...
     items:[
       {q:"What was Tim Berners-Lee originally trying to achieve?",opts:["Create a global communication network","Help scientists exchange research more easily","Build a commercial platform for businesses","Design a new programming language"]},
       {q:"What happened to many early internet businesses?",opts:["They all became extremely successful","Most were bought by larger companies","Some failed dramatically after 2000","They relocated to Switzerland"]},
       {q:"Why did Berners-Lee not patent the World Wide Web?",opts:["He did not realise its commercial value","He was not legally permitted to do so","He wanted it to be freely available to all","His employer at CERN held the rights"]},
       {q:"What does the writer suggest about Berners-Lee today?",opts:["He regrets not making money from his invention","He is worried about certain trends in technology","He has retired from public life","He believes technology companies act responsibly"]},
       {q:"What is the purpose of the Solid project?",opts:["To replace the World Wide Web entirely","To create faster internet connections","To let people manage their own data","To compete with social media platforms"]},
       {q:"What is the overall tone of the passage?",opts:["Critical of technology in general","Informative and broadly admiring","Pessimistic about the future of the web","Humorous and light-hearted"]}
     ]},
    {type:"mc",tl:"Listening",title:"Part 1 - Multiple Choice Extracts",ins:"Listen and choose the correct answer.",
     items:[
       {audio:"Woman: Have you tried that new productivity app everyone is talking about? Man: I downloaded it last week, actually. I thought it would be just another gimmick, but I have to say, it has really helped me organise my schedule. I have been getting so much more done since I started using it.",q:"What is the man's opinion of the app?",opts:["He thinks it is overrated","He finds it genuinely useful","He has not tried it yet"]},
       {audio:"Man: I read that they are planning to replace all the library computers with tablets. Woman: Really? I am not sure that is a good idea. Students need proper keyboards for writing essays, and tablets just are not the same, are they?",q:"What does the woman think about the plan?",opts:["She is enthusiastic about it","She thinks it will save money","She has doubts about it"]},
       {audio:"Woman: So how did the online interview go? Man: Well, the connection kept dropping out, which was incredibly frustrating. I think I answered the questions well enough, but I am worried the technical problems may have given a bad impression.",q:"What is the man concerned about?",opts:["He did not prepare enough for the interview","The poor connection may have affected how he came across","He could not understand the interviewer clearly"]},
    ...
    {type:"fl",tl:"Listening",title:"Part 2 - Sentence Completion",ins:"Listen and complete the sentences.",
     ...
     items:[
       {pre:"The first major commercial video game, Pong, was a",post:"simulation."},
       {pre:"The video game market experienced a serious",post:"in 1983."},
       {pre:"The crash was caused by too many",post:"on the market."},
       {pre:"Nintendo helped revive the industry in",post:"with a new console."},
       {pre:"Mario and Zelda are described as",post:"that people still love."},
       {pre:"Sony released the PlayStation in",post:"."},
       {pre:"The PlayStation helped gaming become",post:"rather than just a hobby for children."},
       {pre:"Online gaming allowed players from different countries to compete in",post:"."},
       {pre:"The gaming industry now earns more than the film and",post:"combined."},
       {pre:"Virtual reality needs to become more affordable and",post:"before most people adopt it."}
     ]},
...
// ===== TEST 2: ENVIRONMENT & SUSTAINABILITY =====
{
  ...
  exercises:[
    {type:"mc",tl:"Use of English",title:"Part 1 - Multiple-choice Cloze",ins:"Choose the correct word (A-D) for each gap.",
     ...
     items:[
       {q:"Gap 1",opts:["believed","regarded","thought","viewed"]},
       {q:"Gap 2",opts:["results","effects","reactions","causes"]},
       {q:"Gap 3",opts:["make","do","take","have"]},
       {q:"Gap 4",opts:["effect","result","outcome","product"]},
       {q:"Gap 5",opts:["progress","advance","development","movement"]},
       {q:"Gap 6",opts:["repair","undo","fix","restore"]},
       {q:"Gap 7",opts:["agreement","consensus","harmony","unity"]},
       {q:"Gap 8",opts:["severe","strong","heavy","hard"]}
     ]},
    {type:"fl",tl:"Use of English",title:"Part 2 - Open Cloze",ins:"Write the word which best fits each gap.",
     items:[
       {pre:"Global warming is caused",post:"the excessive burning of fossil fuels."},
       {pre:"Unless we take immediate action, the situation will get",post:"over the coming decades."},
       {pre:"Recycling is one way",post:"which individuals can help reduce waste."},
       {pre:"The government has",post:"criticised for not doing enough to protect natural habitats."},
       {pre:"Many species are",post:"risk of extinction due to habitat loss."},
       {pre:"Solar panels are becoming cheaper,",post:"makes them more accessible to ordinary households."},
       {pre:"It is high time we",post:"the problem of pollution more seriously."},
       {pre:"There is",post:"doubt that climate change poses a threat to food production worldwide."}
     ]},
    {type:"wf",tl:"Use of English",title:"Part 3 - Word Formation",ins:"Use the word given to form a word that fits the gap.",
     items:[
       {pre:"The",root:"DESTROY",post:"of rainforests has accelerated in recent years."},
       {pre:"We need to find",root:"SUSTAIN",post:"ways of producing energy for the future."},
       {pre:"Air",root:"POLLUTE",post:"in major cities has reached dangerous levels."},
       {pre:"Many",root:"ENVIRONMENT",post:"are calling for stricter regulations on industrial waste."},
       {pre:"The",root:"DISAPPEAR",post:"of certain bird species has alarmed conservation groups."},
       {pre:"It is",root:"ESSENTIAL",post:"a problem of overconsumption and waste."},
       {pre:"Renewable energy offers a",root:"PROMISE",post:"alternative to fossil fuels."},
       {pre:"The river was declared",root:"SUIT",post:"for swimming due to high levels of contamination."}
     ]},
    {type:"kt",tl:"Use of English",title:"Part 4 - Key Word Transformations",ins:"Use 2-5 words including the word given.",
     items:[
       {src:"People say that the factory is polluting the river.",kw:"SAID",hint:"Passive reporting structure"},
       {src:"We should have recycled more in the past.",kw:"OUGHT",hint:"Ought to + perfect infinitive"},
       {src:"If they do not act now, the forest will be destroyed.",kw:"UNLESS",hint:"Unless as negative conditional"},
       {src:"They are building a new wind farm near the coast.",kw:"BEING",hint:"Present continuous passive"},
       {src:"I have never seen such a beautiful landscape before.",kw:"MOST",hint:"Superlative structure"},
       {src:"It is not worth trying to clean the polluted lake.",kw:"POINT",hint:"There is no point in + -ing"}
     ]},
    {type:"mc",tl:"Reading",title:"Part 5 - Multiple Choice",ins:"Read the text and choose the best answer (A-D).",
     ...
     items:[
       {q:"What was the main threat to the Ethiopian wolf from domestic dogs?",opts:["Competition for food","Transmission of diseases","Attacks on wolf pups","Noise disturbance"]},
       {q:"What does the writer say about the vaccination campaign?",opts:["It has been one of the most effective measures","It was rejected by local communities","It only targets the wolves themselves","It was started in the 1980s"]},
       {q:"Why does the programme work with local communities?",opts:["Because the government requires it by law","Because conservation depends on local support","Because farmers are the main donors","Because wolves are kept as pets locally"]},
       {q:"What is the role of wolf ambassadors?",opts:["They breed wolves in captivity","They lead tourist groups in the highlands","They observe wolf packs and report problems","They teach at local universities"]},
       {q:"How is climate change affecting the Ethiopian wolf?",opts:["It is forcing wolves into lower valleys","It is reducing their food supply directly","It is causing their habitat to shrink upwards","It is making the wolves more aggressive"]},
       {q:"What is the writer's overall conclusion?",opts:["The Ethiopian wolf will inevitably go extinct","Conservation is too expensive to be practical","Community-based efforts can genuinely help","The programme has been a complete failure"]}
     ]},
    {type:"mc",tl:"Listening",title:"Part 1 - Multiple Choice Extracts",ins:"Listen and choose the correct answer.",
     items:[
       {audio:"Man: I have started composting all our kitchen waste instead of throwing it in the bin. Woman: That is brilliant. Has it been difficult to set up? Man: Not at all. I just bought a small composter for the garden. It takes about five minutes a day, and we have already cut our household waste by about a third.",q:"What has the man found about composting?",opts:["It takes too much effort","It is simple and effective","It is expensive to maintain"]},
       {audio:"Woman: Did you hear that the council is planning to ban single-use plastic bags from next year? Man: About time, if you ask me. I have been using reusable bags for years. It is such a simple change, and it makes a huge difference to the amount of plastic waste that ends up in landfill.",q:"How does the man feel about the plastic bag ban?",opts:["He thinks it is unnecessary","He is strongly in favour of it","He is worried about the cost"]},
    ...
    {type:"fl",tl:"Listening",title:"Part 2 - Sentence Completion",ins:"Listen and complete the sentences.",
     ...
     items:[
       {pre:"The rewilding project in Scotland has been running for",post:"."},
       {pre:"The Eurasian beaver had been extinct in Britain for more than",post:"."},
       {pre:"The beavers were released in a carefully chosen",post:"in 2009."},
       {pre:"Beaver dams help reduce the risk of",post:"in areas downstream."},
       {pre:"The wetlands created by beaver dams support wildlife such as otters, dragonflies, and",post:"."},
       {pre:"The project has planted more than",post:"native trees."},
       {pre:"The main types of trees planted include birch, oak, and",post:"."},
       {pre:"Biodiversity in the area has gone up by about",post:"."},
       {pre:"Some local",post:"were against the beaver reintroduction at first."},
       {pre:"Most farmers now agree that the",post:"to the wider community are worth it."}
     ]},
    {type:"wr",tl:"Writing",title:"Part 1 - Essay",ins:"Write an essay (140-190 words).",
...
// ===== TEST 3: EDUCATION & LEARNING =====
{
  ...
  exercises:[
    {type:"mc",tl:"Use of English",title:"Part 1 - Multiple-choice Cloze",ins:"Choose the correct word (A-D) for each gap.",
     ...
     items:[
       {q:"Gap 1",opts:["brought","called","put","drawn"]},
       {q:"Gap 2",opts:["attract","engage","involve","interest"]},
       {q:"Gap 3",opts:["work","focus","concentrate","deal"]},
       {q:"Gap 4",opts:["area","matter","topic","content"]},
       {q:"Gap 5",opts:["response","feedback","answer","reaction"]},
       {q:"Gap 6",opts:["concerns","worries","troubles","anxieties"]},
       {q:"Gap 7",opts:["meeting","finding","reaching","getting"]},
       {q:"Gap 8",opts:["harmony","balance","mixture","combination"]}
     ]},
    {type:"fl",tl:"Use of English",title:"Part 2 - Open Cloze",ins:"Write the word which best fits each gap.",
     items:[
       {pre:"She has always been good",post:"mathematics, even as a young child."},
       {pre:"The number of students applying to university has gone",post:"significantly in recent years."},
       {pre:"He failed the exam",post:"he had not studied enough."},
       {pre:"The school provides extra support for students",post:"are struggling with their coursework."},
       {pre:"They were made",post:"wear uniforms at their previous school."},
       {pre:"I would have passed the test if I",post:"spent more time revising."},
       {pre:"There are a number of factors that need to be taken",post:"account when choosing a university."},
       {pre:"Learning a foreign language is",post:"as difficult as many people believe."}
     ]},
    {type:"wf",tl:"Use of English",title:"Part 3 - Word Formation",ins:"Use the word given to form a word that fits the gap.",
     items:[
       {pre:"A good",root:"EDUCATE",post:"is essential for success in the modern world."},
       {pre:"The student showed great",root:"DETERMINE",post:"to overcome the difficulties she faced."},
       {pre:"Many young people feel enormous",root:"PRESS",post:"to achieve high grades."},
       {pre:"The teacher gave an",root:"EXPLAIN",post:"that was clear and easy to follow."},
       {pre:"It is important not to",root:"ESTIMATE",post:"the value of lifelong learning."},
       {pre:"Reading widely can greatly broaden your",root:"KNOW",post:"of the world."},
       {pre:"Her",root:"ACHIEVE",post:"in the final exam was truly outstanding."},
       {pre:"The new policy was met with",root:"APPROVE",post:"from both students and parents."}
     ]},
    {type:"kt",tl:"Use of English",title:"Part 4 - Key Word Transformations",ins:"Use 2-5 words including the word given.",
     items:[
       {src:"The last time I took an exam was two years ago.",kw:"TAKEN",hint:"Present perfect + for"},
       {src:"They think the new curriculum is too demanding.",kw:"CONSIDERED",hint:"Passive with consider"},
       {src:"She managed to finish the assignment despite being ill.",kw:"SUCCEEDED",hint:"Succeed in + -ing"},
       {src:"I am sorry I did not attend your lecture.",kw:"APOLOGISE",hint:"Apologise for + -ing"},
       {src:"The teacher said we must hand in our essays by Friday.",kw:"TOLD",hint:"Reported speech with tell + infinitive"},
       {src:"Nobody in the class is as talented as Maria.",kw:"MOST",hint:"Superlative comparison"}
     ]},
    {type:"mc",tl:"Reading",title:"Part 5 - Multiple Choice",ins:"Read the text and choose the best answer (A-D).",
     ...
     items:[
       {q:"What surprises many people about Finnish education?",opts:["Children must pass an entrance exam at age five","The school day is very long and intensive","Children start formal schooling later than elsewhere","Teachers are poorly paid compared to other countries"]},
       {q:"Why do talented graduates want to become teachers in Finland?",opts:["Teaching pays more than any other profession","The profession is highly respected and offers freedom","There are no other career options available","The government forces top graduates into teaching"]},
       {q:"How does Finland deal with students who struggle academically?",opts:["They are transferred to special schools","They receive extra support from an early stage","They are required to repeat the entire school year","Their parents must pay for private tutoring"]},
       {q:"What is a key characteristic of the Finnish education system?",opts:["Heavy reliance on standardised testing","A strong focus on equal opportunity for all","Competition between schools for funding","Strict national curriculum with no flexibility"]},
       {q:"What do Finnish educators say about copying their model?",opts:["They actively encourage other countries to adopt it exactly","They admit it may not work everywhere without adaptation","They believe it is the only correct approach to education","They refuse to discuss their methods with other countries"]},
       {q:"What is the main point of the passage?",opts:["Finland spends too little on education","Testing is the best way to improve results","Finland shows that a different approach to education can succeed","Private schools are more effective than public ones"]}
     ]},
    {type:"mc",tl:"Listening",title:"Part 1 - Multiple Choice Extracts",ins:"Listen and choose the correct answer.",
     items:[
    ...
    {type:"fl",tl:"Listening",title:"Part 2 - Sentence Completion",ins:"Listen and complete the sentences.",
     ...
     items:[
       {pre:"Playing a musical instrument activates multiple areas of the brain at the",post:"."},
       {pre:"The brain areas involved include motor control, auditory processing, and",post:"."},
       {pre:"A major study was carried out at the University of",post:"."},
       {pre:"Children who had music lessons for two years improved in reading and",post:"."},
       {pre:"The greatest benefits were seen among children from",post:"."},
       {pre:"Older adults who played an instrument for at least",post:"did better on memory tests."},
       {pre:"The memory study was published in the Journal of",post:"."},
       {pre:"Learning music teaches discipline and",post:"."},
       {pre:"Mastering an instrument requires thousands of hours of",post:"."},
       {pre:"Many professional musicians describe performing as deeply",post:"."}
     ]},
    {type:"wr",tl:"Writing",title:"Part 1 - Essay",ins:"Write an essay (140-190 words).",
...
// ===== TEST 4: HEALTH & WELL-BEING =====
{
  ...
  exercises:[
    {type:"mc",tl:"Use of English",title:"Part 1 - Multiple-choice Cloze",ins:"Choose the correct word (A-D) for each gap.",
     ...
     items:[
       {q:"Gap 1",opts:["growth","rise","increase","expansion"]},
       {q:"Gap 2",opts:["numbers","amounts","volumes","quantities"]},
       {q:"Gap 3",opts:["over","along","across","through"]},
       {q:"Gap 4",opts:["impact","force","power","strength"]},
       {q:"Gap 5",opts:["known","called","named","referred"]},
       {q:"Gap 6",opts:["static","inactive","idle","motionless"]},
       {q:"Gap 7",opts:["block","barrier","wall","limit"]},
       {q:"Gap 8",opts:["habits","customs","traditions","practices"]}
     ]},
    {type:"fl",tl:"Use of English",title:"Part 2 - Open Cloze",ins:"Write the word which best fits each gap.",
     items:[
       {pre:"A balanced diet, combined",post:"regular exercise, is the key to a healthy lifestyle."},
       {pre:"She has been suffering",post:"severe headaches for the past three weeks."},
       {pre:"The doctor advised him",post:"cut down on sugar and processed foods."},
       {pre:"Heart disease is one of the leading causes",post:"death in developed countries."},
       {pre:"If he",post:"followed the doctor's advice, he would be in much better shape now."},
       {pre:"You should try to get",post:"least seven hours of sleep every night."},
       {pre:"There has been a great deal",post:"research into the link between diet and mental health."},
       {pre:"Stress can have a negative effect on your health",post:"you are aware of it or not."}
     ]},
    {type:"wf",tl:"Use of English",title:"Part 3 - Word Formation",ins:"Use the word given to form a word that fits the gap.",
     items:[
       {pre:"Regular exercise can greatly improve your physical and",root:"PSYCHOLOGY",post:"well-being."},
       {pre:"The",root:"FIT",post:"industry has grown enormously over the past decade."},
       {pre:"Lack of sleep can lead to poor",root:"CONCENTRATE",post:"during the day."},
       {pre:"Smoking is",root:"DOUBT",post:"one of the most harmful habits a person can have."},
       {pre:"Good nutrition is",root:"ABSOLUTE",post:"essential during childhood."},
       {pre:"There is a growing",root:"AWARE",post:"of the importance of mental health."},
       {pre:"The",root:"EFFECT",post:"of the new treatment has been confirmed by several studies."},
       {pre:"His",root:"RECOVER",post:"after the operation was remarkably quick."}
     ]},
    {type:"kt",tl:"Use of English",title:"Part 4 - Key Word Transformations",ins:"Use 2-5 words including the word given.",
     items:[
       {src:"He last went to the gym three months ago.",kw:"BEEN",hint:"Present perfect negative + for"},
       {src:"Running every day is something I am used to now.",kw:"ACCUSTOMED",hint:"Become accustomed to + -ing"},
       {src:"The doctor told me not to eat fatty food.",kw:"ADVISED",hint:"Passive with advise + not to"},
       {src:"Perhaps she is feeling unwell today.",kw:"MIGHT",hint:"Modal of deduction - might"},
       {src:"They opened the new hospital last year.",kw:"WAS",hint:"Past simple passive"},
       {src:"I find it difficult to get up early every morning.",kw:"TROUBLE",hint:"Have trouble + -ing"}
     ]},
    {type:"mc",tl:"Reading",title:"Part 5 - Multiple Choice",ins:"Read the text and choose the best answer (A-D).",
     ...
     items:[
       {q:"What does the writer say about how people treat sleep?",opts:["Most people get enough sleep","Sleep is often not given enough priority","People sleep too much in modern society","Scientists disagree about the need for sleep"]},
       {q:"According to the Nature study, what happens to people who sleep less than six hours?",opts:["They are more likely to become ill","They perform better at work","They need less food","They have stronger immune systems"]},
       {q:"How does sleep deprivation affect the brain?",opts:["It improves creativity","It has no measurable impact","It reduces the ability to think clearly and control emotions","It makes people more cautious in their decisions"]},
       {q:"What criticism does the writer make about some business leaders?",opts:["They sleep too much during the day","They encourage unhealthy attitudes towards sleep","They refuse to fund sleep research","They force employees to work night shifts"]},
       {q:"What has happened in schools that start later?",opts:["Students complained about the change","There was no noticeable difference","Results and behaviour improved","Teachers refused to change their schedules"]},
       {q:"What is the writer's overall message?",opts:["Sleep is less important than diet and exercise","Getting enough sleep is vital and society should recognise this","Only teenagers need more sleep","The science on sleep is still inconclusive"]}
     ]},
    {type:"mc",tl:"Listening",title:"Part 1 - Multiple Choice Extracts",ins:"Listen and choose the correct answer.",
     items:[
       {audio:"Woman: I have been trying meditation for the past month. At first I found it really hard to sit still for ten minutes, but now I actually look forward to it. It has made a noticeable difference to my stress levels. Man: I have heard a lot of people say that. Maybe I should give it a try.",q:"What has the woman discovered about meditation?",opts:["It was easy from the very beginning","It has helped reduce her stress","She finds it boring and unhelpful"]},
       {audio:"Man: I went to the doctor about my back pain, and she recommended swimming. Apparently it is one of the best exercises for strengthening your back without putting too much strain on your joints. Woman: That makes sense. I swim twice a week and I never have any back problems.",q:"Why was swimming recommended to the man?",opts:["It is the cheapest form of exercise","It burns the most calories","It is gentle on the joints and good for the back"]},
    ...
    {type:"fl",tl:"Listening",title:"Part 2 - Sentence Completion",ins:"Listen and complete the sentences.",
     ...
     items:[
       {pre:"Scientists used to treat the brain and the gut as completely",post:"."},
       {pre:"The gut contains roughly",post:"bacteria."},
       {pre:"The bacteria in the gut are known collectively as the gut",post:"."},
       {pre:"People with diverse gut bacteria have lower rates of depression and",post:"."},
       {pre:"An imbalanced microbiome has been linked to irritable bowel syndrome and",post:"."},
       {pre:"The probiotic experiment was carried out at University College",post:"in Ireland."},
       {pre:"The researchers gave probiotic bacteria to a group of",post:"."},
       {pre:"The gut communicates with the brain through the",post:"."},
       {pre:"The most important factor for gut health is",post:"."},
       {pre:"Processed foods and too much",post:"tend to reduce microbial diversity."}
     ]},
    {type:"wr",tl:"Writing",title:"Part 1 - Essay",ins:"Write an essay (140-190 words).",
...
// ===== TEST 5: ARTS & CULTURE =====
{
  ...
  exercises:[
    {type:"mc",tl:"Use of English",title:"Part 1 - Multiple-choice Cloze",ins:"Choose the correct word (A-D) for each gap.",
     ...
     items:[
       {q:"Gap 1",opts:["place","role","part","function"]},
       {q:"Gap 2",opts:["common","plain","ordinary","regular"]},
       {q:"Gap 3",opts:["threat","pressure","danger","risk"]},
       {q:"Gap 4",opts:["do","make","take","put"]},
       {q:"Gap 5",opts:["point","bring","stand","speak"]},
       {q:"Gap 6",opts:["participation","attendance","presence","involvement"]},
       {q:"Gap 7",opts:["discovered","concluded","resulted","determined"]},
       {q:"Gap 8",opts:["argument","debate","quarrel","dispute"]}
     ]},
    {type:"fl",tl:"Use of English",title:"Part 2 - Open Cloze",ins:"Write the word which best fits each gap.",
     items:[
       {pre:"The painting was so lifelike that it could easily be mistaken",post:"a photograph."},
       {pre:"She has been playing the violin",post:"she was five years old."},
       {pre:"The novel, which was written",post:"a previously unknown author, became an international bestseller."},
       {pre:"He is regarded",post:"one of the most influential artists of the twentieth century."},
       {pre:"The exhibition is well worth",post:"if you have any interest in modern sculpture."},
       {pre:"There were",post:"many people at the concert that we could not find a seat."},
       {pre:"The play is",post:"on a true story from the nineteenth century."},
       {pre:"Not",post:"is she an accomplished painter, but she is also a talented musician."}
     ]},
    {type:"wf",tl:"Use of English",title:"Part 3 - Word Formation",ins:"Use the word given to form a word that fits the gap.",
     items:[
       {pre:"The",root:"PERFORM",post:"received a standing ovation from the audience."},
       {pre:"His paintings are known for their",root:"ORDINARY",post:"use of colour and light."},
       {pre:"The museum has an impressive",root:"COLLECT",post:"of ancient Greek sculptures."},
       {pre:"She showed great",root:"CREATE",post:"in her approach to the project."},
       {pre:"The",root:"POPULAR",post:"of street art has grown enormously in recent years."},
       {pre:"It is virtually",root:"POSSIBLE",post:"to get tickets for the show at such short notice."},
       {pre:"The festival celebrates the cultural",root:"DIVERSE",post:"of the region."},
       {pre:"His latest novel was a huge commercial",root:"SUCCEED",post:"and sold over a million copies."}
     ]},
    {type:"kt",tl:"Use of English",title:"Part 4 - Key Word Transformations",ins:"Use 2-5 words including the word given.",
     items:[
       {src:"People believe that the painting is over 500 years old.",kw:"BELIEVED",hint:"Passive reporting structure"},
       {src:"She has never performed in front of such a large audience before.",kw:"FIRST",hint:"It is the first time + present perfect"},
       {src:"I would prefer to go to the cinema rather than the theatre.",kw:"RATHER",hint:"Would rather + base verb"},
       {src:"He started writing poetry when he was a teenager.",kw:"SINCE",hint:"Present perfect continuous + since"},
       {src:"The gallery was too crowded for us to enjoy the exhibition.",kw:"SO",hint:"So + adjective + that"},
       {src:"We were not allowed to take photographs inside the cathedral.",kw:"LET",hint:"Let + object + bare infinitive"}
     ]},
    {type:"mc",tl:"Reading",title:"Part 5 - Multiple Choice",ins:"Read the text and choose the best answer (A-D).",
     ...
     items:[
       {q:"How has the perception of street art changed?",opts:["It is still largely considered to be vandalism","It has gone from being rejected to being respected","It has always been popular with art critics","It is only valued outside the United Kingdom"]},
       {q:"What happened to Girl with Balloon?",opts:["It was destroyed completely at auction","It was stolen from a gallery","It was partly shredded and then sold for more money","It was donated to a museum by Banksy"]},
       {q:"Why is Banksy's identity significant?",opts:["The mystery increases public interest in the work","Banksy's real name has been confirmed by police","Knowing the artist would reduce the value of the work","Banksy has revealed his identity on social media"]},
       {q:"What criticism is made of Banksy in the text?",opts:["The quality of the art is declining","Banksy has become part of the system being criticised","Banksy's work is too difficult for most people to understand","Banksy charges too much for commissions"]},
       {q:"Why do some people defend Banksy's approach?",opts:["Banksy only sells work through traditional galleries","The art is accessible to everyone without cost","Banksy donates all profits to charity","Only art experts can fully appreciate the work"]},
       {q:"What is the writer's overall attitude towards Banksy?",opts:["Strongly negative and dismissive","Balanced and acknowledging Banksy's influence","Uncritical and entirely admiring","Confused and unable to form an opinion"]}
     ]},
    {type:"mc",tl:"Listening",title:"Part 1 - Multiple Choice Extracts",ins:"Listen and choose the correct answer.",
     items:[
    ...
    {type:"fl",tl:"Listening",title:"Part 2 - Sentence Completion",ins:"Listen and complete the sentences.",
     ...
     items:[
       {pre:"The first permanent photograph was created in",post:"by a French inventor."},
       {pre:"The first photograph showed the view from Niepce's",post:"."},
       {pre:"The exposure time for the first photograph was approximately",post:"."},
       {pre:"The daguerreotype was introduced by Louis Daguerre in",post:"."},
       {pre:"George Eastman developed flexible",post:"in the 1880s."},
       {pre:"Kodak's famous slogan was: You press the button, we do the",post:"."},
       {pre:"The first digital camera was built by an engineer named",post:"."},
       {pre:"Kodak filed for",post:"in 2012."},
       {pre:"Today, most photographs are taken on",post:"."},
       {pre:"Around 1.4 trillion",post:"are captured around the world each year."}
     ]},
    {type:"wr",tl:"Writing",title:"Part 1 - Essay",ins:"Write an essay (140-190 words).",
...
// ===== TEST 6: PSYCHOLOGY & HUMAN BEHAVIOUR =====
{
  ...
  exercises:[
    {type:"mc",tl:"Use of English",title:"Part 1 - Multiple-choice Cloze",ins:"Choose the correct word (A-D) for each gap.",
     ...
     items:[
       {q:"Gap 1",opts:["decided","settled","determined","resolved"]},
       {q:"Gap 2",opts:["discovered","pioneered","invented","originated"]},
       {q:"Gap 3",opts:["reach","arrive","get","achieve"]},
       {q:"Gap 4",opts:["meet","encounter","face","find"]},
       {q:"Gap 5",opts:["achievement","success","victory","triumph"]},
       {q:"Gap 6",opts:["incorporate","include","contain","involve"]},
       {q:"Gap 7",opts:["lifted","raised","grown","risen"]},
       {q:"Gap 8",opts:["role","place","position","part"]}
     ]},
    {type:"fl",tl:"Use of English",title:"Part 2 - Open Cloze",ins:"Write the word which best fits each gap.",
     items:[
       {pre:"People tend to behave differently when they know they are",post:"observed."},
       {pre:"The experiment was carried",post:"under strictly controlled laboratory conditions."},
       {pre:"She could not help",post:"nervous before her first public speaking engagement."},
       {pre:"Research suggests that first impressions are formed",post:"just a few seconds of meeting someone."},
       {pre:"The psychologist asked the participants",post:"they had experienced any significant life changes recently."},
       {pre:"Human beings have a natural tendency to conform to the behaviour",post:"the group they belong to."},
       {pre:"The results were",post:"surprising that the researchers decided to repeat the experiment."},
       {pre:"It took him a long time to get",post:"the disappointment of not being selected for the team."}
     ]},
    {type:"wf",tl:"Use of English",title:"Part 3 - Word Formation",ins:"Use the word given to form a word that fits the gap.",
     items:[
       {pre:"The",root:"BEHAVE",post:"of the participants changed significantly during the study."},
       {pre:"Her",root:"ANXIOUS",post:"increased as the deadline approached."},
       {pre:"It is important to distinguish between",root:"RATIONAL",post:"fears and genuine dangers."},
       {pre:"The",root:"LONELY",post:"experienced by elderly people is a growing social problem."},
       {pre:"His",root:"RELUCTANT",post:"to ask for help made the situation worse."},
       {pre:"The study provided",root:"VALUE",post:"insights into how children learn to share."},
       {pre:"There is a strong",root:"CONNECT",post:"between physical exercise and improved mood."},
       {pre:"The therapist helped her to",root:"COME",post:"her fear of flying."}
     ]},
    {type:"kt",tl:"Use of English",title:"Part 4 - Key Word Transformations",ins:"Use 2-5 words including the word given.",
     items:[
       {src:"It is thought that happiness depends more on relationships than money.",kw:"THOUGHT",hint:"Passive reporting with infinitive"},
       {src:"I am sure she did not do it on purpose.",kw:"HAVE",hint:"Cannot have + past participle"},
       {src:"He only realised his mistake after the meeting had ended.",kw:"UNTIL",hint:"Not until structure"},
       {src:"Despite feeling nervous, she gave an excellent presentation.",kw:"FACT",hint:"In spite of the fact that + clause"},
       {src:"The experiment was so complex that nobody could replicate it.",kw:"TOO",hint:"Too + adjective + for + object"},
       {src:"She would prefer not to discuss her personal problems.",kw:"RATHER",hint:"Would rather + not + base verb"}
     ]},
    {type:"mc",tl:"Reading",title:"Part 5 - Multiple Choice",ins:"Read the text and choose the best answer (A-D).",
     ...
     items:[
       {q:"What was the original purpose of the experiment?",opts:["To train students to become prison guards","To study how people react to having or lacking power","To test new methods of treating prisoners","To compare American and British prison systems"]},
       {q:"Why was the experiment stopped early?",opts:["The funding ran out after six days","The building was needed for other purposes","The behaviour of participants became dangerously extreme","The prisoners escaped from the simulated prison"]},
       {q:"What does the writer say about Zimbardo's role?",opts:["He remained completely neutral throughout","He became too involved and did not stop things soon enough","He left the experiment after the first day","He treated the prisoners worse than the guards did"]},
       {q:"What has recent research revealed about the experiment?",opts:["The results were even more dramatic than reported","The guards may have been influenced more than originally admitted","All participants were professional actors","The experiment actually lasted several months"]},
       {q:"What do critics say the experiment actually demonstrates?",opts:["That all humans are naturally violent","That authority figures can shape behaviour more than situations","That psychology experiments are always unreliable","That prisons should be abolished"]},
       {q:"What is the overall significance of the experiment according to the text?",opts:["It is considered completely discredited and irrelevant","It continues to raise important questions about ethics and human nature","It proved that prisoners are more dangerous than guards","It led to major reforms in the American prison system"]}
     ]},
    {type:"mc",tl:"Listening",title:"Part 1 - Multiple Choice Extracts",ins:"Listen and choose the correct answer.",
     items:[
       {audio:"Woman: I have been reading about the psychology of procrastination. Apparently, it is not really about laziness at all. It is more about avoiding negative emotions associated with a task. Man: That makes a lot of sense. I always put off doing my tax return because it makes me anxious, not because I am lazy.",q:"What do the speakers learn about procrastination?",opts:["It is caused by being lazy","It is linked to avoiding unpleasant feelings","It mainly affects students"]},
    ...
    {type:"fl",tl:"Listening",title:"Part 2 - Sentence Completion",ins:"Listen and complete the sentences.",
     ...
     items:[
       {pre:"More than half of all communication is",post:"."},
       {pre:"Paul Ekman was an American",post:"who studied facial expressions."},
       {pre:"Ekman identified seven basic",post:"that are universal across cultures."},
       {pre:"The expressions for these emotions are considered to be",post:"rather than learned."},
       {pre:"Ekman's coding system for facial muscles is called",post:"."},
       {pre:"The system has been used by law enforcement to help detect",post:"."},
       {pre:"A genuine smile is called a",post:"."},
       {pre:"Fake smiles only involve the muscles of the",post:"."},
       {pre:"Amy Cuddy is a social",post:"who researched body language and confidence."},
       {pre:"Adopting expansive postures can increase feelings of",post:"."}
     ]},
    {type:"wr",tl:"Writing",title:"Part 1 - Essay",ins:"Write an essay (140-190 words).",
...
// ===== TEST 7: HISTORY & SOCIETY =====
{
  ...
  exercises:[
    {type:"mc",tl:"Use of English",title:"Part 1 - Multiple-choice Cloze",ins:"Choose the correct word (A-D) for each gap.",
     ...
     items:[
       {q:"Gap 1",opts:["gain","earn","win","obtain"]},
       {q:"Gap 2",opts:["make","drive","push","run"]},
       {q:"Gap 3",opts:["included","contained","composed","involved"]},
       {q:"Gap 4",opts:["sound","noise","voice","speech"]},
       {q:"Gap 5",opts:["reach","approach","access","enter"]},
       {q:"Gap 6",opts:["given","created","produced","formed"]},
       {q:"Gap 7",opts:["demand","requirement","necessity","condition"]},
       {q:"Gap 8",opts:["problems","matters","challenges","issues"]}
     ]},
    {type:"fl",tl:"Use of English",title:"Part 2 - Open Cloze",ins:"Write the word which best fits each gap.",
     items:[
       {pre:"The Roman Empire is often referred",post:"as one of the greatest civilisations in history."},
       {pre:"It was",post:"until the nineteenth century that most European countries abolished slavery."},
       {pre:"The war broke",post:"in 1914 and lasted for four devastating years."},
       {pre:"The museum has",post:"closed for renovation since the beginning of the year."},
       {pre:"No one knows for certain",post:"caused the decline of the Mayan civilisation."},
       {pre:"The treaty was signed by",post:"countries in an effort to establish lasting peace."},
       {pre:"She devoted her entire life",post:"fighting for the rights of the working class."},
       {pre:"In spite",post:"the harsh conditions, the expedition succeeded in reaching the South Pole."}
     ]},
    {type:"wf",tl:"Use of English",title:"Part 3 - Word Formation",ins:"Use the word given to form a word that fits the gap.",
     items:[
       {pre:"The",root:"DISCOVER",post:"of ancient tombs provided new insights into Egyptian burial practices."},
       {pre:"The museum contains a fascinating",root:"EXHIBIT",post:"on life in medieval England."},
       {pre:"The",root:"INVADE",post:"of Normandy in 1944 was a turning point in the Second World War."},
       {pre:"Historical",root:"ACCURATE",post:"in the film were criticised by several scholars."},
       {pre:"The",root:"GOVERN",post:"introduced sweeping reforms after the revolution."},
       {pre:"Her",root:"BRAVE",post:"during the conflict earned her a medal of honour."},
       {pre:"The",root:"SETTLE",post:"was established by traders in the early sixteenth century."},
       {pre:"The king's",root:"DECIDE",post:"to raise taxes led to widespread unrest among the population."}
     ]},
    {type:"kt",tl:"Use of English",title:"Part 4 - Key Word Transformations",ins:"Use 2-5 words including the word given.",
     items:[
       {src:"They built the castle in the fourteenth century.",kw:"WAS",hint:"Past simple passive"},
       {src:"We started the project three months ago and are still working on it.",kw:"WORKING",hint:"Present perfect continuous"},
       {src:"The historian said that the document was probably a forgery.",kw:"MIGHT",hint:"Reported modal of deduction"},
       {src:"It was wrong of them to demolish the historic building.",kw:"SHOULD",hint:"Should + perfect infinitive for criticism"},
       {src:"The new law made it illegal for children to work in factories.",kw:"LONGER",hint:"No longer + passive"},
       {src:"She knows more about ancient Rome than anyone else in the department.",kw:"NOBODY",hint:"Nobody + comparison"}
     ]},
    {type:"mc",tl:"Reading",title:"Part 5 - Multiple Choice",ins:"Read the text and choose the best answer (A-D).",
     ...
     items:[
       {q:"What made the eruption of Vesuvius so significant for archaeology?",opts:["It created a new island in the Mediterranean","It preserved a Roman city in remarkable detail","It destroyed all written records of the Roman period","It was the last volcanic eruption in Europe"]},
       {q:"What do the graffiti at Pompeii tell us?",opts:["That Romans were unable to read or write","That wall inscriptions were illegal in Roman times","About the everyday thoughts and humour of ordinary people","That the walls were in poor condition before the eruption"]},
       {q:"What problem affected early excavations at Pompeii?",opts:["There was not enough funding to dig properly","Valuable items were taken without proper documentation","The volcanic ash was too hard to remove","Local residents refused to allow excavation"]},
       {q:"Why are parts of Pompeii deteriorating?",opts:["Because of weather damage and high visitor numbers","Because the Italian government refuses to maintain the site","Because new volcanic activity is damaging the ruins","Because archaeologists are removing too many artefacts"]},
       {q:"What controversial solution has been suggested?",opts:["Closing the site permanently to all visitors","Rebuilding the city exactly as it was","Reburying some areas to protect them","Moving all artefacts to museums abroad"]},
       {q:"What broader issue does Pompeii illustrate?",opts:["The danger of living near active volcanoes","The conflict between protecting heritage and allowing public access","The superiority of Roman engineering over modern techniques","The declining interest in ancient history"]}
     ]},
    {type:"mc",tl:"Listening",title:"Part 1 - Multiple Choice Extracts",ins:"Listen and choose the correct answer.",
     items:[
       {audio:"Woman: I visited the new World War One exhibition at the Imperial War Museum. What really struck me was the section on the ordinary soldiers' letters home. They were incredibly moving. You could feel the fear and loneliness in every word. Man: I must go and see it. There is something about personal accounts that textbooks just cannot capture.",q:"What made the strongest impression on the woman?",opts:["The collection of weapons on display","The personal letters written by soldiers","The interactive map of the battlefields"]},
    ...
    {type:"fl",tl:"Listening",title:"Part 2 - Sentence Completion",ins:"Listen and complete the sentences.",
     ...
     items:[
       {pre:"Zheng He led seven major expeditions between 1405 and",post:"."},
       {pre:"The largest vessels in the fleet were called",post:"."},
       {pre:"These ships were approximately",post:"long."},
       {pre:"The first voyage included more than",post:"vessels."},
       {pre:"The fleet carried nearly",post:"crew members on the first expedition."},
       {pre:"The main aim of the voyages was",post:"rather than conquest."},
       {pre:"Among the exotic items received were spices, precious stones, and",post:"."},
       {pre:"After Zheng He died, the emperor ordered the fleet to be",post:"."},
       {pre:"Some historians say the fleet became too",post:"to maintain."},
       {pre:"Confucian scholars reportedly disapproved of foreign trade and",post:"."}
     ]},
    {type:"wr",tl:"Writing",title:"Part 1 - Essay",ins:"Write an essay (140-190 words).",
...
// ===== TEST 8: SCIENCE & DISCOVERY =====
{
  ...
  exercises:[
    {type:"mc",tl:"Use of English",title:"Part 1 - Multiple-choice Cloze",ins:"Choose the correct word (A-D) for each gap.",
     ...
     items:[
       {q:"Gap 1",opts:["throw","shed","cast","put"]},
       {q:"Gap 2",opts:["chance","luck","fortune","accident"]},
       {q:"Gap 3",opts:["part","role","share","piece"]},
       {q:"Gap 4",opts:["said","spoke","told","put"]},
       {q:"Gap 5",opts:["important","significant","considerable","notable"]},
       {q:"Gap 6",opts:["pressing","pushing","squeezing","forcing"]},
       {q:"Gap 7",opts:["doubt","suspicion","distrust","disbelief"]},
       {q:"Gap 8",opts:["apply","use","employ","practise"]}
     ]},
    {type:"fl",tl:"Use of English",title:"Part 2 - Open Cloze",ins:"Write the word which best fits each gap.",
     items:[
       {pre:"The experiment was designed to test",post:"the new drug was effective against the virus."},
       {pre:"Scientists have",post:"trying to find a cure for the disease for over thirty years."},
       {pre:"The results turned",post:"to be far more surprising than anyone had expected."},
       {pre:"Little",post:"known about the long-term effects of the chemical on human health."},
       {pre:"The theory was eventually proved wrong,",post:"having been widely accepted for decades."},
       {pre:"She was awarded the Nobel Prize",post:"her groundbreaking work in genetics."},
       {pre:"The team succeeded",post:"developing a vaccine in record time."},
       {pre:"If the data",post:"been collected more carefully, the conclusions would have been more reliable."}
     ]},
    {type:"wf",tl:"Use of English",title:"Part 3 - Word Formation",ins:"Use the word given to form a word that fits the gap.",
     items:[
       {pre:"The",root:"SCIENCE",post:"community was divided over the interpretation of the results."},
       {pre:"Her",root:"DISCOVER",post:"of the new species attracted international attention."},
       {pre:"The experiment required extreme",root:"PRECISE",post:"in order to produce reliable results."},
       {pre:"The",root:"EXIST",post:"of life on other planets remains unproven."},
       {pre:"Many",root:"RESEARCH",post:"believe that a breakthrough is imminent."},
       {pre:"It is",root:"DANGER",post:"to draw conclusions from such a small sample size."},
       {pre:"The findings were",root:"EXPECT",post:"and challenged several long-held assumptions."},
       {pre:"Space",root:"EXPLORE",post:"has fascinated humanity for centuries."}
     ]},
    {type:"kt",tl:"Use of English",title:"Part 4 - Key Word Transformations",ins:"Use 2-5 words including the word given.",
     items:[
       {src:"Scientists believe the universe began with a massive explosion.",kw:"BELIEVED",hint:"Passive reporting + perfect infinitive"},
       {src:"The experiment failed because the equipment was faulty.",kw:"DUE",hint:"Due to + noun"},
       {src:"He was not experienced enough to lead the research team.",kw:"LITTLE",hint:"Too little + noun + to"},
       {src:"She did not expect the results to be so dramatic.",kw:"CAME",hint:"Come as a surprise"},
       {src:"If we do not invest in science, progress will slow down.",kw:"WITHOUT",hint:"Without + noun as conditional"},
       {src:"Nobody has ever observed this phenomenon before.",kw:"NEVER",hint:"Present perfect passive + never"}
     ]},
    {type:"mc",tl:"Reading",title:"Part 5 - Multiple Choice",ins:"Read the text and choose the best answer (A-D).",
     ...
     items:[
       {q:"Why was the discovery of the Higgs boson so important?",opts:["It disproved the Standard Model of physics","It confirmed a key prediction about how particles gain mass","It showed that the speed of light can be exceeded","It led to the immediate development of new technology"]},
       {q:"What does the writer say about the nickname God particle?",opts:["It was invented by CERN's marketing team","Physicists generally approve of the name","Most physicists are not fond of the nickname","The name was chosen by the discoverers"]},
       {q:"What is the Large Hadron Collider?",opts:["A telescope used to observe distant galaxies","A machine that accelerates and collides particles","A computer used to simulate the Big Bang","A laboratory for testing nuclear weapons"]},
       {q:"What criticism was made of the project?",opts:["It was completed too quickly without proper testing","The discovery had no scientific value","The enormous cost was hard to justify for an abstract finding","Too few countries were involved in the research"]},
       {q:"How do supporters defend investment in fundamental research?",opts:["It always leads to immediate commercial profits","Past basic research has led to transformative technologies","Governments are legally required to fund all scientific projects","The discoveries can be sold to private companies"]},
       {q:"What do physicists hope to investigate next?",opts:["How to build a faster collider","Dark matter, dark energy, and gravity","Whether the Higgs boson really exists","How to travel faster than light"]}
     ]},
    {type:"mc",tl:"Listening",title:"Part 1 - Multiple Choice Extracts",ins:"Listen and choose the correct answer.",
     items:[
       {audio:"Woman: I went to a public lecture on black holes last night. The speaker was brilliant at making really complex ideas accessible. She used everyday analogies that made everything much easier to grasp. Man: That is a rare skill. So many scientists struggle to communicate their work to non-specialists.",q:"What did the woman appreciate about the lecture?",opts:["The speaker used highly technical language","The speaker explained difficult concepts clearly","The lecture was very short and concise"]},
       {audio:"Man: I have just read that scientists have managed to grow a human ear on a 3D printer using living cells. Woman: That is extraordinary. The potential for medicine is incredible. Imagine being able to print replacement organs for people who need transplants. Man: We are still a long way from that, but it is definitely heading in the right direction.",q:"What is the man's view of 3D-printed organs?",opts:["The technology will never work in practice","It is promising but not yet fully developed","It is already being used in hospitals"]},
       {audio:"Woman: Did you know that octopuses have three hearts and blue blood? Man: Yes, and they can change colour in milliseconds to blend in with their surroundings. They are probably the most intelligent invertebrates on the planet. It makes you wonder what other extraordinary abilities exist in the animal kingdom that we have not discovered yet.",q:"What fascinates the man about octopuses?",opts:["Their remarkable intelligence and abilities","Their similarity to human beings","Their ability to survive on land"]},
       {audio:"Man: My daughter wants to study marine biology at university. She has been passionate about the ocean ever since we took her snorkelling in the Red Sea when she was eight. Woman: It is wonderful when children find something they are truly passionate about. Marine biology is such an important field, especially with everything happening to coral reefs.",q:"What does the woman think about the daughter's choice?",opts:["She thinks it is an impractical career choice","She is supportive and sees it as an important field","She believes the daughter should study medicine instead"]},
       {audio:"Woman: I am reading a fascinating book about the human brain. Did you know that the brain uses about twenty percent of the body's total energy, even though it only makes up about two percent of body weight? Man: That is remarkable. It just goes to show how much processing power is required to keep everything running smoothly.",q:"What surprises the speakers about the brain?",opts:["It is larger than most people think","It uses a disproportionately large amount of energy","It does not require any energy at all"]},
       {audio:"Man: I saw a documentary about CRISPR gene editing technology. The idea that scientists can now cut and paste sections of DNA is both exciting and terrifying. Woman: I agree. The medical potential is enormous, but there are serious ethical questions about editing human genes, especially when it comes to future generations.",q:"What concern does the woman raise about gene editing?",opts:["It is too expensive to be practical","There are ethical issues around modifying human DNA","The technology does not actually work yet"]},
       {audio:"Woman: Have you heard about the mission to send a probe to Europa, one of Jupiter's moons? Scientists think there might be a liquid ocean beneath the ice, which could potentially harbour life. Man: That would be the most significant discovery in human history if they found even the simplest organisms.",q:"Why is Europa of interest to scientists?",opts:["It has a breathable atmosphere","It may have an ocean that could contain life","It is the closest moon to Earth"]},
       {audio:"Man: I tried one of those DNA ancestry tests. It told me I am forty percent Scandinavian, which was a complete surprise. My family has lived in southern England for as long as anyone can remember. Woman: Well, the Vikings did settle extensively in Britain. Perhaps you have some distant Norse ancestors.",q:"What surprised the man about his DNA results?",opts:["He had no European ancestry at all","A large percentage of his DNA was Scandinavian","His results were identical to his sister's"]}
     ]},
    {type:"fl",tl:"Listening",title:"Part 2 - Sentence Completion",ins:"Listen and complete the sentences.",
     ...
     items:[
       {pre:"The Human Genome Project was launched in",post:"."},
       {pre:"Scientists from",post:"were involved in the collaboration."},
       {pre:"The project took",post:"to finish."},
       {pre:"The total cost was approximately",post:"."},
       {pre:"The human genome contains roughly",post:"."},
       {pre:"Before the project, scientists estimated between 80,000 and",post:"."},
       {pre:"Human DNA consists of about three billion",post:"."},
       {pre:"DNA is arranged along 23 pairs of",post:"."},
       {pre:"All humans share approximately",post:"of their DNA."},
       {pre:"Personalised medicine tailors treatments to a person's",post:"."}
     ]},
    {type:"wr",tl:"Writing",title:"Part 1 - Essay",ins:"Write an essay (140-190 words).",
...
// ===== TEST 9: MEDIA & COMMUNICATION =====
{
  ...
  exercises:[
    {type:"mc",tl:"Use of English",title:"Part 1 - Multiple-choice Cloze",ins:"Choose the correct word (A-D) for each gap.",
     ...
     items:[
       {q:"Gap 1",opts:["knowledge","belief","recognition","imagination"]},
       {q:"Gap 2",opts:["lay off","put off","turn off","take off"]},
       {q:"Gap 3",opts:["complicated","worsened","troubled","disturbed"]},
       {q:"Gap 4",opts:["basis","standard","feature","mark"]},
       {q:"Gap 5",opts:["much","far","very","highly"]},
       {q:"Gap 6",opts:["handle","tackle","manage","deal"]},
       {q:"Gap 7",opts:["task","balancing act","operation","process"]},
       {q:"Gap 8",opts:["account","check","trial","justice"]}
     ]},
    {type:"fl",tl:"Use of English",title:"Part 2 - Open Cloze",ins:"Write the word which best fits each gap.",
     items:[
       {pre:"The article was shared",post:"thousands of people on social media within hours."},
       {pre:"It makes no",post:"whether you read the news online or in print; what matters is accuracy."},
       {pre:"Many people do not bother to check",post:"the information they share online is actually true."},
       {pre:"The journalist refused to reveal the identity of",post:"source, even under intense pressure."},
       {pre:"Local newspapers play an important role",post:"keeping communities informed about what is happening in their area."},
       {pre:"The programme would not have been broadcast",post:"the lawyers had not approved the content."},
       {pre:"There is",post:"doubt that social media has transformed the way we consume news."},
       {pre:"The editor was criticised",post:"publishing the story without verifying the facts first."}
     ]},
    {type:"wf",tl:"Use of English",title:"Part 3 - Word Formation",ins:"Use the word given to form a word that fits the gap.",
     items:[
       {pre:"The",root:"JOURNAL",post:"spent months investigating the corruption scandal."},
       {pre:"The spread of",root:"INFORM",post:"online is a growing concern for democracies worldwide."},
       {pre:"The documentary provided a",root:"THOUGHT",post:"analysis of the refugee crisis."},
       {pre:"Many",root:"ADVERTISE",post:"use emotional language to persuade consumers."},
       {pre:"The newspaper issued a formal",root:"CORRECT",post:"after publishing inaccurate information."},
       {pre:"Freedom of the press is",root:"WIDE",post:"regarded as a cornerstone of democracy."},
       {pre:"The show attracted an",root:"BELIEVE",post:"number of viewers on its opening night."},
       {pre:"She gave a powerful and",root:"PERSUADE",post:"speech about the dangers of censorship."}
     ]},
    {type:"kt",tl:"Use of English",title:"Part 4 - Key Word Transformations",ins:"Use 2-5 words including the word given.",
     items:[
       {src:"The newspaper did not print the story because it was inaccurate.",kw:"WOULD",hint:"Third conditional with would have"},
       {src:"He denied having leaked the document to the press.",kw:"DENIED",hint:"Deny + that clause"},
       {src:"They are interviewing the witnesses at the moment.",kw:"BEING",hint:"Present continuous passive"},
       {src:"The journalist said she had already filed her report.",kw:"TOLD",hint:"Reported speech with tell"},
       {src:"Reading the news every day is something I have always done.",kw:"USED",hint:"Be used to + -ing"},
       {src:"It was such a shocking headline that everyone talked about it.",kw:"SO",hint:"So + adjective + that"}
     ]},
    {type:"mc",tl:"Reading",title:"Part 5 - Multiple Choice",ins:"Read the text and choose the best answer (A-D).",
     ...
     items:[
       {q:"What does the writer say about the origins of podcasting?",opts:["It was immediately popular with a wide audience","It started as a small-scale activity for tech fans","It was invented by a major media company","It replaced radio within a few years"]},
       {q:"Why are podcasts appealing to listeners?",opts:["They can only be accessed at specific times","They offer flexibility in what and when you listen","They are shorter than radio programmes","They feature only professional broadcasters"]},
       {q:"What was significant about the podcast Serial?",opts:["It was the first podcast ever created","It was only available in the United States","It helped make podcasting mainstream","It was produced by a television network"]},
       {q:"What advantage does podcasting offer to creators?",opts:["Guaranteed income from the first episode","Complete creative control over content","Access to professional recording studios","Automatic distribution through radio stations"]},
       {q:"What concern do some podcast fans have?",opts:["That large companies may undermine the medium's independence","That podcasts are becoming too short","That the sound quality is declining","That there are too few podcasts available"]},
       {q:"What comparison does the writer draw at the end?",opts:["Between podcasting and television viewing habits","Between podcasts in different countries","Between podcasting's evolution and other creative industries affected by digital change","Between the cost of podcasting and traditional broadcasting"]}
     ]},
    {type:"mc",tl:"Listening",title:"Part 1 - Multiple Choice Extracts",ins:"Listen and choose the correct answer.",
     items:[
       {audio:"Woman: I have completely stopped watching the news on television. It is always so negative and sensationalised. I prefer to read a few trusted online sources where the reporting is more balanced. Man: I understand the feeling, but I worry that too many people are retreating into their own information bubbles, only reading things that confirm what they already believe.",q:"What is the man concerned about?",opts:["That television news is too positive","That people only seek out information they agree with","That online news is always more accurate"]},
    ...
    {type:"fl",tl:"Listening",title:"Part 2 - Sentence Completion",ins:"Listen and complete the sentences.",
     ...
     items:[
       {pre:"The earliest known writing appeared in ancient Mesopotamia around",post:"."},
       {pre:"Writing was inscribed on",post:"."},
       {pre:"The ancient Egyptians used",post:"for writing."},
       {pre:"The codex format appeared during the",post:"."},
       {pre:"Gutenberg invented the printing press in",post:"."},
       {pre:"The press was invented in the city of",post:"in Germany."},
       {pre:"Within fifty years, approximately",post:"volumes had been printed."},
       {pre:"The printing press helped fuel the Renaissance, the Reformation, and the",post:"."},
       {pre:"In 2023, global audiobook sales exceeded",post:"."},
       {pre:"Despite predictions, physical book sales have remained",post:"."}
     ]},
    {type:"wr",tl:"Writing",title:"Part 1 - Essay",ins:"Write an essay (140-190 words).",
...
// ===== TEST 10: TRAVEL & GLOBAL ISSUES =====
{
  ...
  exercises:[
    {type:"mc",tl:"Use of English",title:"Part 1 - Multiple-choice Cloze",ins:"Choose the correct word (A-D) for each gap.",
     ...
     items:[
       {q:"Gap 1",opts:["piece","part","fraction","section"]},
       {q:"Gap 2",opts:["growth","increase","spread","rise"]},
       {q:"Gap 3",opts:["places","heritage","tradition","property"]},
       {q:"Gap 4",opts:["attractions","locations","positions","situations"]},
       {q:"Gap 5",opts:["direction","movement","trend","fashion"]},
       {q:"Gap 6",opts:["reputation","popularity","fame","prominence"]},
       {q:"Gap 7",opts:["approach","method","system","technique"]},
       {q:"Gap 8",opts:["way","balance","middle","solution"]}
     ]},
    {type:"fl",tl:"Use of English",title:"Part 2 - Open Cloze",ins:"Write the word which best fits each gap.",
     items:[
       {pre:"She has travelled to more than forty countries",post:"she graduated from university."},
       {pre:"The flight was delayed",post:"to severe weather conditions at the departure airport."},
       {pre:"I would love to visit Japan",post:"I had enough money to afford the trip."},
       {pre:"We had",post:"a wonderful time in Portugal that we decided to go back the following year."},
       {pre:"It took us three hours to get",post:"customs and immigration at the airport."},
       {pre:"The hotel turned",post:"to be much better than we had expected."},
       {pre:"Travelling by train is often more comfortable",post:"flying, especially on shorter journeys."},
       {pre:"He speaks fluent French,",post:"proved extremely useful during our stay in Paris."}
     ]},
    {type:"wf",tl:"Use of English",title:"Part 3 - Word Formation",ins:"Use the word given to form a word that fits the gap.",
     items:[
       {pre:"The",root:"TOUR",post:"industry was severely affected by the pandemic."},
       {pre:"The view from the top of the mountain was absolutely",root:"BREATH",post:"."},
       {pre:"Many travellers are",root:"AWARE",post:"of the customs regulations in the countries they visit."},
       {pre:"The",root:"ACCOMMODATE",post:"in the city centre was surprisingly affordable."},
       {pre:"There has been a noticeable",root:"REDUCE",post:"in the number of flights during the off-peak season."},
       {pre:"The",root:"FRIEND",post:"of the local people made our trip truly memorable."},
       {pre:"It is",root:"ADVISE",post:"to book your tickets well in advance during the summer months."},
       {pre:"The island remains relatively",root:"SPOIL",post:"despite the increase in visitor numbers."}
     ]},
    {type:"kt",tl:"Use of English",title:"Part 4 - Key Word Transformations",ins:"Use 2-5 words including the word given.",
     items:[
       {src:"I have never been to a more beautiful place than this.",kw:"MOST",hint:"Superlative structure"},
       {src:"We could not go to the beach because it was raining.",kw:"PREVENTED",hint:"Prevent + object + from + -ing"},
       {src:"She only started travelling abroad after she finished her studies.",kw:"UNTIL",hint:"Not until structure"},
       {src:"They say the museum is worth visiting.",kw:"SAID",hint:"Passive reporting with infinitive"},
       {src:"I regret not booking the hotel earlier.",kw:"WISH",hint:"Wish + past perfect"},
       {src:"The holiday was so expensive that we had to borrow money.",kw:"SUCH",hint:"Such + a/an + adjective + noun + that"}
     ]},
    {type:"mc",tl:"Reading",title:"Part 5 - Multiple Choice",ins:"Read the text and choose the best answer (A-D).",
     ...
     items:[
       {q:"Why did Greta Thunberg choose to sail across the Atlantic?",opts:["She was afraid of flying","She wanted to demonstrate the environmental cost of flying","She could not afford an airline ticket","She wanted to set a sailing record"]},
       {q:"How did Thunberg's protest movement begin?",opts:["With a speech at the United Nations","Through a viral social media campaign","With a solo protest outside the Swedish parliament","At a conference organised by environmental groups"]},
       {q:"What is the core of Thunberg's message?",opts:["Young people should leave school permanently","Politicians should follow scientific evidence on climate","Aviation should be banned immediately","Only Sweden is taking climate change seriously"]},
       {q:"How have some politicians responded to Thunberg?",opts:["They have all praised her efforts publicly","Some have dismissed her as inexperienced and influenced by others","They have offered her a role in government","They have ignored her completely"]},
       {q:"How does Thunberg deal with criticism?",opts:["She refuses to speak to the media","She reacts with anger and hostility","She remains calm and argues it shows her message is effective","She has stopped her activism because of it"]},
       {q:"What does the writer conclude about Thunberg's impact?",opts:["She has had little effect on public debate","She has brought climate change to the forefront of global discussion","Her methods have been entirely counterproductive","She is only influential in Scandinavian countries"]}
     ]},
    {type:"mc",tl:"Listening",title:"Part 1 - Multiple Choice Extracts",ins:"Listen and choose the correct answer.",
     items:[
    ...
    {type:"fl",tl:"Listening",title:"Part 2 - Sentence Completion",ins:"Listen and complete the sentences.",
     ...
     items:[
       {pre:"Ecotourism involves responsible travel that conserves the environment and benefits",post:"."},
       {pre:"The concept of ecotourism first became popular in the",post:"."},
       {pre:"Costa Rica is widely considered the",post:"of ecotourism."},
       {pre:"Around twenty-five percent of Costa Rica's",post:"is now protected."},
       {pre:"Tourism has become Costa Rica's largest source of",post:"."},
       {pre:"Tourism revenue in Costa Rica is greater than earnings from coffee and",post:"."},
       {pre:"In Kenya, local people manage wildlife areas through community",post:"."},
       {pre:"Elephant numbers in the Maasai Mara have risen by",post:"."},
       {pre:"Companies making false environmental claims is known as",post:"."},
       {pre:"Travellers should look for recognised",post:"to verify genuine ecotourism."}
     ]},
    {type:"wr",tl:"Writing",title:"Part 1 - Essay",ins:"Write an essay (140-190 words).",
...
if (typeof window !== 'undefined') { window.CAM_FCE = CAM_FCE; }
