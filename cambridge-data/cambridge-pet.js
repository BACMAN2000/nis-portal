...
{t:"Practice Test 1",exercises:[
  {type:"mc",tl:"Reading",title:"Part 1 - Short Texts",ins:"Read each text and choose the correct answer.",
   items:[
    {q:"AIRPORT NOTICE: All passengers must show their boarding pass and photo ID before entering the departure area.",opts:["You only need your boarding pass to enter","Two documents are required to enter the departure area","Photo ID is not accepted at this airport"]},
    {q:"HOTEL: Guests who wish to extend their stay should contact reception before 10 AM on the day of departure.",opts:["You can only leave the hotel before 10 AM","You should tell reception early if you want to stay longer","The hotel closes at 10 AM"]},
    {q:"Dear Maria, Our flight has been delayed by two hours. I will pick you up at 9 PM instead of 7 PM. - David",opts:["David is cancelling the trip","Maria needs to arrive two hours early","David will arrive later than planned"]},
    {q:"TRAIN STATION: Return tickets are valid for one month from the date of purchase.",opts:["You must travel back within one month","Single tickets last one month","Return tickets can only be used on the same day"]},
    {q:"TOURIST INFORMATION: Free city maps are available at the front desk. Guided tours depart at 11 AM daily.",opts:["You must pay for a city map","Maps and tours are both free","You can get a free map and join a tour at 11 AM"]}
  ]},
  {type:"mc",tl:"Reading",title:"Part 3 - Reading Comprehension",ins:"Read the text and choose the best answer.",
   ...
   items:[
    {q:"How did Clara pay for her trip?",opts:["Her parents gave her the money","She saved money from a part-time job","She won a travel competition"]},
    {q:"What surprised Clara in Lima?",opts:["How expensive the hostel was","How unfriendly people were","How welcoming other travellers were"]},
    {q:"Who did Clara visit Machu Picchu with?",opts:["Her parents","Some German students","A tour guide from the hostel"]},
    {q:"What did Clara learn to do in Buenos Aires?",opts:["Cook local food","Speak Spanish fluently","Dance the tango"]},
    {q:"How did Clara feel when she returned home?",opts:["More confident and independent","Tired and disappointed","Worried about money"]}
  ]},
  {type:"mc",tl:"Reading",title:"Part 4 - Multiple-choice Cloze",ins:"Choose the correct word for each space.",
   ...
   items:[
    {q:"Gap 1",opts:["prefer","rather","like","enjoy"]},
    {q:"Gap 2",opts:["less","fewer","smaller","lower"]},
    {q:"Gap 3",opts:["that","what","which","where"]},
    {q:"Gap 4",opts:["mainly","especially","mostly","hardly"]},
    {q:"Gap 5",opts:["still","yet","even","already"]},
    {q:"Gap 6",opts:["arrive","get","reach","come"]}
  ]},
  {type:"fl",tl:"Reading",title:"Part 5 - Open Cloze",ins:"Write one word for each space.",
   items:[
    {pre:"She has lived in London",post:"2018."},
    {pre:"I am not used",post:"getting up so early."},
    {pre:"There were very",post:"tourists at the museum today."},
    {pre:"He asked me",post:"I had ever been to Paris."},
    {pre:"We need to set",post:"early tomorrow morning."},
    {pre:"This is the best holiday I have",post:"had."}
  ]},
  {type:"kt",tl:"Reading",title:"Part 6 - Sentence Transformations",ins:"Complete the second sentence so it means the same as the first. Use 1-3 words including the given word.",
   items:[
    {src:"I started learning French three years ago.",kw:"FOR",hint:"Present perfect + for"},
    {src:"This hotel is cheaper than the one we stayed at last year.",kw:"EXPENSIVE",hint:"Not as ... as comparison"},
    {src:"Someone stole my suitcase at the airport.",kw:"WAS",hint:"Passive voice"},
    {src:"It is not necessary to book in advance.",kw:"HAVE",hint:"Modal: don't have to"},
    {src:"The journey was too long for the children.",kw:"ENOUGH",hint:"Too/enough transformation"},
    {src:"'I will call you tomorrow,' said Tom.",kw:"WOULD",hint:"Reported speech"}
  ]},
  {type:"mc",tl:"Listening",title:"Part 2 - Longer Recording",ins:"Listen and choose the correct answer.",
   ...
   items:[
    {q:"Why did Jake choose to travel to Southeast Asia?",opts:["He read about it in a magazine","His sister recommended it","He won a free ticket"]},
    {q:"What was the best experience of Jake's trip?",opts:["Visiting temples in Cambodia","Eating street food in Vietnam","A cooking class in Thailand"]},
    {q:"How long did the cooking teacher spend making Thai food?",opts:["Over thirty years","Five years","One afternoon"]},
    {q:"What happened to Jake in Laos?",opts:["He lost his passport","He became ill","He missed his flight"]},
    {q:"Who helped Jake when he was unwell?",opts:["Other travellers","His family","The guesthouse staff"]},
    {q:"What does Jake plan to do next?",opts:["Return to Thailand","Travel to Indonesia","Visit his sister"]}
  ]},
...
{t:"Practice Test 2",exercises:[
  {type:"mc",tl:"Reading",title:"Part 1 - Short Texts",ins:"Read each text and choose the correct answer.",
   items:[
    {q:"COMPUTER LAB: Please save all work to your own USB drive. Files left on the desktop will be deleted every evening.",opts:["Your files will be safe on the desktop overnight","You should save your work on a USB drive","USB drives are not allowed in the lab"]},
    {q:"Dear customers, our website will be unavailable from midnight to 6 AM on Saturday for essential maintenance. We apologise for any inconvenience.",opts:["The website is permanently closing","The website will not work for part of Saturday","Customers should contact the company on Saturday"]},
    {q:"PHONE SHOP: Trade in your old phone and get up to 150 pounds off a new model.",opts:["New phones cost 150 pounds","You can exchange your old phone for a discount","Old phones are sold for 150 pounds"]},
    {q:"WARNING: This software update requires at least 2 GB of free space. Please check your storage before proceeding.",opts:["The update will give you 2 GB of space","You need enough free space before updating","The software costs 2 pounds"]},
    {q:"Hi Sam, I have just bought a new tablet. It was much cheaper online than in the shop. You should check the website! - Nico",opts:["Nico prefers shopping in stores","The tablet was more expensive online","Nico found a better price on the internet"]}
  ]},
  {type:"mc",tl:"Reading",title:"Part 3 - Reading Comprehension",ins:"Read the text and choose the best answer.",
   ...
   items:[
    {q:"What did people do in music shops in the 1980s and 1990s?",opts:["They downloaded songs","They looked through CDs before buying","They listened to streaming services"]},
    {q:"What happened when digital music arrived?",opts:["More music shops opened","People could buy single songs","CDs became more expensive"]},
    {q:"What do streaming services offer?",opts:["Free CDs by post","Access to millions of songs for a fee","Discounts on concert tickets"]},
    {q:"Why do some people think streaming is a problem?",opts:["It is too expensive","People may value music less","The sound quality is very poor"]},
    {q:"What is the writer's conclusion about streaming?",opts:["It will soon disappear","It is the future of music listening","It is only popular with older people"]}
  ]},
  {type:"mc",tl:"Reading",title:"Part 4 - Multiple-choice Cloze",ins:"Choose the correct word for each space.",
   ...
   items:[
    {q:"Gap 1",opts:["communicate","say","speak","tell"]},
    {q:"Gap 2",opts:["However","Nowadays","Although","Despite"]},
    {q:"Gap 3",opts:["do","get","make","have"]},
    {q:"Gap 4",opts:["result","effect","cause","reason"]},
    {q:"Gap 5",opts:["take","bring","lead","carry"]},
    {q:"Gap 6",opts:["weight","balance","measure","level"]}
  ]},
  {type:"fl",tl:"Reading",title:"Part 5 - Open Cloze",ins:"Write one word for each space.",
   items:[
    {pre:"This laptop is",post:"expensive than the one I wanted."},
    {pre:"I have not seen him",post:"a long time."},
    {pre:"She was talking",post:"the phone when I arrived."},
    {pre:"Would you mind",post:"off the computer?"},
    {pre:"It depends",post:"how much memory you need."},
    {pre:"He is interested",post:"learning about programming."}
  ]},
  {type:"kt",tl:"Reading",title:"Part 6 - Sentence Transformations",ins:"Complete the second sentence so it means the same as the first. Use 1-3 words including the given word.",
   items:[
    {src:"They built this computer in Japan.",kw:"WAS",hint:"Passive voice"},
    {src:"I have never used this app before.",kw:"FIRST",hint:"First time + present perfect"},
    {src:"My old phone was not as fast as this one.",kw:"FASTER",hint:"Comparative adjective"},
    {src:"You are not allowed to use phones in the exam.",kw:"MUST",hint:"Modal: must not"},
    {src:"I regret not buying the cheaper laptop.",kw:"WISH",hint:"Wish + past perfect"},
    {src:"'I am fixing the computer,' said the technician.",kw:"WAS",hint:"Reported speech - past continuous"}
  ]},
  {type:"mc",tl:"Listening",title:"Part 2 - Longer Recording",ins:"Listen and choose the correct answer.",
   ...
   items:[
    {q:"What does Dr. Patel say about screens?",opts:["They are always harmful","They are a problem when used too much","They have no effect on health"]},
    {q:"What should people do before going to sleep?",opts:["Use their phone for one hour","Avoid screens for at least an hour","Watch relaxing videos"]},
    {q:"How long should young children use screens each day?",opts:["No more than one hour","At least two hours","As long as they want"]},
    {q:"What problem has Dr. Patel noticed in children who watch too many videos?",opts:["They eat too much","They cannot sleep","They have trouble concentrating at school"]},
    {q:"How does Dr. Patel use technology for health?",opts:["She uses a fitness tracker","She watches exercise videos","She reads health articles online"]},
    {q:"What is Dr. Patel's overall view of technology?",opts:["It is mostly harmful","It depends on how it is used","It should be avoided"]}
  ]},
  {type:"wr",tl:"Writing",title:"Part 2 - Article or Story",ins:"Write about 100 words.",
...
{t:"Practice Test 3",exercises:[
  {type:"mc",tl:"Reading",title:"Part 1 - Short Texts",ins:"Read each text and choose the correct answer.",
   items:[
    {q:"PARK NOTICE: Please do not feed the birds. Bread is harmful to their health.",opts:["Feeding birds is encouraged in this park","You should not give food to the birds","Bread is available for sale in the park"]},
    {q:"CITY COUNCIL: From next month, all plastic bags will cost 20p each. Please bring your own reusable bags when shopping.",opts:["Plastic bags will be free from next month","Shoppers are advised to bring their own bags","The city is banning all types of bags"]},
    {q:"Dear neighbours, Please remember to put recycling bins out on Tuesday evenings, not Wednesday mornings. Thank you. - Building Manager",opts:["Recycling collection is on Wednesday morning","Bins should be placed outside on Tuesday evening","Recycling has been cancelled this week"]},
    {q:"NATURE RESERVE: Visitors must stay on the marked paths. Dogs are not permitted in this area.",opts:["You can walk anywhere you like with your dog","Dogs are welcome if they stay on the paths","You must follow the paths and leave dogs at home"]},
    {q:"SCHOOL: All students are invited to join the new environment club. We meet every Thursday at lunchtime in Room 12.",opts:["The environment club is only for certain students","Students can join the club on Thursdays at lunch","Room 12 is closed on Thursdays"]}
  ]},
  {type:"mc",tl:"Reading",title:"Part 3 - Reading Comprehension",ins:"Read the text and choose the best answer.",
   ...
   items:[
    {q:"How much plastic enters the oceans each year?",opts:["Eight thousand tonnes","Eight million tonnes","Eighty million tonnes"]},
    {q:"What are microplastics?",opts:["Large pieces of ocean waste","Tiny pieces of broken-down plastic","A type of fish food"]},
    {q:"Where does much of the ocean plastic come from?",opts:["Ships and boats at sea","Countries without proper waste systems","Factories built near the coast"]},
    {q:"What have some governments done about the problem?",opts:["Banned all plastic completely","Closed rivers that carry waste","Banned certain single-use plastic items"]},
    {q:"What do experts say is needed to solve the problem?",opts:["Only governments need to act","A combination of different approaches","Ocean cleaning machines are the only answer"]}
  ]},
  {type:"mc",tl:"Reading",title:"Part 4 - Multiple-choice Cloze",ins:"Choose the correct word for each space.",
   ...
   items:[
    {q:"Gap 1",opts:["touching","affecting","impressing","contacting"]},
    {q:"Gap 2",opts:["impression","result","impact","meaning"]},
    {q:"Gap 3",opts:["survive","remain","continue","stay"]},
    {q:"Gap 4",opts:["afraid","worried","nervous","frightened"]},
    {q:"Gap 5",opts:["probably","likely","possibly","certainly"]},
    {q:"Gap 6",opts:["part","job","work","share"]}
  ]},
  {type:"fl",tl:"Reading",title:"Part 5 - Open Cloze",ins:"Write one word for each space.",
   items:[
    {pre:"We should all try to use",post:"plastic in our daily lives."},
    {pre:"The forest has been here",post:"hundreds of years."},
    {pre:"If everyone recycles, it will make",post:"big difference."},
    {pre:"Many animals are",post:"danger of becoming extinct."},
    {pre:"I have never",post:"so much rubbish on a beach before."},
    {pre:"This project was set",post:"by a group of young volunteers."}
  ]},
  {type:"kt",tl:"Reading",title:"Part 6 - Sentence Transformations",ins:"Complete the second sentence so it means the same as the first. Use 1-3 words including the given word.",
   items:[
    {src:"People throw away too much plastic.",kw:"THROWN",hint:"Passive voice"},
    {src:"It started raining while we were cleaning the beach.",kw:"WHEN",hint:"Past continuous + when"},
    {src:"No city is more polluted than this one.",kw:"MOST",hint:"Superlative"},
    {src:"We cannot go to the park because it is raining.",kw:"WOULD",hint:"Second conditional idea"},
    {src:"It is possible that temperatures will rise further.",kw:"MAY",hint:"Modal: may for possibility"},
    {src:"They have not cleaned the river for months.",kw:"SINCE",hint:"Passive + since"}
  ]},
  {type:"mc",tl:"Listening",title:"Part 2 - Longer Recording",ins:"Listen and choose the correct answer.",
   ...
   items:[
    {q:"What first made Lisa want to start her project?",opts:["A lesson about the environment","Seeing food wasted at her school","Reading an article about composting"]},
    {q:"Who helped Lisa set up the project?",opts:["Her parents","The head teacher","A local charity"]},
    {q:"How much food was wasted each week at the school?",opts:["About thirty kilos","About fifty kilos","About seventy kilos"]},
    {q:"What did the sharing table allow students to do?",opts:["Buy cheaper food","Leave unwanted food for others","Cook their own meals"]},
    {q:"By how much did the school reduce food waste?",opts:["Forty percent","Fifty percent","Sixty percent"]},
    {q:"What has happened since the project started?",opts:["The school has won an award","Other schools want to copy the idea","The canteen has closed down"]}
  ]},
  {type:"wr",tl:"Writing",title:"Part 2 - Article or Story",ins:"Write about 100 words.",
...
{t:"Practice Test 4",exercises:[
  {type:"mc",tl:"Reading",title:"Part 1 - Short Texts",ins:"Read each text and choose the correct answer.",
   items:[
    {q:"GYM NOTICE: All new members must complete a health questionnaire before using the equipment.",opts:["New members can use the equipment immediately","You need to fill in a form about your health first","The gym equipment is currently broken"]},
    {q:"SWIMMING POOL: The pool will be closed for maintenance from 5th to 12th March. We apologise for any inconvenience.",opts:["The pool is open every day in March","The pool will be shut for one week","Maintenance work happens every week"]},
    {q:"Dear all, This year's school sports day has been moved from June 15th to June 22nd due to predicted bad weather. - Mr. Collins",opts:["Sports day has been cancelled","Sports day will be a week later than planned","The weather will be good on June 15th"]},
    {q:"CAFE: Our new healthy lunch menu includes salads, soups, and fresh juices. All meals under 5 pounds!",opts:["The cafe only serves drinks","Healthy meals are available at an affordable price","Salads cost more than 5 pounds"]},
    {q:"PHARMACY: Flu vaccinations are available now. No appointment needed. Ask at the counter.",opts:["You must book an appointment for a flu vaccination","Flu vaccinations require a doctor's letter","You can get a flu vaccination without booking"]}
  ]},
  {type:"mc",tl:"Reading",title:"Part 3 - Reading Comprehension",ins:"Read the text and choose the best answer.",
   ...
   items:[
    {q:"Why is running so popular?",opts:["It requires expensive equipment","You can do it almost anywhere with little equipment","It is only done indoors"]},
    {q:"What are endorphins?",opts:["A type of running shoe","A style of exercise","Chemicals in the brain that improve mood"]},
    {q:"What mistake do beginners often make?",opts:["They do not run enough","They do too much too quickly","They buy the wrong clothes"]},
    {q:"Why are good shoes important for runners?",opts:["They make you run faster","They protect feet and joints","They look more professional"]},
    {q:"What extra motivation do charity events give runners?",opts:["Free trainers","Prize money","Raising money for a good cause"]}
  ]},
  {type:"mc",tl:"Reading",title:"Part 4 - Multiple-choice Cloze",ins:"Choose the correct word for each space.",
   ...
   items:[
    {q:"Gap 1",opts:["recognise","know","realise","understand"]},
    {q:"Gap 2",opts:["right","enough","plenty","well"]},
    {q:"Gap 3",opts:["easy","able","likely","possible"]},
    {q:"Gap 4",opts:["wake","get","stand","rise"]},
    {q:"Gap 5",opts:["morning","afternoon","evening","night"]},
    {q:"Gap 6",opts:["cold","warm","cool","fresh"]}
  ]},
  {type:"fl",tl:"Reading",title:"Part 5 - Open Cloze",ins:"Write one word for each space.",
   items:[
    {pre:"You should try to exercise at",post:"three times a week."},
    {pre:"She has been feeling much",post:"since she started yoga."},
    {pre:"I am thinking",post:"joining a gym near my house."},
    {pre:"Running is good",post:"your heart and lungs."},
    {pre:"He gave",post:"smoking last year."},
    {pre:"There is",post:"point in worrying about things you cannot change."}
  ]},
  {type:"kt",tl:"Reading",title:"Part 6 - Sentence Transformations",ins:"Complete the second sentence so it means the same as the first. Use 1-3 words including the given word.",
   items:[
    {src:"She started going to the gym six months ago.",kw:"BEEN",hint:"Present perfect continuous"},
    {src:"Running is healthier than watching TV.",kw:"AS",hint:"Not as ... as"},
    {src:"You should eat less sugar.",kw:"OUGHT",hint:"Modal: ought to"},
    {src:"The doctor told me not to eat fast food.",kw:"ADVISED",hint:"Reporting verb: advise"},
    {src:"My sister runs faster than me.",kw:"SLOWLY",hint:"Comparative adverb"},
    {src:"It is not necessary to go to the gym every day.",kw:"NEED",hint:"Modal: don't need to"}
  ]},
  {type:"mc",tl:"Listening",title:"Part 2 - Longer Recording",ins:"Listen and choose the correct answer.",
   ...
   items:[
    {q:"How did Emma discover she could be a good trainer?",opts:["She took a test at university","She helped her friends exercise","She watched training videos online"]},
    {q:"How long did it take Emma to get her qualification?",opts:["About three months","About six months","About twelve months"]},
    {q:"Who does Emma mainly work with?",opts:["Professional athletes","Older retired people","Teenagers and young adults"]},
    {q:"What is the biggest mistake beginners make?",opts:["They exercise too much at the start","They do not buy the right equipment","They eat too much protein"]},
    {q:"How often should beginners exercise according to Emma?",opts:["Every day","Three times a week","Once a week"]},
    {q:"What is Emma's main advice about choosing an activity?",opts:["Running is the best option","Choose something you enjoy","Always exercise with a trainer"]}
  ]},
  {type:"wr",tl:"Writing",title:"Part 2 - Article or Story",ins:"Write about 100 words.",
...
{t:"Practice Test 5",exercises:[
  {type:"mc",tl:"Reading",title:"Part 1 - Short Texts",ins:"Read each text and choose the correct answer.",
   items:[
    {q:"UNIVERSITY: Applications for the September intake must be submitted online by 31st January. Late applications will not be accepted.",opts:["You can apply at any time during the year","You must apply before the end of January","Applications are only accepted on paper"]},
    {q:"NOTICE: The school library will open one hour earlier during exam week to give students extra study time.",opts:["The library is closing during exams","Students will have more time to study in the library","Exam week has been shortened by one hour"]},
    {q:"Hi Anna, Can you bring your history notes to class tomorrow? I was absent last Thursday and missed the lesson. Thanks, Ben",opts:["Ben wants to lend Anna his notes","Ben needs Anna's notes because he missed a class","Anna was absent from the history lesson"]},
    {q:"COLLEGE: Students who wish to change their course must speak to their tutor before the end of the second week.",opts:["Course changes are not possible","You have two weeks to request a course change","Tutors are not available in the first two weeks"]},
    {q:"CLASSROOM: Dictionaries may be used during the reading exam but electronic devices are not allowed.",opts:["You can use your phone as a dictionary","Paper dictionaries are permitted in the exam","All books are banned from the exam room"]}
  ]},
  {type:"mc",tl:"Reading",title:"Part 3 - Reading Comprehension",ins:"Read the text and choose the best answer.",
   ...
   items:[
    {q:"Why do some parents choose home schooling?",opts:["They think schools give too much attention to each child","They want more individual attention for their child","They want their children to socialise more"]},
    {q:"What is one advantage of home schooling mentioned in the text?",opts:["Children can focus on subjects they enjoy","Children learn to work in teams","Children have more friends"]},
    {q:"What concern do critics have about home schooling?",opts:["Children learn too quickly","Children may have fewer chances to socialise","Home schooling is too expensive"]},
    {q:"What does research suggest about home-schooled children?",opts:["They always do better than school children","They often do as well as school children","They usually struggle at university"]},
    {q:"What is the overall tone of the text?",opts:["Strongly against home schooling","Strongly in favour of home schooling","Balanced, presenting both sides"]}
  ]},
  {type:"mc",tl:"Reading",title:"Part 4 - Multiple-choice Cloze",ins:"Choose the correct word for each space.",
   ...
   items:[
    {q:"Gap 1",opts:["after","over","beyond","above"]},
    {q:"Gap 2",opts:["solving","working","answering","dealing"]},
    {q:"Gap 3",opts:["method","way","process","manner"]},
    {q:"Gap 4",opts:["seeming","appearing","looking","feeling"]},
    {q:"Gap 5",opts:["friend","partner","colleague","member"]},
    {q:"Gap 6",opts:["usually","regularly","normally","frequently"]}
  ]},
  {type:"fl",tl:"Reading",title:"Part 5 - Open Cloze",ins:"Write one word for each space.",
   items:[
    {pre:"I am looking forward",post:"starting university in September."},
    {pre:"She did not do well in the exam",post:"she had not studied enough."},
    {pre:"He has been studying English",post:"he was ten years old."},
    {pre:"The teacher told us",post:"hand in our homework by Friday."},
    {pre:"If I had more time, I",post:"learn another language."},
    {pre:"This is the school",post:"my mother used to work."}
  ]},
  {type:"kt",tl:"Reading",title:"Part 6 - Sentence Transformations",ins:"Complete the second sentence so it means the same as the first. Use 1-3 words including the given word.",
   items:[
    {src:"I last saw her two weeks ago.",kw:"SEEN",hint:"Present perfect negative"},
    {src:"English is easier than Chinese.",kw:"DIFFICULT",hint:"Comparative"},
    {src:"They will open a new school next year.",kw:"OPENED",hint:"Future passive"},
    {src:"'Do not forget to bring your textbooks,' the teacher said.",kw:"REMINDED",hint:"Reporting verb: remind"},
    {src:"I am too tired to study tonight.",kw:"ENOUGH",hint:"Too/enough transformation"},
    {src:"Perhaps she will pass the exam.",kw:"MIGHT",hint:"Modal: might for possibility"}
  ]},
  {type:"mc",tl:"Listening",title:"Part 2 - Longer Recording",ins:"Listen and choose the correct answer.",
   ...
   items:[
    {q:"Why did Marco choose to study in England?",opts:["He wanted a warmer climate","He wanted to improve his English","He could not get into an Italian university"]},
    {q:"Who inspired Marco to study in England?",opts:["His English teacher","His father","A friend from university"]},
    {q:"What was the hardest thing for Marco at first?",opts:["Understanding different accents","Making friends","Finding accommodation"]},
    {q:"What clubs has Marco joined?",opts:["Swimming and drama","Tennis and music","Football and film"]},
    {q:"What has Marco learned to cook?",opts:["Italian and French dishes","Korean and Indian dishes","English and Spanish dishes"]},
    {q:"How has studying abroad changed Marco?",opts:["He is more independent and open-minded","He wants to become a teacher","He prefers living in Italy"]}
  ]},
  {type:"wr",tl:"Writing",title:"Part 2 - Article or Story",ins:"Write about 100 words.",
...
{t:"Practice Test 6",exercises:[
  {type:"mc",tl:"Reading",title:"Part 1 - Short Texts",ins:"Read each text and choose the correct answer.",
   items:[
    {q:"CINEMA: Tuesday special - all tickets half price. Offer does not include 3D screenings.",opts:["All films are cheaper on Tuesdays","3D films are half price on Tuesdays","Tuesday tickets cost twice as much"]},
    {q:"THEATRE: Tonight's performance of Hamlet has been cancelled due to a technical problem. All tickets will be refunded.",opts:["Hamlet will be shown later tonight","You cannot see Hamlet tonight but will get your money back","Tickets for Hamlet are now on sale"]},
    {q:"Dear Sophie, I have two spare tickets for the concert on Saturday. Would you and Tom like to come? Let me know! - Rachel",opts:["Rachel wants to buy tickets from Sophie","Rachel is offering Sophie and Tom free tickets","Sophie has invited Rachel to a concert"]},
    {q:"MUSEUM: Free entry for children under 12. Adults 8 pounds. Family ticket (2 adults + 2 children) 14 pounds.",opts:["Everyone must pay to enter the museum","Children pay 8 pounds each","A family ticket costs less than two adult tickets"]},
    {q:"MUSIC FESTIVAL: No glass bottles allowed. Water can be purchased inside the festival grounds.",opts:["You may bring glass bottles of water","Glass bottles are not permitted at the festival","Water is free at the festival"]}
  ]},
  {type:"mc",tl:"Reading",title:"Part 3 - Reading Comprehension",ins:"Read the text and choose the best answer.",
   ...
   items:[
    {q:"How has streaming changed the film industry?",opts:["Films are no longer made","Films can be watched at home on release day","Cinemas have become cheaper"]},
    {q:"Why do some filmmakers dislike streaming?",opts:["Films are meant to be seen on a big screen","Streaming services pay too much","It takes too long to upload films"]},
    {q:"How does streaming help smaller filmmakers?",opts:["It gives them bigger budgets","It helps them get awards","It gives them a platform to show their work"]},
    {q:"Why do some people prefer streaming over cinema?",opts:["The sound quality is better at home","It is more affordable and accessible","They do not like watching films with others"]},
    {q:"What does the writer say about cinemas?",opts:["They will close soon","People still enjoy going to them","They are better than streaming in every way"]}
  ]},
  {type:"mc",tl:"Reading",title:"Part 4 - Multiple-choice Cloze",ins:"Choose the correct word for each space.",
   ...
   items:[
    {q:"Gap 1",opts:["called","known","named","said"]},
    {q:"Gap 2",opts:["win","gain","earn","take"]},
    {q:"Gap 3",opts:["both","either","neither","each"]},
    {q:"Gap 4",opts:["advanced","developed","improved","increased"]},
    {q:"Gap 5",opts:["commitment","devotion","attention","interest"]},
    {q:"Gap 6",opts:["fame","reputation","popularity","fashion"]}
  ]},
  {type:"fl",tl:"Reading",title:"Part 5 - Open Cloze",ins:"Write one word for each space.",
   items:[
    {pre:"I am really keen",post:"watching science fiction films."},
    {pre:"She has been acting",post:"she was a child."},
    {pre:"The film was",post:"exciting that I watched it twice."},
    {pre:"He plays the guitar as",post:"as the piano."},
    {pre:"We had to queue",post:"over an hour to get tickets."},
    {pre:"I could not help",post:"during the comedy show."}
  ]},
  {type:"kt",tl:"Reading",title:"Part 6 - Sentence Transformations",ins:"Complete the second sentence so it means the same as the first. Use 1-3 words including the given word.",
   items:[
    {src:"The last time I went to the cinema was in March.",kw:"BEEN",hint:"Present perfect negative + since"},
    {src:"This is the funniest film I have ever watched.",kw:"NEVER",hint:"Superlative to comparative"},
    {src:"Someone directed this film in 2019.",kw:"WAS",hint:"Passive voice"},
    {src:"The concert was too loud for my grandmother.",kw:"ENOUGH",hint:"Too/enough transformation"},
    {src:"'Have you seen the new exhibition?' Tom asked me.",kw:"WHETHER",hint:"Reported question"},
    {src:"It is a pity I cannot play a musical instrument.",kw:"WISH",hint:"Wish + past simple"}
  ]},
  {type:"mc",tl:"Listening",title:"Part 2 - Longer Recording",ins:"Listen and choose the correct answer.",
   ...
   items:[
    {q:"How long has Alex's cinema been open?",opts:["About three years","About five years","About ten years"]},
    {q:"What makes Alex's cinema different from big chains?",opts:["It has more screens","It shows a wider range of films","It is cheaper for everyone"]},
    {q:"What nearly happened in the first two years?",opts:["The cinema nearly closed","They had to move to a bigger building","They stopped showing old films"]},
    {q:"What events helped bring in new customers?",opts:["Free popcorn nights","Film quizzes and outdoor screenings","Celebrity visits"]},
    {q:"How does the membership scheme work?",opts:["You pay once and get free films forever","You pay monthly for unlimited films","You get one free film per month"]},
    {q:"How does Alex feel about the future?",opts:["Worried","Unsure","Positive"]}
  ]},
  {type:"wr",tl:"Writing",title:"Part 2 - Article or Story",ins:"Write about 100 words.",
...
{t:"Practice Test 7",exercises:[
  {type:"mc",tl:"Reading",title:"Part 1 - Short Texts",ins:"Read each text and choose the correct answer.",
   items:[
    {q:"SPORTS CENTRE: The basketball court is available for booking from 6 PM on weekdays. Weekend slots fill up fast, so book early.",opts:["The basketball court cannot be booked","You can book the court on weekday evenings","The court is only open at weekends"]},
    {q:"FOOTBALL CLUB: Training for under-16s has moved from Wednesday to Thursday this week due to a national holiday.",opts:["Under-16 training is cancelled this week","Training will be on a different day this week","There is no training on national holidays"]},
    {q:"Dear Coach, I will not be at practice tomorrow because I have injured my ankle. I hope to be back next week. - James",opts:["James is leaving the team","James cannot practice because of an injury","James wants to change to a different sport"]},
    {q:"SWIMMING COMPETITION: Registration closes on Friday at 5 PM. Entry fee is 3 pounds per event.",opts:["The competition is free to enter","You must sign up before Friday evening","Registration is only available on Friday"]},
    {q:"NOTICE: The tennis courts will be resurfaced during August. They will reopen on 1st September.",opts:["The tennis courts are being improved over the summer","Tennis is available throughout August","New tennis courts are being built in September"]}
  ]},
  {type:"mc",tl:"Reading",title:"Part 3 - Reading Comprehension",ins:"Read the text and choose the best answer.",
   ...
   items:[
    {q:"What are bike-sharing schemes?",opts:["Programmes that give people free bicycles","Systems that let people rent bikes for short trips","Clubs for people who enjoy cycling together"]},
    {q:"What have some cities done to encourage cycling?",opts:["Banned all cars from the centre","Built new cycle lanes and provided facilities","Given everyone a free bicycle"]},
    {q:"Why is cycling better for joints than running?",opts:["It is a gentler form of exercise","It uses different muscles","It does not require movement"]},
    {q:"What discourages some people from cycling in cities?",opts:["The cost of buying a bicycle","The danger of accidents with cars","The lack of bike-sharing schemes"]},
    {q:"What do campaigners want?",opts:["More cars on the roads","Better cycling infrastructure","Higher speed limits"]}
  ]},
  {type:"mc",tl:"Reading",title:"Part 4 - Multiple-choice Cloze",ins:"Choose the correct word for each space.",
   ...
   items:[
    {q:"Gap 1",opts:["important","famous","favourite","popular"]},
    {q:"Gap 2",opts:["gather","join","arrive","collect"]},
    {q:"Gap 3",opts:["made","had","did","took"]},
    {q:"Gap 4",opts:["amount","number","range","group"]},
    {q:"Gap 5",opts:["chosen","picked","elected","voted"]},
    {q:"Gap 6",opts:["friendship","relationship","connection","company"]}
  ]},
  {type:"fl",tl:"Reading",title:"Part 5 - Open Cloze",ins:"Write one word for each space.",
   items:[
    {pre:"He has played football",post:"he was five years old."},
    {pre:"She is the fastest runner",post:"the whole school."},
    {pre:"I am not very good",post:"playing tennis."},
    {pre:"We were watching the match",post:"the power went off."},
    {pre:"You need to warm",post:"before doing any exercise."},
    {pre:"The team has won every game",post:"far this season."}
  ]},
  {type:"kt",tl:"Reading",title:"Part 6 - Sentence Transformations",ins:"Complete the second sentence so it means the same as the first. Use 1-3 words including the given word.",
   items:[
    {src:"No one in our team is as tall as Marco.",kw:"TALLEST",hint:"Superlative"},
    {src:"They cancelled the match because of the rain.",kw:"WAS",hint:"Passive voice"},
    {src:"I started playing basketball when I was eight.",kw:"BEEN",hint:"Present perfect continuous + since"},
    {src:"'You should try a different sport,' the coach said to me.",kw:"SUGGESTED",hint:"Reporting verb: suggest"},
    {src:"The stadium is too small for the final.",kw:"BIG",hint:"Too/enough transformation"},
    {src:"Perhaps the team will win the championship.",kw:"COULD",hint:"Modal: could for possibility"}
  ]},
  {type:"mc",tl:"Listening",title:"Part 2 - Longer Recording",ins:"Listen and choose the correct answer.",
   ...
   items:[
    {q:"What was Mia like before she started running?",opts:["She was already quite fit","She could not run for very long","She had run several races"]},
    {q:"Who helped Mia start running?",opts:["A professional coach","Her neighbour","Her doctor"]},
    {q:"What did Mia do after four months of training?",opts:["She ran a five-kilometre race","She completed a marathon","She stopped running for a while"]},
    {q:"How often did Mia train for the marathon?",opts:["Three days a week","Every day","Five or six days a week"]},
    {q:"How did Mia feel when she finished the marathon?",opts:["Disappointed with her time","Emotional and proud","Too tired to feel anything"]},
    {q:"What is Mia's plan for the future?",opts:["She will stop running","She will become a coach","She will run another marathon"]}
  ]},
  {type:"wr",tl:"Writing",title:"Part 2 - Article or Story",ins:"Write about 100 words.",
...
{t:"Practice Test 8",exercises:[
  {type:"mc",tl:"Reading",title:"Part 1 - Short Texts",ins:"Read each text and choose the correct answer.",
   items:[
    {q:"MUSEUM: Photography is permitted in all galleries except the special exhibition on the third floor.",opts:["You can take photos everywhere in the museum","Photos are not allowed in one area of the museum","Photography is completely banned"]},
    {q:"ART GALLERY: Free guided tours run at 11 AM and 2 PM. Tours last approximately 45 minutes. No booking required.",opts:["You must pay for a guided tour","Tours happen twice a day and are free","You need to book tours in advance"]},
    {q:"Dear Pablo, The food festival starts at noon on Saturday. Shall we meet at the entrance at 11:45? - Lucia",opts:["Lucia wants to arrive after the festival starts","Lucia suggests meeting before the festival opens","The festival starts in the evening"]},
    {q:"LIBRARY: Our world cultures reading group meets on the first Monday of every month at 7 PM. New members welcome!",opts:["The reading group meets every Monday","New people cannot join the group","The group meets once a month"]},
    {q:"FESTIVAL: Traditional dance performances take place every evening at 8 PM in the main square. Free admission.",opts:["Dance performances cost 8 pounds","You can watch free dance shows every evening","The main square is closed in the evening"]}
  ]},
  {type:"mc",tl:"Reading",title:"Part 3 - Reading Comprehension",ins:"Read the text and choose the best answer.",
   ...
   items:[
    {q:"Where has street food traditionally been popular?",opts:["Europe and North America","Asia and Latin America","Australia and Africa"]},
    {q:"How has social media affected street food?",opts:["It has made people less interested in food","It has made people want to try new foods","It has made street food more expensive"]},
    {q:"Why is street food attractive to people on a budget?",opts:["It is free","It is cheaper than restaurant food","It comes in larger portions"]},
    {q:"How does street food help aspiring chefs?",opts:["It gives them free training","They can start with less money than a restaurant","They earn more than restaurant chefs"]},
    {q:"What concern is mentioned about street food?",opts:["It is not popular enough","It only serves fast food","Hygiene and waste are issues"]}
  ]},
  {type:"mc",tl:"Reading",title:"Part 4 - Multiple-choice Cloze",ins:"Choose the correct word for each space.",
   ...
   items:[
    {q:"Gap 1",opts:["role","job","part","work"]},
    {q:"Gap 2",opts:["existed","celebrated","performed","practised"]},
    {q:"Gap 3",opts:["made","done","held","given"]},
    {q:"Gap 4",opts:["beginning","arrival","opening","start"]},
    {q:"Gap 5",opts:["pulls","draws","attracts","catches"]},
    {q:"Gap 6",opts:["rest","pause","break","stop"]}
  ]},
  {type:"fl",tl:"Reading",title:"Part 5 - Open Cloze",ins:"Write one word for each space.",
   items:[
    {pre:"I am very fond",post:"traditional music from my country."},
    {pre:"The festival has been running",post:"over twenty years."},
    {pre:"This painting was done",post:"a famous artist in the 1800s."},
    {pre:"There were",post:"many people at the festival that we could not move."},
    {pre:"Have you ever",post:"to a cultural festival abroad?"},
    {pre:"She takes",post:"her mother, who is also a talented dancer."}
  ]},
  {type:"kt",tl:"Reading",title:"Part 6 - Sentence Transformations",ins:"Complete the second sentence so it means the same as the first. Use 1-3 words including the given word.",
   items:[
    {src:"People celebrate this festival every year.",kw:"IS",hint:"Passive voice"},
    {src:"I have never tried Japanese food before.",kw:"FIRST",hint:"First time + present perfect"},
    {src:"The old market is not as big as the new one.",kw:"BIGGER",hint:"Comparative"},
    {src:"We could not go to the festival because it was raining.",kw:"WOULD",hint:"Third conditional idea"},
    {src:"'When does the festival start?' she asked.",kw:"STARTED",hint:"Reported question"},
    {src:"It is possible that they will cancel the event.",kw:"MIGHT",hint:"Modal: might for possibility"}
  ]},
  {type:"mc",tl:"Listening",title:"Part 2 - Longer Recording",ins:"Listen and choose the correct answer.",
   ...
   items:[
    {q:"What surprised Yuki about the London Underground?",opts:["How quiet it was","How noisy people were","How expensive tickets were"]},
    {q:"How did Yuki find making friends at first?",opts:["Very easy","Quite difficult","Impossible"]},
    {q:"How did Yuki make friends in London?",opts:["Through work colleagues","By joining a language exchange group","At a Japanese restaurant"]},
    {q:"What does Yuki enjoy most about London?",opts:["The weather","The public transport","The cultural diversity"]},
    {q:"What does Yuki like about London museums?",opts:["They are close to her home","Many of them are free","They have Japanese exhibitions"]},
    {q:"What does Yuki miss most about Japan?",opts:["The food","The museums","The public transport"]}
  ]},
  {type:"wr",tl:"Writing",title:"Part 2 - Article or Story",ins:"Write about 100 words.",
...
{t:"Practice Test 9",exercises:[
  {type:"mc",tl:"Reading",title:"Part 1 - Short Texts",ins:"Read each text and choose the correct answer.",
   items:[
    {q:"JOB ADVERT: Part-time sales assistant needed. Must be available at weekends. Experience preferred but not essential. Apply online.",opts:["You must have sales experience to apply","Weekend availability is required for this job","The job is full-time only"]},
    {q:"OFFICE NOTICE: Staff meeting at 3 PM today in Conference Room B. All team members are expected to attend.",opts:["The meeting is optional","Everyone should go to the meeting","The meeting has been cancelled"]},
    {q:"Dear Ms Taylor, Thank you for attending the interview last week. We are pleased to offer you the position. Please confirm by Friday. - HR Department",opts:["Ms Taylor did not get the job","Ms Taylor has been offered the job","The interview is next week"]},
    {q:"COMPANY POLICY: Employees working from home must be available by email between 9 AM and 5 PM on working days.",opts:["Working from home is not allowed","Home workers must check emails during office hours","Employees can only work from home at weekends"]},
    {q:"Hi David, I have decided to accept the job in Manchester. It means moving away, but the salary is much better. - Sarah",opts:["Sarah has rejected the job offer","Sarah will move for a job with better pay","David is also moving to Manchester"]}
  ]},
  {type:"mc",tl:"Reading",title:"Part 3 - Reading Comprehension",ins:"Read the text and choose the best answer.",
   ...
   items:[
    {q:"What was working from home like before 2020?",opts:["It was very common","It was not very common","It was impossible"]},
    {q:"What is a hybrid working model?",opts:["Working only from home","Working only in the office","Splitting time between home and office"]},
    {q:"What do most workers think about hybrid working?",opts:["They prefer it","They dislike it","They have no opinion"]},
    {q:"What problem do some younger workers face?",opts:["They earn less money","They miss learning from experienced colleagues","They have to travel too far"]},
    {q:"What concern exists about career progression?",opts:["Remote workers may be promoted less often","Remote workers get promoted too quickly","There are no promotions for office workers"]}
  ]},
  {type:"mc",tl:"Reading",title:"Part 4 - Multiple-choice Cloze",ins:"Choose the correct word for each space.",
   ...
   items:[
    {q:"Gap 1",opts:["organisation","preparation","arrangement","introduction"]},
    {q:"Gap 2",opts:["Add","Put","Include","Join"]},
    {q:"Gap 3",opts:["related","attached","connected","joined"]},
    {q:"Gap 4",opts:["deeply","closely","thoroughly","strongly"]},
    {q:"Gap 5",opts:["natural","real","true","actual"]},
    {q:"Gap 6",opts:["let down","put off","turned away","discouraged"]}
  ]},
  {type:"fl",tl:"Reading",title:"Part 5 - Open Cloze",ins:"Write one word for each space.",
   items:[
    {pre:"She is responsible",post:"managing the sales team."},
    {pre:"He has worked at this company",post:"he graduated from university."},
    {pre:"I would like to apply",post:"the position of marketing assistant."},
    {pre:"They are looking",post:"someone with experience in customer service."},
    {pre:"The meeting will take",post:"in the main conference room."},
    {pre:"She got on well",post:"all her colleagues from the start."}
  ]},
  {type:"kt",tl:"Reading",title:"Part 6 - Sentence Transformations",ins:"Complete the second sentence so it means the same as the first. Use 1-3 words including the given word.",
   items:[
    {src:"They offered her the job last week.",kw:"WAS",hint:"Passive voice"},
    {src:"He started working here five years ago.",kw:"BEEN",hint:"Present perfect continuous + for"},
    {src:"No other employee works harder than Maria.",kw:"HARDEST",hint:"Superlative"},
    {src:"'You should apply for the management position,' my friend said.",kw:"ADVISED",hint:"Reporting verb: advise"},
    {src:"The office is too far from my house.",kw:"CLOSE",hint:"Too/enough transformation"},
    {src:"If I spoke better English, I would get the job.",kw:"WOULD",hint:"Second conditional"}
  ]},
  {type:"mc",tl:"Listening",title:"Part 2 - Longer Recording",ins:"Listen and choose the correct answer.",
   ...
   items:[
    {q:"What was Kate's previous job?",opts:["A veterinary nurse","An accountant","A teacher"]},
    {q:"Why was Kate unhappy in her old job?",opts:["The pay was too low","She did not like her colleagues","She spent all day at a desk"]},
    {q:"What made Kate think about becoming a dog walker?",opts:["She saw a job advert","She walked a friend's dog","She visited a dog training centre"]},
    {q:"How did Kate's family react to her decision?",opts:["They were very supportive","They thought she was making a mistake","They had no opinion"]},
    {q:"How did Kate find her first clients?",opts:["Through social media","By advertising in a newspaper","By putting leaflets through doors"]},
    {q:"How does Kate feel about earning less money?",opts:["She is upset about it","She does not mind because she is happier","She plans to go back to her old job"]}
  ]},
  {type:"wr",tl:"Writing",title:"Part 2 - Article or Story",ins:"Write about 100 words.",
...
{t:"Practice Test 10",exercises:[
  {type:"mc",tl:"Reading",title:"Part 1 - Short Texts",ins:"Read each text and choose the correct answer.",
   items:[
    {q:"RESTAURANT: Lunch special available Monday to Friday, 12-2 PM. Main course plus a drink for 8.50 pounds.",opts:["The lunch special is available every day","You can get a meal and drink at a reduced price on weekdays","The restaurant is only open for lunch"]},
    {q:"SUPERMARKET: Reduced items can be found in the yellow-sticker section near the bakery. Items must be consumed by the date shown.",opts:["All items near the bakery are fresh","Discounted food is available near the bakery area","Yellow sticker items are the most expensive"]},
    {q:"Dear guests, Please let us know about any food allergies or dietary requirements at least 24 hours before the dinner. - Event Team",opts:["The dinner will only serve vegetarian food","You should inform them about allergies in advance","Guests with allergies cannot attend the dinner"]},
    {q:"COOKING CLASS: Beginners welcome. Learn to make fresh pasta and three classic sauces. All ingredients provided. 35 pounds per person.",opts:["You need to bring your own ingredients","The class is only for experienced cooks","Everything you need for the class is included in the price"]},
    {q:"CAFE: We are proud to serve only locally sourced, organic coffee. Ask about our loyalty card for a free drink after ten purchases.",opts:["The cafe serves imported coffee","You can earn a free drink by buying ten coffees","Loyalty cards cost extra"]}
  ]},
  {type:"mc",tl:"Reading",title:"Part 3 - Reading Comprehension",ins:"Read the text and choose the best answer.",
   ...
   items:[
    {q:"What did the British university study find about cooking show viewers?",opts:["They never cook at home","They are more willing to try new recipes","They only eat ready meals"]},
    {q:"What problem did the study find with cooking show recipes?",opts:["They are too complicated","They are too healthy","They often contain a lot of fat and sugar"]},
    {q:"How do some viewers treat cooking shows?",opts:["As entertainment rather than practical cooking guides","As educational lessons they follow carefully","As boring programmes they rarely watch"]},
    {q:"What criticism do some people have of cooking shows?",opts:["They are too expensive to make","They have turned food into just entertainment","They do not feature enough chefs"]},
    {q:"What positive effect have cooking shows had?",opts:["They have made restaurants cheaper","They have made cooking seem exciting and accessible","They have reduced the number of takeaway restaurants"]}
  ]},
  {type:"mc",tl:"Reading",title:"Part 4 - Multiple-choice Cloze",ins:"Choose the correct word for each space.",
   ...
   items:[
    {q:"Gap 1",opts:["selecting","choosing","picking","preferring"]},
    {q:"Gap 2",opts:["fashion","direction","movement","trend"]},
    {q:"Gap 3",opts:["moral","polite","fair","honest"]},
    {q:"Gap 4",opts:["issue","factor","point","matter"]},
    {q:"Gap 5",opts:["enough","plenty","much","lots"]},
    {q:"Gap 6",opts:["put","give","take","leave"]}
  ]},
  {type:"fl",tl:"Reading",title:"Part 5 - Open Cloze",ins:"Write one word for each space.",
   items:[
    {pre:"I am not used",post:"eating such spicy food."},
    {pre:"She learned to cook",post:"her grandmother when she was young."},
    {pre:"Would you like",post:"more cake? There is plenty left."},
    {pre:"The recipe calls",post:"two hundred grams of flour."},
    {pre:"We ran",post:"of milk so I went to the shop."},
    {pre:"This dish is made",post:"fresh vegetables from the garden."}
  ]},
  {type:"kt",tl:"Reading",title:"Part 6 - Sentence Transformations",ins:"Complete the second sentence so it means the same as the first. Use 1-3 words including the given word.",
   items:[
    {src:"My mother makes the best cake in the family.",kw:"MADE",hint:"Passive voice"},
    {src:"I have not eaten sushi before.",kw:"FIRST",hint:"First time + present perfect"},
    {src:"This restaurant is more expensive than the one on Park Street.",kw:"CHEAP",hint:"Comparative"},
    {src:"'Do not touch the hot pan,' she said to me.",kw:"WARNED",hint:"Reporting verb: warn"},
    {src:"The soup was too salty for me to eat.",kw:"ENOUGH",hint:"Too/enough transformation"},
    {src:"Perhaps they will open a new restaurant here.",kw:"MAY",hint:"Modal: may for possibility"}
  ]},
  {type:"mc",tl:"Listening",title:"Part 2 - Longer Recording",ins:"Listen and choose the correct answer.",
   ...
   items:[
    {q:"What type of food does Green Table serve?",opts:["Traditional meat dishes","Only salads and soups","Completely plant-based food"]},
    {q:"How long did Daniel work as a chef before opening his restaurant?",opts:["About five years","About ten years","About fifteen years"]},
    {q:"Who encouraged Daniel to open the restaurant?",opts:["His colleagues","His wife","A business partner"]},
    {q:"What did people say about Daniel's idea?",opts:["They thought it would fail","They were very supportive","They wanted to invest money"]},
    {q:"What is the most popular dish at Green Table?",opts:["A vegetable curry","Mushroom and truffle pasta","A vegan burger"]},
    {q:"What are Daniel's future plans?",opts:["To close the restaurant","To add meat to the menu","To possibly open another restaurant"]}
  ]},
  {type:"wr",tl:"Writing",title:"Part 2 - Article or Story",ins:"Write about 100 words.",
...
if (typeof window !== 'undefined') { window.CAM_PET = CAM_PET; }
