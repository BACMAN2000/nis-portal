...
items:[
{q:"Gap 1",opts:["prerogative","priority","privilege","predominance"]},
{q:"Gap 2",opts:["engender","generate","fabricate","manufacture"]},
{q:"Gap 3",opts:["distinguishes","discerns","discriminates","differentiates"]},
{q:"Gap 4",opts:["rekindled","reinstated","recounted","reclaimed"]},
{q:"Gap 5",opts:["grounded","founded","based","settled"]},
{q:"Gap 6",opts:["pragmatic","prosaic","practical","practiced"]},
{q:"Gap 7",opts:["immaterial","insignificant","irrelevant","inconsequential"]},
{q:"Gap 8",opts:["reappraise","reconsider","re-examine","reassess"]}
]},
// --- Exercise 2: Open Cloze ---
{type:"fl",tl:"Use of English",title:"Part 2 - Open Cloze",ins:"Write the word which best fits each gap.",
items:[
{pre:"Seldom",post:"a scientific discovery provoked such widespread controversy."},
{pre:"The theory, elegant",post:"it may be, fails to account for several anomalies."},
{pre:"Not until the final chapter",post:"the author reveal the true significance of the research."},
{pre:"It was the philosopher Kant",post:"first articulated this distinction with rigour."},
{pre:"Under no circumstances",post:"the results be interpreted as definitive proof."},
{pre:"The experiment succeeded, and it did",post:"against all expectations."},
{pre:"Were the funding",post:"be withdrawn, the entire programme would collapse."},
{pre:"Impressive",post:"the findings were, they left many questions unanswered."}
]},
...
items:[
{pre:"The sheer",root:"PREDICT",post:"of the weather made planning impossible."},
{pre:"Her",root:"PHOTOGRAPH",post:"memory allowed her to recall entire pages of text."},
{pre:"The politician was accused of deliberate",root:"REPRESENT",post:"of the facts."},
{pre:"They showed remarkable",root:"RESOURCE",post:"in overcoming the obstacles."},
{pre:"The",root:"BUREAUCRACY",post:"procedures delayed the project by months."},
{pre:"His behaviour was",root:"CHARACTER",post:"of someone usually so reserved."},
{pre:"The company underwent a major",root:"ORGANISE",post:"following the merger."},
{pre:"The decision was met with",root:"BELIEVE",post:"by all present."}
]},
...
items:[
{src:"The film was so boring that most people left.",kw:"SUCH",hint:"such + a/an + adj + noun + that"},
{src:"I had no idea the situation was so serious.",kw:"REALISE",hint:"negative + realise + how + adj"},
{src:"People say that he embezzled millions from the charity.",kw:"ALLEGED",hint:"passive reporting + perfect infinitive"},
{src:"She started learning the violin when she was four.",kw:"AGE",hint:"present perfect continuous + since the age of"},
{src:"We only managed to finish because everyone helped.",kw:"BUT",hint:"but for + -ing = if it had not been for"},
{src:"They regret not investing in the technology sooner.",kw:"WISH",hint:"wish + past perfect for past regrets"}
]},
...
items:[
{pre:"The concept of collective memory was first introduced by",post:"in the 1920s."},
{pre:"According to the lecture, even personal memories are influenced by",post:"in which we live."},
{pre:"A family reunion can reactivate",post:"associated with forgotten memories."},
{pre:"Communities practise selectivity by foregrounding certain events while others are pushed into",post:"."},
{pre:"The lecturer states that the process of selecting memories usually serves particular",post:"and reinforces narratives."},
{pre:"Confederate monuments were mostly erected during the era of",post:", not immediately after the war."},
{pre:"The statues were intended to legitimise a particular",post:"rather than to preserve historical facts."},
{pre:"On social media, algorithms tend to prioritise",post:"when curating content."},
{pre:"The fragmentation of shared memory threatens the",post:"needed for democratic deliberation."}
]},
// --- Exercise 8: Writing ---
...
items:[
{q:"Gap 1",opts:["precipitated","instigated","provoked","incited"]},
{q:"Gap 2",opts:["originate","derive","stem","date"]},
{q:"Gap 3",opts:["surmised","conjectured","postulated","speculated"]},
{q:"Gap 4",opts:["striking","startling","staggering","stunning"]},
{q:"Gap 5",opts:["defies","denies","decries","deflects"]},
{q:"Gap 6",opts:["meticulous","scrupulous","painstaking","assiduous"]},
{q:"Gap 7",opts:["attracted","drawn","commanded","garnered"]},
{q:"Gap 8",opts:["corroborate","substantiate","authenticate","validate"]}
]},
// --- Exercise 2: Open Cloze ---
{type:"fl",tl:"Use of English",title:"Part 2 - Open Cloze",ins:"Write the word which best fits each gap.",
items:[
{pre:"Only after prolonged negotiation",post:"the two parties reach an agreement."},
{pre:"Remarkable",post:"the achievement was, it received little media coverage."},
{pre:"At no point",post:"the participants informed of the true purpose of the study."},
{pre:"It is widely acknowledged that the crisis could have been averted,",post:"the warnings been heeded."},
{pre:"The results were consistent",post:"what the researchers had predicted."},
{pre:"There is little doubt that this policy will prove effective, much",post:"its predecessor did in the 1990s."},
{pre:"Not only did the novel win the prize,",post:"it also became an international bestseller."},
{pre:"The extent",post:"which climate change will affect agricultural yields remains uncertain."}
]},
// --- Exercise 3: Word Formation ---
{type:"wf",tl:"Use of English",title:"Part 3 - Word Formation",ins:"Use the word given to form a word that fits the gap.",
items:[
{pre:"The",root:"SIGNIFY",post:"of this discovery cannot be overstated."},
{pre:"Her",root:"SPEAK",post:"on political matters earned her both admirers and detractors."},
{pre:"The museum\\'s",root:"ACQUIRE",post:"committee approved the purchase unanimously."},
{pre:"The results were",root:"CONCLUDE",post:"and further testing was required."},
{pre:"Such",root:"PRECEDE",post:"levels of cooperation surprised everyone involved."},
{pre:"The",root:"WIDE",post:"gap between rich and poor has become a pressing concern."},
{pre:"His",root:"DISMISS",post:"towards the junior staff was widely resented."},
{pre:"The phenomenon has proven remarkably",root:"RESIST",post:"to conventional explanation."}
]},
// --- Exercise 4: Key Word Transformations ---
{type:"kt",tl:"Use of English",title:"Part 4 - Key Word Transformations",ins:"Use 3-8 words including the word given.",
items:[
{src:"He did not realise how much trouble he was causing.",kw:"LITTLE",hint:"inversion with negative adverb"},
{src:"Although the team tried hard, they could not win the match.",kw:"HOWEVER",hint:"however + adj/adv + subject + verb"},
{src:"She is too experienced to be deceived by such a simple trick.",kw:"TAKEN",hint:"phrasal verb: taken in = deceived"},
{src:"The meeting was cancelled because not enough people attended.",kw:"OWING",hint:"owing to + noun phrase"},
{src:"It is likely that the cause of the fire was an electrical fault.",kw:"PUT",hint:"put down to = attribute to"},
{src:"The authorities should have acted more quickly during the crisis.",kw:"HIGH",hint:"it is high time + past simple/past perfect"}
]},
// --- Exercise 5: Reading MC ---
{type:"mc",tl:"Reading",title:"Part 5 - Multiple Choice",ins:"Choose the best answer (A-D).",
...
items:[
{q:"The writer\\'s primary purpose in the opening paragraph is to",opts:["advocate for the nativist position in language acquisition","outline the two main opposing perspectives in the field","demonstrate that the empiricist view has been conclusively proven","criticise Chomsky\\'s contribution to linguistics"]},
...
{q:"According to the passage, cross-linguistic research has",opts:["confirmed the existence of universal grammatical deep structures","shown that all languages follow identical acquisition patterns","revealed more structural variation than nativists predicted","proven that language learning relies solely on statistical methods"]},
{q:"The writer characterises usage-based approaches as suggesting that children",opts:["are born with a complete grammatical system that unfolds naturally","build grammatical knowledge incrementally through experience","learn language exclusively through formal instruction","rely primarily on imitation to acquire linguistic competence"]},
{q:"The broader implication discussed in paragraph five is that",opts:["the brain contains many highly specialised cognitive modules","neural plasticity has no relevance to language acquisition","cognitive modularity may be less fundamental than once thought","language is entirely separate from other mental faculties"]},
...
items:[
{pre:"The Library of Alexandria was founded in the",post:"but served scholars, not the general public."},
{pre:"The Free Libraries Act was passed in",post:"in Britain."},
{pre:"The legislation was motivated by the belief that democracy required an",post:"."},
{pre:"Andrew Carnegie funded the construction of over",post:"in the United States."},
{pre:"Carnegie\\'s motives combined philanthropy with promoting self-improvement as an alternative to",post:"."},
{pre:"Modern libraries now offer digital literacy classes, co-working spaces, and",post:"."},
{pre:"Traditionalists believe libraries should focus on providing access to knowledge through",post:"."},
{pre:"Research shows that libraries function as important",post:"where diverse people can interact as equals."},
{pre:"In a time of growing social fragmentation, this role may be more",post:"."}
]},
// --- Exercise 8: Writing ---
{type:"wr",tl:"Writing",title:"Part 1 - Essay",ins:"Write your essay in 240-280 words.",
...
items:[
{q:"Gap 1",opts:["prompted","propelled","projected","proffered"]},
{q:"Gap 2",opts:["resurgence","revival","restoration","renewal"]},
{q:"Gap 3",opts:["cost","price","expense","charge"]},
{q:"Gap 4",opts:["compressed","condensed","distilled","reduced"]},
{q:"Gap 5",opts:["stripping","depriving","divesting","robbing"]},
{q:"Gap 6",opts:["regarded","observed","viewed","watched"]},
{q:"Gap 7",opts:["profoundly","deeply","thoroughly","intensely"]},
{q:"Gap 8",opts:["overlook","overpass","override","overrun"]}
]},
// --- Exercise 2: Open Cloze ---
{type:"fl",tl:"Use of English",title:"Part 2 - Open Cloze",ins:"Write the word which best fits each gap.",
items:[
{pre:"Had the government acted sooner, the crisis might",post:"been averted altogether."},
{pre:"So pervasive is the influence of social media",post:"it has fundamentally altered how people relate to one another."},
{pre:"The project was ambitious, to say the",post:", but the team remained undaunted."},
{pre:"Little",post:"anyone suspect that the results would prove so controversial."},
{pre:"She completed the marathon in record time and",post:"so doing, inspired a generation of runners."},
{pre:"The theory holds water only in",post:"far as the initial assumptions are valid."},
{pre:"Much",post:"I admire her determination, I question the wisdom of her approach."},
{pre:"It was not until the evidence was re-examined",post:"the true cause of the failure became apparent."}
]},
// --- Exercise 3: Word Formation ---
{type:"wf",tl:"Use of English",title:"Part 3 - Word Formation",ins:"Use the word given to form a word that fits the gap.",
items:[
{pre:"The",root:"PERCEIVE",post:"that wealth guarantees happiness persists despite evidence to the contrary."},
{pre:"His",root:"WILLING",post:"to compromise ultimately led to the collapse of the negotiations."},
{pre:"The",root:"CORRESPOND",post:"between theory and observation was remarkably close."},
{pre:"She displayed",root:"EXCEED",post:"good judgement under pressure."},
{pre:"The",root:"MAINTAIN",post:"of the building had been neglected for decades."},
{pre:"Their",root:"RELY",post:"on a single data source proved to be their downfall."},
{pre:"The sheer",root:"AUDACIOUS",post:"of the proposal took everyone by surprise."},
{pre:"Environmental",root:"DEGRADE",post:"has accelerated at an alarming rate in recent years."}
]},
// --- Exercise 4: Key Word Transformations ---
{type:"kt",tl:"Use of English",title:"Part 4 - Key Word Transformations",ins:"Use 3-8 words including the word given.",
items:[
{src:"I am sure she did not do it deliberately.",kw:"INTENTION",hint:"have no intention of + -ing"},
{src:"The project failed because of poor management.",kw:"DOWN",hint:"be down to = be caused by"},
{src:"He suddenly realised that he had made a terrible mistake.",kw:"DAWNED",hint:"it dawned on someone that"},
{src:"We had to cancel the event because of the storm.",kw:"CALLED",hint:"call off = cancel"},
{src:"She has a tendency to exaggerate her achievements.",kw:"PRONE",hint:"be prone to + -ing"},
{src:"Apparently, the company is about to go bankrupt.",kw:"VERGE",hint:"on the verge of + -ing"}
]},
// --- Exercise 5: Reading MC ---
{type:"mc",tl:"Reading",title:"Part 5 - Multiple Choice",ins:"Choose the best answer (A-D).",
...
items:[
{pre:"The most frequently occurring form of synaesthesia involves perceiving letters or numbers as having inherent",post:"."},
{pre:"Research at the University of Edinburgh showed that synaesthetic associations remain",post:"when subjects are retested."},
{pre:"Non-synaesthetes assigning colours arbitrarily show significant",post:"in their responses over time."},
{pre:"The neurological explanation involves increased",post:"between adjacent brain regions."},
{pre:"Brain scans show heightened cross-activation between areas that process different",post:"."},
{pre:"One hypothesis suggests that all infants possess this connectivity but it is normally",post:"during development."},
{pre:"Synaesthesia is described as a retention of neural connections that most people",post:"as they grow up."},
{pre:"According to the British Journal of Psychology, the condition is",post:"more prevalent among creative professionals."},
{pre:"Some scholars believe that artistic metaphorical thinking may share",post:"with synesthetic perception."}
]},
// --- Exercise 8: Writing ---
{type:"wr",tl:"Writing",title:"Part 1 - Essay",ins:"Write your essay in 240-280 words.",
...
items:[
{q:"Gap 1",opts:["attracted","drawn","captured","commanded"]},
{q:"Gap 2",opts:["imperceptible","unnoticed","inconspicuous","subliminal"]},
{q:"Gap 3",opts:["spawned","generated","bred","begotten"]},
{q:"Gap 4",opts:["yield","produce","bear","render"]},
{q:"Gap 5",opts:["flout","breach","defy","violate"]},
{q:"Gap 6",opts:["relegates","demotes","downgrades","subordinates"]},
{q:"Gap 7",opts:["volition","determination","resolution","aspiration"]},
{q:"Gap 8",opts:["bridge","span","cross","close"]}
]},
// --- Exercise 2: Open Cloze ---
{type:"fl",tl:"Use of English",title:"Part 2 - Open Cloze",ins:"Write the word which best fits each gap.",
items:[
{pre:"Never before",post:"the city witnessed such widespread public protest."},
{pre:"Whatever the outcome",post:"be, we must remain committed to the process."},
{pre:"The policy was abandoned, not",post:"because of the public backlash it provoked."},
{pre:"Scarcely had the announcement been made",post:"protests erupted across the capital."},
{pre:"She succeeded by",post:"of sheer perseverance and determination."},
{pre:"The report made recommendations, the most significant",post:"which concerned funding reform."},
{pre:"They carried on regardless,",post:"spite of the obvious risks involved."},
{pre:"No sooner had the ceasefire been declared",post:"fighting broke out in the eastern provinces."}
]},
// --- Exercise 3: Word Formation ---
{type:"wf",tl:"Use of English",title:"Part 3 - Word Formation",ins:"Use the word given to form a word that fits the gap.",
items:[
{pre:"The",root:"PROPEL",post:"system used in the spacecraft was revolutionary."},
{pre:"His",root:"CONTEMPT",post:"attitude towards his colleagues alienated everyone."},
{pre:"The report highlighted several",root:"SHORT",post:"in the current regulatory framework."},
{pre:"The",root:"FERTILE",post:"of the soil made agriculture virtually impossible."},
{pre:"She made an",root:"PASSION",post:"plea for clemency on behalf of the defendant."},
{pre:"The",root:"PLACE",post:"of thousands of refugees created a humanitarian crisis."},
{pre:"His",root:"FORGE",post:"performance earned him critical acclaim worldwide."},
{pre:"The government faced accusations of",root:"MANAGE",post:"over its handling of the crisis."}
]},
// --- Exercise 4: Key Word Transformations ---
{type:"kt",tl:"Use of English",title:"Part 4 - Key Word Transformations",ins:"Use 3-8 words including the word given.",
items:[
{src:"Without his financial support, the charity would have collapsed.",kw:"HAD",hint:"had it not been for = without (third conditional inversion)"},
{src:"She is determined to finish the project on time.",kw:"BENT",hint:"be bent on + -ing = be determined to"},
{src:"The fact that he lied is what upsets me most.",kw:"EXCEPTION",hint:"take exception to = object to"},
{src:"They believe the painting was stolen during the war.",kw:"THOUGHT",hint:"passive reporting structure + perfect infinitive"},
{src:"I cannot possibly accept this offer under these conditions.",kw:"QUESTION",hint:"out of the question = impossible"},
{src:"The whole affair started because of a trivial misunderstanding.",kw:"AROSE",hint:"arise from = originate from"}
]},
// --- Exercise 5: Reading MC ---
{type:"mc",tl:"Reading",title:"Part 5 - Multiple Choice",ins:"Choose the best answer (A-D).",
...
items:[
{q:"The writer presents the philosophical study of memory as",opts:["a well-established field with a long academic history","a recently emerging area that asks normative rather than empirical questions","an extension of existing psychological research into cognitive processes","a controversial approach that most scholars have rejected"]},
{q:"According to Margalit, our memory obligations towards strangers are rooted in",opts:["the specific details of their individual experiences","our shared national or cultural identity with them","the universal human qualities they represent","the likelihood that we will encounter them personally"]},
{q:"The example of Holocaust memorials is used to illustrate",opts:["the failure of existing memorials to serve their purpose","how different types of ethical relations generate different memory obligations","that only those directly affected should determine how events are commemorated","the superiority of thin ethical relations over thick ones"]},
{q:"The writer suggests that post-conflict societies face a tension between",opts:["historical accuracy and artistic expression in memorials","international obligations and domestic political priorities","honouring particular suffering and fostering collective reconciliation","thick and thin philosophical frameworks"]},
{q:"Critics of Margalit argue that",opts:["his framework is too rigid to account for the fluidity of modern ethical relationships","the concept of memory obligations has no practical application","thick relations are always more important than thin ones","digital media have eliminated the distinction between remembering and forgetting"]},
{q:"The writer\\'s overall tone towards Margalit\\'s framework can best be described as",opts:["dismissive and hostile","wholly uncritical and enthusiastic","appreciative but acknowledging its limitations","indifferent and detached"]}
]},
// --- Exercise 6: Listening Part 1 ---
{type:"mc",tl:"Listening",title:"Part 1 - Short Extracts",ins:"Listen and choose the correct answer.",
items:[
...
items:[
{pre:"The strong form of the hypothesis, known as linguistic determinism, has largely been",post:"."},
{pre:"The weaker version claims that language influences thought without fully",post:"it."},
{pre:"Russian speakers distinguished shades of blue more quickly because their language has separate",post:"for light and dark blue."},
{pre:"The Kuuk Thaayorre people use",post:"rather than relative spatial terms like left and right."},
{pre:"These speakers maintain a constant awareness of",post:"at all times."},
{pre:"In Mandarin, time is expressed through",post:"with earlier events described as above later ones."},
{pre:"English speakers predominantly conceptualise time using",post:"."},
{pre:"The colour perception research showed that having more colour terms helps speakers",post:"more quickly."},
{pre:"The overall evidence supports the weaker version of the hypothesis, known as linguistic",post:"."}
]},
// --- Exercise 8: Writing ---
{type:"wr",tl:"Writing",title:"Part 1 - Essay",ins:"Write your essay in 240-280 words.",
...
items:[
{q:"Gap 1",opts:["illuminate","elucidate","clarify","enlighten"]},
{q:"Gap 2",opts:["impels","compels","propels","repels"]},
{q:"Gap 3",opts:["construct","contrive","conceive","concoct"]},
{q:"Gap 4",opts:["implications","consequences","repercussions","ramifications"]},
{q:"Gap 5",opts:["justify","vindicate","warrant","legitimise"]},
{q:"Gap 6",opts:["arena","sphere","domain","realm"]},
{q:"Gap 7",opts:["contravene","undermine","contradict","compromise"]},
{q:"Gap 8",opts:["concede","confess","acknowledge","admit"]}
]},
// --- Exercise 2: Open Cloze ---
{type:"fl",tl:"Use of English",title:"Part 2 - Open Cloze",ins:"Write the word which best fits each gap.",
items:[
{pre:"Were it not",post:"the intervention of a bystander, the accident could have been fatal."},
{pre:"Hard",post:"it may be to accept, the evidence is overwhelming."},
{pre:"Not a single witness came forward, nor",post:"any physical evidence recovered from the scene."},
{pre:"The success of the venture depends, in no small",post:", on the commitment of all partners."},
{pre:"It is precisely this quality",post:"sets her apart from her contemporaries."},
{pre:"The report was thorough in",post:"respect and left no question unanswered."},
{pre:"She spoke with such conviction",post:"to persuade even the most sceptical members of the committee."},
{pre:"Far",post:"being a setback, the delay proved to be a blessing in disguise."}
]},
// --- Exercise 3: Word Formation ---
{type:"wf",tl:"Use of English",title:"Part 3 - Word Formation",ins:"Use the word given to form a word that fits the gap.",
items:[
{pre:"The politician\\'s",root:"SINCERE",post:"was apparent to everyone in the room."},
{pre:"This technology has the potential to",root:"REVOLUTION",post:"the healthcare industry."},
{pre:"Their",root:"SIGHT",post:"in failing to check the data proved catastrophic."},
{pre:"The",root:"EXHAUST",post:"energy of the children left the teachers drained."},
{pre:"The novel offers a",root:"COMPEL",post:"account of life during the occupation."},
{pre:"She displayed remarkable",root:"COMPOSE",post:"throughout the ordeal."},
{pre:"The",root:"SUSTAIN",post:"of the current model is now widely recognised."},
{pre:"His contributions to the field were",root:"MATCH",post:"by any of his contemporaries."}
]},
// --- Exercise 4: Key Word Transformations ---
{type:"kt",tl:"Use of English",title:"Part 4 - Key Word Transformations",ins:"Use 3-8 words including the word given.",
items:[
{src:"Nobody expected the new policy to be so controversial.",kw:"BARGAINED",hint:"bargain for = expect"},
{src:"He made no attempt to conceal his disappointment.",kw:"PAINS",hint:"take pains to = make an effort to"},
{src:"The chances of finding survivors are very slim now.",kw:"LIKELIHOOD",hint:"there is little likelihood of + -ing"},
{src:"You should think carefully before making a final decision.",kw:"WEIGH",hint:"weigh up = consider carefully"},
{src:"Everyone admires her dedication to the cause.",kw:"LOOKED",hint:"look up to = admire"},
{src:"She refused to let the criticism affect her performance.",kw:"RISE",hint:"rise above = not be affected by"}
]},
// --- Exercise 5: Reading MC ---
{type:"mc",tl:"Reading",title:"Part 5 - Multiple Choice",ins:"Choose the best answer (A-D).",
...
items:[
{q:"The writer suggests that behaviourism\\'s rejection of animal consciousness was motivated by",opts:["genuine concern for scientific objectivity","a fear of the ethical implications of acknowledging it","an ideological commitment to excluding subjective phenomena","insufficient evidence about animal neurological structures"]},
{q:"Griffin\\'s argument relied on the principle that",opts:["animal behaviour can only be explained through anthropomorphism","similar neural structures likely produce comparable experiences","bat echolocation proves that animals have self-awareness","consciousness is too complex to study scientifically"]},
{q:"The Cambridge Declaration on Consciousness is presented as",opts:["a controversial document rejected by most neuroscientists","a formal recognition that consciousness-related brain structures exist beyond humans","definitive proof that all animals are fully conscious","a philosophical argument for animal rights"]},
{q:"The writer\\'s reference to \\'the hard problem of consciousness\\' serves to",opts:["dismiss the significance of neuroscientific evidence","acknowledge a fundamental unresolved question about subjective experience","argue that animal consciousness cannot be scientifically studied","support the behaviourist position on consciousness"]},
{q:"The phrase \\'let the perfect be the enemy of the good\\' is used to argue that",opts:["perfect understanding of consciousness is achievable with more research","ethical action should not be delayed pending complete philosophical resolution","philosophical perfection is more important than practical ethics","animal welfare policies should only be based on proven scientific facts"]},
{q:"According to the final paragraph, acknowledgment of animal consciousness has been slow because",opts:["the scientific evidence remains weak and unconvincing","philosophers have successfully argued against it","it threatens significant economic interests","the public lacks access to relevant information"]}
]},
// --- Exercise 6: Listening Part 1 ---
{type:"mc",tl:"Listening",title:"Part 1 - Short Extracts",ins:"Listen and choose the correct answer.",
items:[
...
{audio:"Extract 3: Woman: The experiment was deceptively simple. They gave participants a choice between receiving a small sum immediately or a larger sum in a week. Man: And the results? Woman: Predictably, most chose the immediate reward. But here is the interesting part: when the researchers introduced a vivid mental imagery exercise, asking participants to picture themselves enjoying the future reward in detail, the preference shifted dramatically towards waiting.",q:"The experiment showed that mental imagery",opts:["had no effect on participants\\' financial decisions","significantly increased participants\\' willingness to delay gratification","made participants more anxious about future rewards"]},
{audio:"Extract 3 (continued): Man: That has huge implications for financial education. Woman: Absolutely. It suggests that the problem with saving is not that people do not understand compound interest. It is that the future self who benefits from saving feels abstract and unreal. Make that future self vivid, and behaviour changes.",q:"The woman concludes that people struggle to save primarily because",opts:["they lack basic financial literacy","their future selves feel psychologically distant and abstract","they are inherently incapable of rational financial planning"]}
]},
// --- Exercise 7: Listening Part 2 ---
{type:"fl",tl:"Listening",title:"Part 2 - Sentence Completion",ins:"Complete each sentence with a word or short phrase.",
...
items:[
{pre:"Prolonged sleep deprivation in animals is ultimately",post:"."},
{pre:"Chronic lack of sleep has been linked to conditions including cardiovascular disease and",post:"."},
{pre:"The glymphatic system removes waste from the brain primarily during",post:"."},
{pre:"The system works by flushing",post:"through the brain tissue."},
{pre:"The toxic protein removed by this process, associated with Alzheimer\\'s, is called",post:"."},
{pre:"Memory consolidation takes place mainly during the",post:"of sleep."},
{pre:"Students who sleep after learning perform",post:"on memory tests."},
{pre:"Early school start times conflict with adolescents\\'",post:"."},
{pre:"Sleep deprivation ironically reduces the very capacities people sacrifice sleep to",post:"."}
]},
// --- Exercise 8: Writing ---
{type:"wr",tl:"Writing",title:"Part 1 - Essay",ins:"Write your essay in 240-280 words.",
...
items:[
{q:"Gap 1",opts:["momentous","monumental","considerable","prodigious"]},
{q:"Gap 2",opts:["assumed","presumed","supposed","surmised"]},
{q:"Gap 3",opts:["fundamentally","radically","drastically","extensively"]},
{q:"Gap 4",opts:["defies","exceeds","surpasses","transcends"]},
{q:"Gap 5",opts:["articulate","formulate","express","enunciate"]},
{q:"Gap 6",opts:["vertiginous","cavernous","voluminous","capacious"]},
{q:"Gap 7",opts:["evocative","provocative","suggestive","indicative"]},
{q:"Gap 8",opts:["addition","appendage","adjunct","addendum"]}
]},
// --- Exercise 2: Open Cloze ---
{type:"fl",tl:"Use of English",title:"Part 2 - Open Cloze",ins:"Write the word which best fits each gap.",
items:[
{pre:"Nowhere",post:"this problem more evident than in the developing world."},
{pre:"She made her decision and, right",post:"wrong, she was determined to stand by it."},
{pre:"The phenomenon, fascinating",post:"itself, also has important practical applications."},
{pre:"On no account",post:"this information be disclosed to unauthorised personnel."},
{pre:"The team worked around the clock, thereby",post:"that the deadline was met."},
{pre:"It was",post:"so much the cost as the inconvenience that bothered them."},
{pre:"Eloquent",post:"his speech was, it failed to change a single vote."},
{pre:"The discovery was all the more remarkable",post:"having been made by accident."}
]},
// --- Exercise 3: Word Formation ---
{type:"wf",tl:"Use of English",title:"Part 3 - Word Formation",ins:"Use the word given to form a word that fits the gap.",
items:[
{pre:"The",root:"THINK",post:"had happened, and no one was prepared for it."},
{pre:"Her",root:"REMARK",post:"composed demeanour concealed deep anxiety."},
{pre:"The treaty represented an",root:"HISTORY",post:"breakthrough in diplomatic relations."},
{pre:"The government\\'s",root:"DECIDE",post:"frustrated both allies and opponents."},
{pre:"Scientists have noted a",root:"PROPORTION",post:"impact on vulnerable communities."},
{pre:"The",root:"COME",post:"of the negotiations exceeded everyone\\'s expectations."},
{pre:"His early work showed extraordinary",root:"PROMISE",post:"but his later career was disappointing."},
{pre:"The",root:"TURN",post:"in the economy caught most analysts by surprise."}
]},
// --- Exercise 4: Key Word Transformations ---
{type:"kt",tl:"Use of English",title:"Part 4 - Key Word Transformations",ins:"Use 3-8 words including the word given.",
items:[
{src:"I can never remember people\\'s names at parties.",kw:"HOPELESS",hint:"be hopeless at + -ing"},
{src:"The heavy rain prevented them from completing the race.",kw:"PRECLUDED",hint:"preclude someone from + -ing"},
{src:"They demolished the old factory without consulting the residents.",kw:"PRIOR",hint:"prior + noun = before"},
{src:"His sudden resignation surprised absolutely everyone.",kw:"BLUE",hint:"out of the blue = unexpectedly"},
{src:"She is not able to tolerate dishonesty of any kind.",kw:"STANDS",hint:"cannot stand = cannot tolerate"},
{src:"This problem needs to be addressed immediately.",kw:"CRYING",hint:"a crying need = an urgent need"}
]},
// --- Exercise 5: Reading MC ---
{type:"mc",tl:"Reading",title:"Part 5 - Multiple Choice",ins:"Choose the best answer (A-D).",
...
items:[
{pre:"The term epistemic injustice was introduced by",post:"in 2007."},
{pre:"Testimonial injustice occurs when a speaker\\'s credibility is reduced because of the hearer\\'s",post:"."},
{pre:"Hermeneutical injustice involves gaps in shared",post:"that disadvantage certain groups."},
{pre:"Before the term existed, women who experienced sexual harassment lacked the",post:"to describe it."},
{pre:"This absence of language rendered their suffering",post:"."},
{pre:"Fricker\\'s analysis shows that injustice can operate through the distribution of",post:"."},
{pre:"In healthcare, patients from minority ethnic groups often find their symptoms are",post:"."},
{pre:"Legal scholars have noted that indigenous testimony about environmental damage is systematically",post:"in court."},
{pre:"The common pattern is that prejudice corrupts the process of",post:"with devastating consequences."}
]},
// --- Exercise 8: Writing ---
{type:"wr",tl:"Writing",title:"Part 1 - Essay",ins:"Write your essay in 240-280 words.",
...
items:[
{q:"Gap 1",opts:["ignited","kindled","sparked","fired"]},
{q:"Gap 2",opts:["compelling","persuasive","convincing","forceful"]},
{q:"Gap 3",opts:["compromised","impaired","undermined","tainted"]},
{q:"Gap 4",opts:["acquired","assumed","adopted","attained"]},
{q:"Gap 5",opts:["combat","counter","confront","contest"]},
{q:"Gap 6",opts:["retort","counter","rejoin","rebuff"]},
{q:"Gap 7",opts:["cogent","eloquent","articulate","fluent"]},
{q:"Gap 8",opts:["purge","cleanse","purify","sanitise"]}
]},
// --- Exercise 2: Open Cloze ---
{type:"fl",tl:"Use of English",title:"Part 2 - Open Cloze",ins:"Write the word which best fits each gap.",
items:[
{pre:"Such was the complexity of the problem",post:"even the most experienced engineers were baffled."},
{pre:"The proposal was rejected, and rightly",post:", given the risks involved."},
{pre:"Only by investing in education can a society hope to",post:"about lasting change."},
{pre:"The painting is attributed",post:"Caravaggio, though some experts dispute this."},
{pre:"Brilliant",post:"the performance was, it could not save the production."},
{pre:"The new law notwithstanding, many employers continue to flout",post:"regulations with impunity."},
{pre:"It was",post:"considerable reluctance that the board approved the merger."},
{pre:"In",post:"way did the outcome reflect the effort invested in the project."}
]},
// --- Exercise 3: Word Formation ---
{type:"wf",tl:"Use of English",title:"Part 3 - Word Formation",ins:"Use the word given to form a word that fits the gap.",
items:[
{pre:"The",root:"PRIVILEGE",post:"communities bore the brunt of the economic downturn."},
{pre:"Her",root:"PHILANTHROPY",post:"endeavours earned her widespread admiration."},
{pre:"The negotiations reached an",root:"PASS",post:"that lasted several weeks."},
{pre:"Scientists noted the",root:"ANOMALY",post:"behaviour of the particles under extreme conditions."},
{pre:"The sheer",root:"MAGNET",post:"of his personality drew people to him effortlessly."},
{pre:"The team\\'s",root:"PREPARE",post:"for the crisis was exemplary."},
{pre:"The documentary offered an",root:"SPARE",post:"portrayal of life in the conflict zone."},
{pre:"Environmental",root:"ACTIVE",post:"staged a dramatic protest outside parliament."}
]},
// --- Exercise 4: Key Word Transformations ---
{type:"kt",tl:"Use of English",title:"Part 4 - Key Word Transformations",ins:"Use 3-8 words including the word given.",
items:[
{src:"It was wrong of you to speak to her like that.",kw:"OUGHT",hint:"ought not to + perfect infinitive for past criticism"},
{src:"She always manages to remain calm in a crisis.",kw:"LOSES",hint:"lose composure = become agitated"},
{src:"The negotiations failed because neither side was willing to compromise.",kw:"GROUND",hint:"give ground = make concessions"},
{src:"Everyone says the new restaurant is excellent.",kw:"REPUTED",hint:"be reputed to = be said to"},
{src:"He pretended not to notice her arrival.",kw:"BLIND",hint:"turn a blind eye to = deliberately ignore"},
{src:"It is extremely unlikely that they will agree to our terms.",kw:"REMOTE",hint:"a remote possibility = very unlikely"}
]},
// --- Exercise 5: Reading MC ---
{type:"mc",tl:"Reading",title:"Part 5 - Multiple Choice",ins:"Choose the best answer (A-D).",
...
items:[
{q:"The writer\\'s main purpose in paragraph two is to illustrate that",opts:["GDP is an accurate measure of environmental health","economic activity can be harmful yet still boost GDP figures","oil spills are the most significant flaw in GDP measurement","healthcare spending always indicates societal progress"]},
{q:"Kahneman\\'s research is cited to support the argument that",opts:["all income levels contribute equally to happiness","economic growth invariably improves emotional well-being","beyond a certain income level, more wealth adds little to daily happiness","psychological research is irrelevant to economic policy"]},
{q:"The degrowth movement proposes that wealthy nations should",opts:["increase economic output to fund environmental programmes","intentionally reduce production and focus on well-being activities","maintain current growth rates while improving efficiency","export their economic models to developing countries"]},
{q:"Sceptics of degrowth argue that",opts:["developing nations have no need for economic growth","technological innovation is unlikely to improve sustainability","wealthy nations advocating reduced growth may be ignoring global inequality","environmental sustainability is not a realistic goal"]},
{q:"The phrase \\'locked into an economic system\\' implies that",opts:["wealthy nations have consciously chosen perpetual growth","the economic system operates independently of human agency","growth continues not because it serves well-being but because the system demands it","GDP is the only possible measure of economic success"]},
{q:"The final paragraph suggests that the growth debate is fundamentally about",opts:["the technical feasibility of reducing economic output","competing visions of what constitutes a good society","the relative importance of European and global perspectives","whether economists or philosophers should guide policy"]}
]},
// --- Exercise 6: Listening Part 1 ---
{type:"mc",tl:"Listening",title:"Part 1 - Short Extracts",ins:"Listen and choose the correct answer.",
items:[
{audio:"Extract 1: Woman: One of the most pernicious myths about bilingual education is that it confuses children. The evidence is overwhelmingly to the contrary. Children who receive instruction in two languages from an early age develop stronger metalinguistic awareness than their monolingual peers. Man: Yet many school systems still resist implementing it. Woman: Largely for political reasons, not pedagogical ones. Bilingual education gets caught up in debates about national identity and immigration, which have nothing to do with how children actually learn.",q:"The woman attributes resistance to bilingual education primarily to",opts:["legitimate concerns about its educational effectiveness","political considerations unrelated to learning outcomes","a lack of trained bilingual teachers"]},
...
items:[
{pre:"Approximately a quarter of atmospheric carbon dioxide is absorbed by",post:"."},
{pre:"Dissolved CO2 forms",post:"in seawater, increasing ocean acidity."},
{pre:"Ocean acidity has risen by approximately",post:"since industrialisation began."},
{pre:"This rate of change has no precedent in at least",post:"."},
{pre:"Organisms that build shells use",post:"as their primary building material."},
{pre:"Coral reefs support approximately",post:"of all marine species."},
{pre:"By 2050, most tropical coral reefs may be in a state of",post:"."},
{pre:"Reef ecosystem services are valued at approximately",post:"per year."},
{pre:"The pteropod, crucial to polar food chains, is already exhibiting",post:"in Antarctic waters."}
]},
// --- Exercise 8: Writing ---
{type:"wr",tl:"Writing",title:"Part 1 - Essay",ins:"Write your essay in 240-280 words.",
...
items:[
{q:"Gap 1",opts:["wrought","enacted","effected","exerted"]},
{q:"Gap 2",opts:["convened","mustered","marshalled","assembled"]},
{q:"Gap 3",opts:["galvanised","energised","animated","invigorated"]},
{q:"Gap 4",opts:["vindicate","corroborate","substantiate","attest"]},
{q:"Gap 5",opts:["elicit","garner","solicit","muster"]},
{q:"Gap 6",opts:["prompted","warranted","necessitated","enjoined"]},
{q:"Gap 7",opts:["fragile","tenuous","precarious","volatile"]},
{q:"Gap 8",opts:["dissipate","disintegrate","dissolve","disperse"]}
]},
// --- Exercise 2: Open Cloze ---
{type:"fl",tl:"Use of English",title:"Part 2 - Open Cloze",ins:"Write the word which best fits each gap.",
items:[
{pre:"Hardly had the ink dried on the agreement",post:"both sides began violating its terms."},
{pre:"The policy was effective, albeit",post:"a considerable cost to individual freedoms."},
{pre:"Whether the reforms will succeed depends",post:"a number of factors beyond our control."},
{pre:"Not",post:"nothing has this region been called the cradle of civilisation."},
{pre:"The work, ambitious",post:"scope, was let down by poor execution."},
{pre:"They pressed ahead with the project",post:"the face of fierce opposition from local residents."},
{pre:"It was",post:"when the full extent of the damage became clear that action was taken."},
{pre:"The two explanations are by no",post:"mutually exclusive."}
]},
// --- Exercise 3: Word Formation ---
{type:"wf",tl:"Use of English",title:"Part 3 - Word Formation",ins:"Use the word given to form a word that fits the gap.",
items:[
{pre:"The",root:"ERADICATE",post:"of the disease has been one of medicine\\'s greatest triumphs."},
{pre:"Her",root:"BREAK",post:"research challenged decades of established orthodoxy."},
{pre:"The witness gave a",root:"CONVINCE",post:"account of the events that evening."},
{pre:"The government\\'s",root:"RESPOND",post:"to public concern was notably lacking."},
{pre:"Such",root:"EXPECT",post:"generous terms astonished the negotiating team."},
{pre:"The committee expressed its",root:"APPROVE",post:"in the strongest possible terms."},
{pre:"The",root:"MORTAL",post:"of the hero in verse ensured his legacy endured."},
{pre:"The speaker delivered an",root:"ELOQUENT",post:"address that moved the entire audience."}
]},
// --- Exercise 4: Key Word Transformations ---
{type:"kt",tl:"Use of English",title:"Part 4 - Key Word Transformations",ins:"Use 3-8 words including the word given.",
items:[
{src:"She did not hesitate to voice her objections.",kw:"QUALMS",hint:"have no qualms about + -ing"},
{src:"The rumours about the company turned out to be true.",kw:"SUBSTANCE",hint:"there is substance to = something is true"},
{src:"It is essential that everyone attends the briefing tomorrow.",kw:"IMPERATIVE",hint:"it is imperative that + subjunctive"},
{src:"She always makes sure her work is perfect before submitting it.",kw:"LENGTHS",hint:"go to great lengths = make extreme effort"},
{src:"I do not think he intended to cause offence.",kw:"MEANT",hint:"mean harm = intend to cause offence"},
{src:"The new evidence completely changed the outcome of the trial.",kw:"BEARING",hint:"have a bearing on = influence"}
]},
// --- Exercise 5: Reading MC ---
{type:"mc",tl:"Reading",title:"Part 5 - Multiple Choice",ins:"Choose the best answer (A-D).",
...
items:[
{pre:"The Dunning-Kruger effect was first documented in",post:"by David Dunning and Justin Kruger."},
{pre:"People with limited competence tend to",post:"their own ability in a domain."},
{pre:"Genuine experts, conversely, tend to",post:"their performance."},
{pre:"The original study tested undergraduates on logical reasoning, grammar, and",post:"."},
{pre:"According to Dunning and Kruger, incompetence prevents people from recognising their own",post:"."},
{pre:"Some researchers claim the effect is partly a",post:"caused by regression to the mean."},
{pre:"In East Asian countries, studies found",post:"or even reversals of the original pattern."},
{pre:"The underlying skill of accurately evaluating one\\'s own knowledge is called",post:"."},
{pre:"Poor metacognitive skills can have serious consequences in areas including healthcare and",post:"."}
]},
// --- Exercise 8: Writing ---
{type:"wr",tl:"Writing",title:"Part 1 - Essay",ins:"Write your essay in 240-280 words.",
...
items:[
{q:"Gap 1",opts:["acquired","assumed","attained","amassed"]},
{q:"Gap 2",opts:["depleted","eroded","diminished","attenuated"]},
{q:"Gap 3",opts:["stem","curb","curtail","suppress"]},
{q:"Gap 4",opts:["paradox","dilemma","quandary","predicament"]},
{q:"Gap 5",opts:["exhibit","specimen","artefact","relic"]},
{q:"Gap 6",opts:["evolve","progress","advance","develop"]},
{q:"Gap 7",opts:["anachronism","anomaly","aberration","antiquity"]},
{q:"Gap 8",opts:["attendant","concomitant","accompanying","concurrent"]}
]},
// --- Exercise 2: Open Cloze ---
{type:"fl",tl:"Use of English",title:"Part 2 - Open Cloze",ins:"Write the word which best fits each gap.",
items:[
{pre:"Compelling",post:"the argument may sound, it rests on questionable assumptions."},
{pre:"They left no stone unturned",post:"their search for the missing document."},
{pre:"The reforms were introduced with a",post:"to reducing inequality."},
{pre:"Not since the founding of the institution",post:"such radical changes been proposed."},
{pre:"The project was completed on time, no small feat",post:"the constraints the team was operating under."},
{pre:"She spoke",post:"if she had witnessed the events herself, though she had not."},
{pre:"The extent of the damage, considerable",post:"it was, could have been far worse."},
{pre:"It remains to",post:"seen whether these measures will have the desired effect."}
]},
// --- Exercise 3: Word Formation ---
{type:"wf",tl:"Use of English",title:"Part 3 - Word Formation",ins:"Use the word given to form a word that fits the gap.",
items:[
{pre:"The",root:"DIVERSE",post:"of the economy was a key policy objective."},
{pre:"His behaviour was",root:"CONSCIENCE",post:"and warranted severe disciplinary action."},
{pre:"The",root:"PERCEIVE",post:"shift in public opinion went unnoticed by the media."},
{pre:"Their",root:"ACHIEVE",post:"puzzled teachers who knew their potential."},
{pre:"She was",root:"MISTAKE",post:"the most qualified candidate for the position."},
{pre:"The building\\'s",root:"ARCHITECT",post:"significance made it a prime candidate for listing."},
{pre:"His",root:"PERSEVERE",post:"in the face of adversity was truly admirable."},
{pre:"The report catalogued a series of",root:"REGULAR",post:"in the accounting procedures."}
]},
// --- Exercise 4: Key Word Transformations ---
{type:"kt",tl:"Use of English",title:"Part 4 - Key Word Transformations",ins:"Use 3-8 words including the word given.",
items:[
{src:"I am certain that she did not know about the plan.",kw:"IGNORANCE",hint:"in ignorance of = not knowing about"},
{src:"The new rules apply to all employees without exception.",kw:"BOARD",hint:"across the board = to everyone"},
{src:"We must decide now; there is no more time for discussion.",kw:"RUN",hint:"run out of = exhaust the supply of"},
{src:"He kept his composure even though he was under enormous pressure.",kw:"FACE",hint:"in the face of = despite"},
{src:"The investigation was stopped before it could reach any conclusions.",kw:"CUT",hint:"cut short = end prematurely"},
{src:"Nobody could have predicted how successful the project would become.",kw:"FORESEEN",hint:"could not have been foreseen = was impossible to predict"}
]},
// --- Exercise 5: Reading MC ---
{type:"mc",tl:"Reading",title:"Part 5 - Multiple Choice",ins:"Choose the best answer (A-D).",
...
items:[
{pre:"Rewilding involves restoring ecosystems by reintroducing lost species and allowing",post:"to resume."},
{pre:"George Monbiot\\'s influential book on the subject was called",post:", published in 2013."},
{pre:"Grey wolves were reintroduced to Yellowstone National Park in",post:"."},
{pre:"The wolves initiated a chain of ecological effects known as a",post:"."},
{pre:"By preying on elk, wolves allowed riverbank vegetation to recover, which",post:"and changed river courses."},
{pre:"In England, the Knepp Estate converted 3,500 acres of",post:"into a wildlife haven."},
{pre:"Rare species at Knepp include turtle doves, nightingales, and",post:"."},
{pre:"Farming communities oppose rewilding because they fear",post:"."},
{pre:"The fundamental debate concerns the definition of nature and whether human landscape intervention is inherently",post:"."}
]},
// --- Exercise 8: Writing ---
{type:"wr",tl:"Writing",title:"Part 1 - Essay",ins:"Write your essay in 240-280 words.",
...
items:[
{q:"Gap 1",opts:["overturned","overthrown","overridden","overcome"]},
{q:"Gap 2",opts:["held","maintained","contended","upheld"]},
{q:"Gap 3",opts:["refuted","rebutted","contradicted","countered"]},
{q:"Gap 4",opts:["correlates","coincides","corresponds","concurs"]},
{q:"Gap 5",opts:["far-reaching","wide-ranging","broad-based","all-encompassing"]},
{q:"Gap 6",opts:["clear-cut","straightforward","uncomplicated","unambiguous"]},
{q:"Gap 7",opts:["spawned","borne","begotten","fathered"]},
{q:"Gap 8",opts:["overstating","exaggerating","inflating","magnifying"]}
]},
// --- Exercise 2: Open Cloze ---
{type:"fl",tl:"Use of English",title:"Part 2 - Open Cloze",ins:"Write the word which best fits each gap.",
items:[
{pre:"Important",post:"these findings are, they must be interpreted with caution."},
{pre:"The research was groundbreaking in",post:"it challenged decades of established orthodoxy."},
{pre:"Were the hypothesis to be confirmed, it",post:"necessitate a complete revision of the theory."},
{pre:"Not only has the programme failed to achieve its objectives,",post:"it has actually made matters worse."},
{pre:"The plan, brilliant",post:"paper, proved impossible to implement in practice."},
{pre:"The government proceeded",post:"the reforms despite widespread public opposition."},
{pre:"So rapidly did the situation deteriorate",post:"emergency measures had to be introduced."},
{pre:"The funding was awarded on",post:"that the results be made publicly available."}
]},
// --- Exercise 3: Word Formation ---
{type:"wf",tl:"Use of English",title:"Part 3 - Word Formation",ins:"Use the word given to form a word that fits the gap.",
items:[
{pre:"The",root:"CONCEIVE",post:"that the brain stops developing after childhood has been disproven."},
{pre:"Her",root:"TIRE",post:"advocacy for the cause eventually produced results."},
{pre:"The findings were",root:"CONTROVERSY",post:"and sparked a heated academic debate."},
{pre:"The",root:"DENY",post:"truth is that the system needs fundamental reform."},
{pre:"His",root:"FORTH",post:"book promises to shed new light on the subject."},
{pre:"The",root:"ELUDE",post:"nature of consciousness continues to puzzle philosophers."},
{pre:"Their",root:"FORESEE",post:"departure threw the entire schedule into disarray."},
{pre:"The policy had a number of",root:"INTEND",post:"consequences that proved difficult to reverse."}
]},
// --- Exercise 4: Key Word Transformations ---
{type:"kt",tl:"Use of English",title:"Part 4 - Key Word Transformations",ins:"Use 3-8 words including the word given.",
items:[
{src:"The authorities did not manage to find the cause of the explosion.",kw:"BOTTOM",hint:"get to the bottom of = discover the cause"},
{src:"He spoke so quietly that nobody could hear what he was saying.",kw:"BARELY",hint:"barely audible = almost impossible to hear"},
{src:"I strongly advise you not to sign that contract.",kw:"BETTER",hint:"had better not = strong advice against"},
{src:"The success of the event was entirely due to her efforts.",kw:"CREDIT",hint:"the credit goes to = recognition of achievement"},
{src:"She did not intend to offend anyone with her remarks.",kw:"MEANT",hint:"be meant to = be intended to"},
{src:"The discovery altered our understanding of evolution forever.",kw:"IRREVERSIBLY",hint:"irreversibly = in a way that cannot be undone"}
]},
// --- Exercise 5: Reading MC ---
{type:"mc",tl:"Reading",title:"Part 5 - Multiple Choice",ins:"Choose the best answer (A-D).",
...
items:[
{q:"The writer presents the rational actor model as",opts:["a proven and reliable description of human behaviour","an idealised framework that behavioural economics has challenged","the only viable basis for economic theory","a model that behavioural economists have strengthened"]},
{q:"Loss aversion is described as the tendency to",opts:["avoid making any decisions that involve potential losses","feel losses more intensely than equivalent gains","consistently choose the option with the lowest risk","overestimate the probability of negative outcomes"]},
{q:"The writer\\'s attitude towards the practical applications of nudging is",opts:["entirely dismissive of their value","acknowledging their effectiveness while noting controversy","convinced they represent the ideal form of governance","sceptical that they have produced any measurable results"]},
{q:"The criticism that behavioural economics lacks a coherent theoretical framework suggests that",opts:["it has completely replaced classical economics","its findings are unreliable and should be ignored","it identifies problems without offering a systematic alternative theory","cognitive biases do not actually exist"]},
{q:"The political objection to nudging centres on the claim that it",opts:["restricts individual choice in visible and transparent ways","represents hidden paternalism that undermines genuine autonomy","has been adopted only by authoritarian governments","is too expensive to implement effectively"]},
{q:"The question raised in the final paragraph concerns",opts:["whether economic growth should remain a policy priority","the technical feasibility of implementing behavioural insights","what systematic irrationality implies for the foundations of democracy","whether Kahneman and Tversky\\'s research methods were sound"]}
]},
// --- Exercise 6: Listening Part 1 ---
{type:"mc",tl:"Listening",title:"Part 1 - Short Extracts",ins:"Listen and choose the correct answer.",
items:[
{audio:"Extract 1: Man: The concept of emotional intelligence has become ubiquitous in corporate training, but I worry that it has been diluted to the point of meaninglessness. Woman: You think the original concept had more rigour? Man: Considerably. When Peter Salovey and John Mayer first defined it, they were talking about a specific set of cognitive abilities: perceiving emotions accurately, using emotions to facilitate thought, understanding emotional complexity, and managing emotions adaptively. What corporate trainers have turned it into is essentially just being nice to people.",q:"The man is concerned that emotional intelligence has been",opts:["accurately applied in corporate contexts","oversimplified from its original scientific definition","rejected by the business community"]},
...
items:[
{pre:"The term attention economy was first used by the economist",post:"in 1971."},
{pre:"Simon observed that abundant information creates a corresponding scarcity of",post:"."},
{pre:"Social media platforms sell user attention to",post:"as their core business model."},
{pre:"Design features like the infinite scroll are optimised for",post:"rather than user well-being."},
{pre:"The JAMA meta-analysis found that using social media for more than",post:"increases adolescent mental health risks."},
{pre:"Content generating strong emotional reactions such as outrage and fear captures",post:"than nuanced analysis."},
{pre:"This creates a systematic bias towards sensationalism and",post:"in public discourse."},
{pre:"The philosopher Matthew Crawford argues that attention is not merely economic but also",post:"."},
{pre:"Crawford suggests that a culture commercialising attention engages in a form of",post:"."}
]},
// --- Exercise 8: Writing ---
{type:"wr",tl:"Writing",title:"Part 1 - Essay",ins:"Write your essay in 240-280 words.",
...
if (typeof window !== 'undefined') { window.CAM_CPE = CAM_CPE; }
